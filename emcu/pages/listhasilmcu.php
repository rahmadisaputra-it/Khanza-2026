<?php
    ...
    if (isset($nomcuhasil["nomcuhasil"])) {
        ...
        if($rsquerynorawat = mysqli_fetch_array($querynorawat)) {
            ...
            $querydatapasien = bukaquery(
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.stts_nikah,".
                "reg_periksa.tgl_registrasi,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, ".
                ...
                "where reg_periksa.no_rawat='".$rsquerynorawat["no_rawat"]."'"
            );
            if($rsquerydatapasien = mysqli_fetch_array($querydatapasien)){
                echo "          <table width='100%' class='table table-striped table-hover js-basic-example dataTable' border='0' align='center' cellpadding='5' cellspacing='5' class='tbl_form'>
                                    <tr>
                                        <td width='30%' valign='top'>Nama Pasien</td><td valign='top'>:&nbsp;</td><td width='70%' valign='top'>".$rsquerydatapasien["nm_pasien"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>Jenis Kelamin</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["jk"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>Tanggal Lahir</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["tgl_lahir"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>Status Nikah</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["stts_nikah"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>Umur</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["umurdaftar"]." ".$rsquerydatapasien["sttsumur"]." </td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>Alamat</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["alamat"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>Tanggal MCU</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["tgl_registrasi"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>No.Rekam Medis</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["no_rkm_medis"]."</td>
                                    </tr>
                                    <tr>  
                                        <td valign='top'>No.Pelayanan</td><td valign='top'>:&nbsp;</td><td valign='top'>".$rsquerydatapasien["no_rawat"]."</td>
                                    </tr>
                                </table>";
            }
