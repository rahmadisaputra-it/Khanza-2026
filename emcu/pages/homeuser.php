<?php 
    if(isset($_SESSION["ses_emcu"])){
        ...
        if(!isset($_SESSION["nama_perusahaan"])){
            $queryuser = @bukaquery2("select perusahaan_pasien.nama_perusahaan from perusahaan_pasien where perusahaan_pasien.kode_perusahaan='".validTeks4(encrypt_decrypt($_SESSION["ses_emcu"],"d"),20)."'");
            while($rsqueryuser = mysqli_fetch_array($queryuser)) {
                $_SESSION["nama_perusahaan"] = $rsqueryuser["nama_perusahaan"];
            }
        }
    }else{
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?act=HomeUser"><b>Aplikasi E-MCU <?=$_SESSION["nama_instansi"];?></b></a>
            </div>
        </div>
    </nav>
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            <div class="user-info">
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?=$_SESSION["nama_perusahaan"];?></div>
