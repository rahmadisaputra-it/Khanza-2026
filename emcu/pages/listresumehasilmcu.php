...
<div class="block-header">
    <h2><center>RESUME HASIL PEMERIKSAAN MEDICAL CHECK UP</center></h2>
</div>
        ...
        <div class="card">
            <div class="body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" width="1800px">
                        <thead>
                            <tr>
                                ...
                                <th valign='middle'><center>Kesimpulan</center></th>
                                <th valign='middle'><center>Saran</center></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 
