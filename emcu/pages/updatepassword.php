            ...
            <div class="body">
                ...
                <?php 
                    ...
                    if (isset($btnSimpan)) {
                         ...
                         if(getOne2("select AES_DECRYPT(password_perusahaan_pasien.password,'windi') from password_perusahaan_pasien where password_perusahaan_pasien.kode_perusahaan='".validTeks4(encrypt_decrypt($_SESSION["ses_emcu"],"d"),20)."'")==$passwordlama){
                             if($passwordbaru==$passwordbaruulangi){
                                 if(strlen($passwordbaru)>5){
                                     if(bukaquery2("update password_perusahaan_pasien set password=AES_ENCRYPT('$passwordbaru','windi') where password_perusahaan_pasien.kode_perusahaan='".validTeks4(encrypt_decrypt($_SESSION["ses_emcu"],"d"),20)."'")){
