 ...
 * @author dosen
 */
public class DlgStokKeluarIPSRSPerTanggal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgStokKeluarIPSRSPerTanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgStokKeluarIPSRSPerTanggal dialog = new DlgStokKeluarIPSRSPerTanggal(new javax.swing.JFrame(), true);
    ...
    String konversi(int year, int month, int day){
        ...
        try {
            ...
            Logger.getLogger(DlgStokKeluarIPSRSPerTanggal.class.getName()).log(Level.SEVERE, null, ex);
        }
