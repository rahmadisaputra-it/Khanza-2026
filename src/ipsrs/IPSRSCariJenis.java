...
public final class IPSRSCariJenis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public IPSRSCariJenis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Jenis Barang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        IPSRSJenis nm_jenis=new IPSRSJenis(null,false);
        nm_jenis.emptTeks();
        nm_jenis.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSCariJenis dialog = new IPSRSCariJenis(new javax.swing.JFrame(), true);
    ...
    private void tampil2() {
        try {
            myObj = new FileReader("./cache/jenisipsrs.iyem");
