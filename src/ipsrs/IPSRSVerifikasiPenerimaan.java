...
public class IPSRSVerifikasiPenerimaan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public IPSRSVerifikasiPenerimaan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSVerifikasiPenerimaan dialog = new IPSRSVerifikasiPenerimaan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ...
            if(!nmsup.getText().trim().equals("")){
                carisuplier=" and surat_pemesanan_non_medis.kode_suplier='"+kdsup.getText()+"' ";
            }
            if(!nmptg.getText().trim().equals("")){
                caripegawai=" and surat_pemesanan_non_medis.nip='"+kdptg.getText()+"' ";
            }
            if(!TCari.getText().trim().equals("")){
                carikeyword=" and (surat_pemesanan_non_medis.no_pemesanan like '%"+TCari.getText().trim()+"%' or "+
                            " surat_pemesanan_non_medis.kode_suplier like '%"+TCari.getText().trim()+"%' or "+
            ...
            ps=koneksi.prepareStatement("select date_format(surat_pemesanan_non_medis.tanggal,'%d/%m/%Y') as tanggal,surat_pemesanan_non_medis.no_pemesanan, "+
                    ...
                    "surat_pemesanan_non_medis.potongan,surat_pemesanan_non_medis.tanggal as tglpesan,surat_pemesanan_non_medis.tagihan from surat_pemesanan_non_medis "+
                    "inner join ipsrssuplier on surat_pemesanan_non_medis.kode_suplier=ipsrssuplier.kode_suplier "+
                    "inner join pegawai on surat_pemesanan_non_medis.nip=pegawai.nik where surat_pemesanan_non_medis.status='Sudah Datang' "+
                    "and surat_pemesanan_non_medis.tanggal between '"+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglBeli2.getSelectedItem()+"")+"' "+
                    carifaktur+carisuplier+caripegawai+carikeyword+" order by surat_pemesanan_non_medis.tanggal,surat_pemesanan_non_medis.no_pemesanan ");
            ...
            try {
                ...
                while(rs.next()){
                    pspenerimaan=koneksi.prepareStatement(
                            "select date_format(ipsrspemesanan.tgl_pesan,'%d/%m/%Y') as tanggal,ipsrspemesanan.no_faktur,ipsrspemesanan.total1,ipsrspemesanan.potongan, "+
                            "ipsrspemesanan.nip,petugas.nama,date_format(ipsrspemesanan.tgl_faktur,'%d/%m/%Y') as tgl_faktur, "+
                            "date_format(ipsrspemesanan.tgl_tempo,'%d/%m/%Y') as tgl_tempo,ipsrspemesanan.status,ipsrspemesanan.total2,ipsrspemesanan.ppn,"+
                            "ipsrspemesanan.meterai,ipsrspemesanan.tagihan,ipsrspemesanan.no_order,(to_days(ipsrspemesanan.tgl_pesan)-to_days('"+rs.getString("tglpesan")+"')) as lama "+
                            "from ipsrspemesanan inner join petugas on ipsrspemesanan.nip=petugas.nip "+
                            "where ipsrspemesanan.no_order='"+rs.getString("no_pemesanan")+"'");
                    try {
                        ...
                        if(rspenerimaan.next()){
                           ...
                           htmlContent.append(                             
                            ...
                            pssub=koneksi.prepareStatement(
                                    "select detail_surat_pemesanan_non_medis.kode_brng,ipsrsbarang.nama_brng,kodesatuan.satuan,detail_surat_pemesanan_non_medis.jumlah,detail_surat_pemesanan_non_medis.h_pesan, "+
                                    ...
                                    "inner join kodesatuan on detail_surat_pemesanan_non_medis.kode_sat=kodesatuan.kode_sat where detail_surat_pemesanan_non_medis.no_pemesanan='"+rs.getString("no_pemesanan")+"'");
                            try {
                                ...
                                while(rssub.next()){
                                    ...
                                    pssubpenerimaan=koneksi.prepareStatement(
                                        "select kodesatuan.satuan,ipsrsdetailpesan.jumlah,ipsrsdetailpesan.harga,"+
                                        "ipsrsdetailpesan.subtotal,ipsrsdetailpesan.dis,ipsrsdetailpesan.besardis,ipsrsdetailpesan.total "+
                                        "from ipsrsdetailpesan inner join kodesatuan on ipsrsdetailpesan.kode_sat=kodesatuan.kode_sat "+
                                        "where ipsrsdetailpesan.no_faktur='"+rspenerimaan.getString("no_faktur")+"' and ipsrsdetailpesan.kode_brng='"+rssub.getString("kode_brng")+"'");
                                    try {
                            ...
                            pssisipan=koneksi.prepareStatement(
                                    ...
                                    "and kode_brng not in (select kode_brng from detail_surat_pemesanan_non_medis where no_pemesanan='"+rs.getString("no_pemesanan")+"')");
                            try {
