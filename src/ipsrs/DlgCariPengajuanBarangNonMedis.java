...
public class DlgCariPengajuanBarangNonMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPengajuanBarangNonMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Pengajuan Pengadaan/Pembelian Barang Non Medis dan Penunjang ( Lab & RO ) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        LTotal.setPreferredSize(new java.awt.Dimension(137, 30));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(ceksukses==false){
                ...
                Valid.MyReportqry("rptPengajuanBarangNonMedis.jasper","report","::[ Data Pengajuan Permintaan/Pengadaan Barang Non Medis dan Penunjang ( Lab & RO ) ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }else{
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    if(Sequel.cariInteger("select count(no_pengajuan) from pengajuan_barang_nonmedis where no_pengajuan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim())==0){
            Valid.textKosong(TCari,"pilihan data");
    }else{
        Sequel.queryu("delete from pengajuan_barang_nonmedis where no_pengajuan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim());
        runBackground(() ->tampil());
    }    
    ...
    private void ppProsesPengajuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppProsesPengajuanActionPerformed
        if(Sequel.cariInteger("select count(no_pengajuan) from pengajuan_barang_nonmedis where no_pengajuan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim())==0){
            ...
            Sequel.queryu("update pengajuan_barang_nonmedis set status='Proses Pengajuan' where no_pengajuan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim());
            runBackground(() ->tampil());
        }
    ...
    private void ppDitolakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDitolakActionPerformed
        if(Sequel.cariInteger("select count(no_pengajuan) from pengajuan_barang_nonmedis where no_pengajuan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim())==0){
            ...
            Sequel.queryu("update pengajuan_barang_nonmedis set status='Ditolak' where no_pengajuan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().trim());
            runBackground(() ->tampil());
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPengajuanBarangNonMedis dialog = new DlgCariPengajuanBarangNonMedis(new javax.swing.JFrame(), true);
       ...
       Valid.tabelKosong(tabMode);
        try{  
            ps=koneksi.prepareStatement(
                    "select pengajuan_barang_nonmedis.tanggal,pengajuan_barang_nonmedis.no_pengajuan, "+
                    "pengajuan_barang_nonmedis.keterangan,pengajuan_barang_nonmedis.nip,pegawai.nama,pengajuan_barang_nonmedis.status "+
                    ...
                    " group by pengajuan_barang_nonmedis.no_pengajuan order by pengajuan_barang_nonmedis.tanggal,pengajuan_barang_nonmedis.no_pengajuan ");
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        "select detail_pengajuan_barang_nonmedis.kode_brng,ipsrsbarang.nama_brng, "+
                        "detail_pengajuan_barang_nonmedis.kode_sat,kodesatuan.satuan,detail_pengajuan_barang_nonmedis.jumlah,"+
                        "detail_pengajuan_barang_nonmedis.h_pengajuan,detail_pengajuan_barang_nonmedis.total "+
                        "from detail_pengajuan_barang_nonmedis inner join ipsrsbarang inner join kodesatuan inner join ipsrsjenisbarang "+
                        " on detail_pengajuan_barang_nonmedis.kode_brng=ipsrsbarang.kode_brng "+
                        " and detail_pengajuan_barang_nonmedis.kode_sat=kodesatuan.kode_sat "+
                        " and ipsrsbarang.jenis=ipsrsjenisbarang.kd_jenis where "+
                        " detail_pengajuan_barang_nonmedis.no_pengajuan=? and ipsrsbarang.nama_brng like ? and ipsrsjenisbarang.nm_jenis like ? and detail_pengajuan_barang_nonmedis.kode_brng like ? or "+
                        " detail_pengajuan_barang_nonmedis.no_pengajuan=? and ipsrsbarang.nama_brng like ? and ipsrsjenisbarang.nm_jenis like ? and ipsrsbarang.nama_brng like ? or "+
                        " detail_pengajuan_barang_nonmedis.no_pengajuan=? and ipsrsbarang.nama_brng like ? and ipsrsjenisbarang.nm_jenis like ? and detail_pengajuan_barang_nonmedis.kode_sat like ? or "+
                        " detail_pengajuan_barang_nonmedis.no_pengajuan=? and ipsrsbarang.nama_brng like ? and ipsrsjenisbarang.nm_jenis like ? and ipsrsjenisbarang.nm_jenis like ? order by detail_pengajuan_barang_nonmedis.kode_brng  ");
                    try {
    ...
    public void isCek(){
        ...
        ppHapus.setEnabled(akses.getpengajuan_barang_nonmedis());
        ppDisetujui.setEnabled(akses.getsurat_pemesanan_non_medis());
        ppProsesPengajuan.setEnabled(akses.getpengajuan_barang_nonmedis());
        ppDitolak.setEnabled(akses.getpengajuan_barang_nonmedis());
    }
