...
public class IPSRSCariSuratPemesanan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public IPSRSCariSuratPemesanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(ceksukses==false){
                ...
                Valid.MyReportqry("rptDataPemesananNonMedis.jasper","report","::[ Data Surat Pemesanan Barang Non Medis dan Penunjang ( Lab & Radiologi) ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }else{
    ...
    private void ppDatangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDatangActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            ...
            if(Sequel.cariIsi("select status from surat_pemesanan_non_medis where no_pemesanan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()).equals("Sudah Datang")){
                ...
                IPSRSPemesanan aplikasi=new IPSRSPemesanan(null,false);
        ...
        if(Apoteker.getText().trim().equals("")){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                    ...
                    " where surat_pemesanan_non_medis.no_pemesanan=? ");
                try {
                    ...
                    if(rs.next()){
                        ...
                        ps2=koneksi.prepareStatement("select detail_surat_pemesanan_non_medis.kode_brng,ipsrsbarang.nama_brng, "+
                            ...
                            " detail_surat_pemesanan_non_medis.no_pemesanan=?");
                        try {
