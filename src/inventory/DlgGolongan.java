 ...
 * @author dosen
 */
public final class DlgGolongan extends javax.swing.JDialog {
     ...
     *@param parent
     *@param modal */
    public DlgGolongan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"P","Kode Golongan","Nama Golongan"};
    ...
    private void initComponents() {
        ...
        panelisi4.add(Kd);
        Kd.setBounds(94, 12, 80, 23);

        label36.setText("Nama Golongan :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Kode Golongan");
        }else if(Nm.getText().trim().equals("")){
            Valid.textKosong(Nm,"Nama Golongan");
        }else{
            Sequel.menyimpan("golongan_barang","'"+Kd.getText()+"','"+Nm.getText()+"'","Kode Golongan");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("golongan_barang","kode",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"golongan_barang","kode","?","nama=?,kode=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgGolongan dialog = new DlgGolongan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{   
            ps=koneksi.prepareStatement("select kode,nama  "+
                    " from golongan_barang where  kode like ? or "+
                    " nama like ? order by nama ");
            try {                
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Kd.requestFocus();        
        Valid.autoNomer("golongan_barang","G",2,Kd);
    }
