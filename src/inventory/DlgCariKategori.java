    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKategori dialog = new DlgCariKategori(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{  
            file=new File("./cache/kategoriobat.iyem");
            file.createNewFile();
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    iyembuilder.append("{\"KodeKategori\":\"").append(rs.getString(1)).append("\",\"NamaKategori\":\"").append(rs.getString(2)).append("\"},");
                }
            } catch (Exception e) {
            ...
            if (iyembuilder.length() > 0) {
                ...
                fileWriter.write("{\"kategoriobat\":["+iyembuilder+"]}");
                fileWriter.flush();
            }
    ...
    private void tampil2() {
        try {
            myObj = new FileReader("./cache/kategoriobat.iyem");
    ...
    public void isCek(){        
        BtnTambah.setEnabled(akses.getkategori_barang());
    }
