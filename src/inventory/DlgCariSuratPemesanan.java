...
public class DlgCariSuratPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Surat Pemesanan Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        NoFaktur.setBounds(94, 10, 209, 23);
        ...
        TglBeli1.setBounds(94, 40, 90, 23);
        ...
        label12.setBounds(184, 40, 27, 23);
        ...
        label18.setBounds(0, 70, 90, 23);

        Status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Proses Pesan", "Sudah Datang" }));
        Status.setName("Status"); // NOI18N
        Status.setPreferredSize(new java.awt.Dimension(40, 23));
        panelisi3.add(Status);
        Status.setBounds(94, 70, 150, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(ceksukses==false){
                ...
                Valid.MyReportqry("rptDataPemesanan.jasper","report","::[ Data Surat Pemesanan Barang ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }else{
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
  if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
     ...
     Sequel.queryu2("delete from surat_pemesanan_medis where no_pemesanan=?",1,new String[]{tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()});
     runBackground(() ->tampil());    
  }       
    ...
    private void ppDatangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDatangActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            ...
            if(Sequel.cariIsi("select status from surat_pemesanan_medis where no_pemesanan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()).equals("Sudah Datang")){
                ...
                DlgPemesanan aplikasi=new DlgPemesanan(null,false);
                ...
                aplikasi.isCek();
                aplikasi.tampil2(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
    ...
    private void ppProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppProsesActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            ...
            Sequel.queryu("update surat_pemesanan_medis set status='Proses Pesan' where no_pemesanan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
            runBackground(() ->tampil());
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariSuratPemesanan dialog = new DlgCariSuratPemesanan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
       Valid.tabelKosong(tabMode);
        try{   
            ps=koneksi.prepareStatement(
                    "select surat_pemesanan_medis.tanggal,surat_pemesanan_medis.no_pemesanan, "+
                    "surat_pemesanan_medis.kode_suplier,datasuplier.nama_suplier, "+
                    "surat_pemesanan_medis.nip,pegawai.nama,"+
                    "surat_pemesanan_medis.status,surat_pemesanan_medis.total2,"+
                    "surat_pemesanan_medis.ppn,surat_pemesanan_medis.meterai,"+
                    ...
                    " and databarang.kode_industri=industrifarmasi.kode_industri "+
                    " and surat_pemesanan_medis.nip=pegawai.nik and databarang.kdjns=jenis.kdjns"+
                    " where surat_pemesanan_medis.tanggal between ? and ? and surat_pemesanan_medis.no_pemesanan like ? and datasuplier.nama_suplier like ? and pegawai.nama like ?  and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and surat_pemesanan_medis.status like ? and "+
                    " (surat_pemesanan_medis.no_pemesanan like ? or surat_pemesanan_medis.kode_suplier like ? or datasuplier.nama_suplier like ? or surat_pemesanan_medis.nip like ? or pegawai.nama like ? or detail_surat_pemesanan_medis.kode_brng like ? or databarang.nama_brng like ? or "+
                    " detail_surat_pemesanan_medis.kode_sat like ? or industrifarmasi.nama_industri like ? or jenis.nama like ?) group by surat_pemesanan_medis.no_pemesanan order by surat_pemesanan_medis.tanggal,surat_pemesanan_medis.no_pemesanan ");
            try {
                ...
                ps.setString(9,"%"+Status.getSelectedItem().toString().replaceAll("Semua","")+"%");
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement("select detail_surat_pemesanan_medis.kode_brng,databarang.nama_brng, "+
                        "detail_surat_pemesanan_medis.kode_sat,kodesatuan.satuan,detail_surat_pemesanan_medis.jumlah,detail_surat_pemesanan_medis.h_pesan, "+
                        "detail_surat_pemesanan_medis.subtotal,detail_surat_pemesanan_medis.dis,detail_surat_pemesanan_medis.besardis,detail_surat_pemesanan_medis.total,"+
                        ...
                        " on detail_surat_pemesanan_medis.kode_brng=databarang.kode_brng and databarang.kdjns=jenis.kdjns "+
                        " and databarang.kode_industri=industrifarmasi.kode_industri and detail_surat_pemesanan_medis.kode_sat=kodesatuan.kode_sat where "+
                        " detail_surat_pemesanan_medis.no_pemesanan=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and "+
                        " (detail_surat_pemesanan_medis.kode_brng like ? or databarang.nama_brng like ? or detail_surat_pemesanan_medis.kode_sat like ? or "+
                        " industrifarmasi.nama_industri like ? or jenis.nama like ?) order by detail_surat_pemesanan_medis.kode_brng  ");
                    try {
                        ...
                        int no=1;
                        while(rs2.next()){
                                tabMode.addRow(new Object[]{no+". I.F. : "+rs2.getString("nama_industri"),
                    ...
                    tabMode.addRow(new Object[]{"Tgl.Pemesanan",": "+rs.getString("tanggal"),"","","","","Total",":",Valid.SetAngka(rs.getDouble("total2"))});
                    tabMode.addRow(new Object[]{"Status Pemesanan",": "+rs.getString("status"),"","","","","Meterai",":",Valid.SetAngka(rs.getDouble("meterai"))});
                    tabMode.addRow(new Object[]{"Supplier",": "+rs.getString("kode_suplier")+", "+rs.getString("nama_suplier"),"","","","","PPN",":",Valid.SetAngka(rs.getDouble("ppn"))});
                    tabMode.addRow(new Object[]{"Petugas",": "+rs.getString("nip")+", "+rs.getString("nama"),"","","","","Tagihan",":",Valid.SetAngka(rs.getDouble("tagihan"))});
