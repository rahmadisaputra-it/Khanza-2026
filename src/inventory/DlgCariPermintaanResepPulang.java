...
public class DlgCariPermintaanResepPulang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPermintaanResepPulang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Permintaan Resep Pulang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-02-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-02-2022" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPermintaanResepPulang dialog = new DlgCariPermintaanResepPulang(new javax.swing.JFrame(), true);
        ...
        try{  
            if(ChkTanggal.isSelected()==true){
                ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                    ...
                    " from permintaan_resep_pulang inner join reg_periksa inner join pasien inner join dokter on permintaan_resep_pulang.no_rawat=reg_periksa.no_rawat  "+
                ...
                ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                    ...
                    " from permintaan_resep_pulang inner join reg_periksa inner join pasien inner join dokter on permintaan_resep_pulang.no_rawat=reg_periksa.no_rawat  "+
                    " and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and permintaan_resep_pulang.kd_dokter=dokter.kd_dokter where "+
                    " pasien.no_rkm_medis=? and permintaan_resep_pulang.kd_dokter=? order by permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam desc");
            }
            try{
                if(ChkTanggal.isSelected()==true){
