 ...
 * @author dosen
 */
public class K3RSLokasiKejadian extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public K3RSLokasiKejadian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Lokasi Kejadian"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Lokasi Kejadian K3 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Lokasi Kejadian");
        }else{
            Sequel.menyimpan("k3rs_lokasi_kejadian","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"k3rs_lokasi_kejadian","kode_lokasi");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("k3rs_lokasi_kejadian","kode_lokasi=?","kode_lokasi=?,lokasi_kejadian=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSLokasiKejadian dialog = new K3RSLokasiKejadian(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getlokasi_kejadian_k3rs());
    }
