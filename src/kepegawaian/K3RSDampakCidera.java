 ...
 * @author dosen
 */
public class K3RSDampakCidera extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public K3RSDampakCidera(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Dampak Cidera"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Dampak Cidera K3 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Dampak Cidera");
        }else{
            Sequel.menyimpan("k3rs_dampak_cidera","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"k3rs_dampak_cidera","kode_dampak");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("k3rs_dampak_cidera","kode_dampak=?","kode_dampak=?,dampak_cidera=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSDampakCidera dialog = new K3RSDampakCidera(new javax.swing.JFrame(), true);
    ...
    private void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"DK",3,TKd);
        TKd.requestFocus();
    }
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getdampak_cidera_k3rs());
    }
