 ...
 * @author dosen
 */
public class K3RSBagianTubuh extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public K3RSBagianTubuh(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode Bagian","Bagian Tubuh"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Bagian Tubuh Yang Terluka K3 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"Kode Bagian");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Bagian Tubuh");
        }else{
            Sequel.menyimpan("k3rs_bagian_tubuh","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Bagian");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"k3rs_bagian_tubuh","kode_bagian");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("k3rs_bagian_tubuh","kode_bagian=?","kode_bagian=?,bagian_tubuh=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSBagianTubuh dialog = new K3RSBagianTubuh(new javax.swing.JFrame(), true);
    ...
    private void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"BK",3,TKd);
        TKd.requestFocus();
    }
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getbagian_tubuh_k3rs());
    }
