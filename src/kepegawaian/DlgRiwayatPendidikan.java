 ...
 * @author perpustakaan
 */
public class DlgRiwayatPendidikan extends javax.swing.JDialog {
    ...
    public DlgRiwayatPendidikan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        DlgRiwayatPendidikan.this.setTitle(newValue);
                    });
                });
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Pendidikan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        try {
            if(engine.getLocation().contains("ListRiwayatPendidikan")){
                runBackground(() ->loadURL("http://" +koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"penggajian/index.php?act=ListRiwayatPendidikan&action=LIHAT&keyword="+TCari.getText().replaceAll(" ","_")));
            }                
        } catch (Exception ex) {
            System.out.println("Notifikasi : "+ex);
        }        
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatPendidikan dialog = new DlgRiwayatPendidikan(new javax.swing.JFrame(), true);
