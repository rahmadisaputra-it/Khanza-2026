 ...
 * @author perpustakaan
 */
public class DlgRiwayatPenelitian extends javax.swing.JDialog {
    ...
    public DlgRiwayatPenelitian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        DlgRiwayatPenelitian.this.setTitle(newValue);
                    });
                });
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        try {
            if(engine.getLocation().contains("ListRiwayatPenelitian")){
                runBackground(() ->loadURL("http://" +koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"penggajian/index.php?act=ListRiwayatPenelitian&action=LIHAT&keyword="+TCari.getText().replaceAll(" ","_")));
            }                
        } catch (Exception ex) {
            System.out.println("Notifikasi : "+ex);
        }        
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatPenelitian dialog = new DlgRiwayatPenelitian(new javax.swing.JFrame(), true);
