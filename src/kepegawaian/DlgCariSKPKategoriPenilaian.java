...
public final class DlgCariSKPKategoriPenilaian extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariSKPKategoriPenilaian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariSKPKategoriPenilaian dialog = new DlgCariSKPKategoriPenilaian(new javax.swing.JFrame(), true);
    ...
    private void tampil2() {
        try {
            myObj = new FileReader("./cache/skpkategoripenilaian.iyem");
            root = mapper.readTree(myObj);
            Valid.tabelKosong(tabMode);
            response = root.path("skp_kategori_penilaian");
            if(response.isArray()){
