 ...
 * @author dosen
 */
public class K3RSJenisCidera extends javax.swing.JDialog {
    ...
    public K3RSJenisCidera(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Jenis","Jenis Cidera"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Jenis Cidera K3 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Jenis Cidera");
        }else{
            Sequel.menyimpan("k3rs_jenis_cidera","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Jenis");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"k3rs_jenis_cidera","kode_cidera");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("k3rs_jenis_cidera","kode_cidera=?","kode_cidera=?,jenis_cidera=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSJenisCidera dialog = new K3RSJenisCidera(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from k3rs_jenis_cidera where kode_cidera like ? or jenis_cidera like ? order by kode_cidera");
            try {
    ...
    private void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"CK",3,TKd);
        TKd.requestFocus();
    }
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getjenis_cidera_k3rs());
    }
