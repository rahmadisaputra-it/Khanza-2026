 ...
 * @author dosen
 */
public final class DlgCariRuangAuditKepatuhan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariRuangAuditKepatuhan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);
        tabMode=new DefaultTableModel(null,new String[]{"ID Ruang","Nama Ruang"}){
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        ruang_audit_kepatuhan.isCek();
        ruang_audit_kepatuhan.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariRuangAuditKepatuhan dialog = new DlgCariRuangAuditKepatuhan(new javax.swing.JFrame(), true);
