...
public class DlgJadwalTambahan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengaturan Jadwal Tambahan Pegawai ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
                ...
                try{
                    ...
                    switch (pilihan) {
                        case "Tampilkan Semua":
                            Valid.MyReportqry("rptJadwalPegawai.jasper","report","::[ Jadwal Masuk Tambahan Pegawai ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);            
                            break;
                        case "Tanpa departemen & jabatan":
                            Valid.MyReportqry("rptJadwalPegawai2.jasper","report","::[ Jadwal Masuk Tambahan Pegawai ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);            
                            break;
                    }
                }catch(Exception e){
