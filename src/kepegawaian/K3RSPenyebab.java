 ...
 * @author dosen
 */
public class K3RSPenyebab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public K3RSPenyebab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Penyebab Kecelakaan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Penyebab Kecelakaan K3 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel4.setText("Penyebab Kecelakaan :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Penyebab Kecelakaan");
        }else{
            Sequel.menyimpan("k3rs_penyebab","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"k3rs_penyebab","kode_penyebab");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("k3rs_penyebab","kode_penyebab=?","kode_penyebab=?,penyebab_kecelakaan=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSPenyebab dialog = new K3RSPenyebab(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from k3rs_penyebab where kode_penyebab like ? or penyebab_kecelakaan like ? order by kode_penyebab");
            try {
    ...
    private void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"PK",3,TKd);
        TKd.requestFocus();
    }
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getpenyebab_k3rs());
    }
