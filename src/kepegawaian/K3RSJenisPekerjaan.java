 ...
 * @author dosen
 */
public class K3RSJenisPekerjaan extends javax.swing.JDialog {
    ...
    public K3RSJenisPekerjaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Jenis","Jenis Pekerjaan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Jenis Pekerjaan K3 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Jenis Pekerjaan");
        }else{
            Sequel.menyimpan("k3rs_jenis_pekerjaan","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Jenis");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"k3rs_jenis_pekerjaan","kode_pekerjaan");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("k3rs_jenis_pekerjaan","kode_pekerjaan=?","kode_pekerjaan=?,jenis_pekerjaan=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSJenisPekerjaan dialog = new K3RSJenisPekerjaan(new javax.swing.JFrame(), true);
