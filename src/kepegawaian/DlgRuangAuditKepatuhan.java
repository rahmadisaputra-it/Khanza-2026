 ...
 * @author dosen
 */
public class DlgRuangAuditKepatuhan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRuangAuditKepatuhan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ruang/Unit Audit Kepatuhan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"ID Ruang");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Nama Ruang");
        }else{
            Sequel.menyimpan("ruang_audit_kepatuhan","'"+TKd.getText()+"','"+TNm.getText()+"'","ID Ruang");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"ruang_audit_kepatuhan","id_ruang");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("ruang_audit_kepatuhan","id_ruang=?","id_ruang=?,nama_ruang=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRuangAuditKepatuhan dialog = new DlgRuangAuditKepatuhan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from ruang_audit_kepatuhan where id_ruang like ? "+
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"RA",3,TKd);
        TKd.requestFocus();
    }
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getruang_audit_kepatuhan());
    }
