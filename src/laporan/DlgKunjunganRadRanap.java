 ...
 * @author perpustakaan
 */
public final class DlgKunjunganRadRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKunjunganRadRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kunjungan Radiologi Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(ceksukses==false){
            ...
            if(tabMode.getRowCount()==0){
                ...
                Valid.MyReportqry("rptKunjunganRadRanap.jasper","report","::[ Laporan Kunjungan Radiologi Rawat Inap ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
    ...
    private void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "from periksa_radiologi inner join reg_periksa inner join dokter inner join pasien "+
                    ...
                    "where periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and bangsal.nm_bangsal like ? or " +
                    "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or " +
                    "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or " +
                    "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or " +
                    "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "periksa_radiologi.status='Ranap' and periksa_radiologi.no_rawat=? and periksa_radiologi.tgl_periksa=? and periksa_radiologi.jam=? ");
                    try {
                        ps2.setString(1,rs.getString("no_rawat"));
