 ...
 * @author perpustakaan
 */
public final class DlgPoliAsalPasienRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPoliAsalPasienRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8,1);
        setSize(885,674);
        tabMode=new DefaultTableModel(null,new String[]{"Kode Poli/Unit","Poliklinik/Unit","Jumlah Pasien"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Poli Asal Pasien Ranap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPoliAsalPasienRanap dialog = new DlgPoliAsalPasienRanap(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while(rs.next()){
                    if(kdpenjab.getText().trim().equals("")){
                        jumlahpasien=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where reg_periksa.status_lanjut='Ranap' and reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"'");
                    }else{
