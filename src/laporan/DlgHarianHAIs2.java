...
public class DlgHarianHAIs2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgHarianHAIs2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgHarianHAIs2 dialog = new DlgHarianHAIs2(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='4%' rowspan='2'>No.R.M</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='11%' rowspan='2'>Nama Pasien</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%' rowspan='2'>Tanggal</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='10%' colspan='4'>Hari Pemasangan</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='20%' colspan='8'>Infeksi</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='3%' rowspan='2'>Deku</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='24%' colspan='3'>Hasil Kultur</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='8%' rowspan='2'>Antibiotik</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='11%' rowspan='2'>Kamar/Bangsal</td>"+
                "</tr>"+
                "<tr class='isi'>"+
