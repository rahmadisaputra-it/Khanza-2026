 ...
 * @author perpustakaan
 */
public final class DlgDosisRadiologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDosisRadiologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] rowRwJlDr={
            "Tanggal & Jam","No.Rawat","No.RM","Nama Pasien","J.K.","Umur","Alamat","Pemeriksaan","Dokter Perujuk/Pengirim",
            "Status", "Proyeksi", "kV", "mAS", "FFD", "BSF", "Inak", "Jml.Penyinaran", "Dosis"
        };
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Dosis Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua Status", "Pemeriksaan Radiologi Rawat Jalan", "Pemeriksaan Radiologi Rawat Inap" }));
        Status.setName("Status"); // NOI18N
        FormInput.add(Status);
        Status.setBounds(78, 10, 315, 23);
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel "+
                    "inner join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                    "where periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.status like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? "+
                    "and (jns_perawatan_radiologi.nm_perawatan like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or reg_periksa.no_rawat like ?) "+
                    "order by periksa_radiologi.tgl_periksa,reg_periksa.jam_reg");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3,"%"+Status.getSelectedItem().toString().replaceAll("Semua Status","").replaceAll("Pemeriksaan Radiologi Rawat Jalan","Ralan").replaceAll("Pemeriksaan Radiologi Rawat Inap","Ranap")+"%");
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("tgl_periksa")+" "+rs.getString("jam"),rs.getString("no_rawat"),rs.getString("no_rkm_medis"),
                        rs.getString("nm_pasien"),rs.getString("jk"),rs.getString("umur"),rs.getString("almt_pj"),rs.getString("nm_perawatan"),
                        rs.getString("nm_dokter"),rs.getString("status"),rs.getString("proyeksi"),rs.getString("kV"),rs.getString("mAS"),
                        rs.getString("FFD"),rs.getString("BSF"),rs.getString("inak"),rs.getString("jml_penyinaran"),rs.getString("dosis")
                    }); 
                }
            } catch (Exception e) {
