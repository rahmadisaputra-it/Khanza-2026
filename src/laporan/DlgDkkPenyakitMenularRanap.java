...
public final class DlgDkkPenyakitMenularRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDkkPenyakitMenularRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Penyakit Menular di Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(ceksukses==false){
            ...
            if(tabMode.getRowCount()==0){
                ...
                Valid.MyReportqry("rptDkkPenyakitMenularRanap.jasper","report","::[ Penyakit Menular Rawat Inap ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDkkPenyakitMenularRanap dialog = new DlgDkkPenyakitMenularRanap(new javax.swing.JFrame(), true);
    ...
    private void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement("select diagnosa_pasien.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as nm_penyakit from diagnosa_pasien inner join penyakit "+
                    ...
                    "where diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1'  and reg_periksa.tgl_registrasi between ? and ? and left(upper(diagnosa_pasien.kd_penyakit),1)='A' or "+
                    "diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1'  and reg_periksa.tgl_registrasi between ? and ? and left(upper(diagnosa_pasien.kd_penyakit),1)='B' group by diagnosa_pasien.kd_penyakit ");
            try {
    ...
    private void tampil2(){        
        try{   
            ...
            ps=koneksi.prepareStatement("select diagnosa_pasien.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as nm_penyakit from diagnosa_pasien inner join penyakit inner join kamar_inap "+
                    ...
                    "where diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1'  and kamar_inap.tgl_keluar between ? and ? and left(upper(diagnosa_pasien.kd_penyakit),1)='A' or "+
                    "diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1'  and kamar_inap.tgl_keluar between ? and ? and left(upper(diagnosa_pasien.kd_penyakit),1)='B' group by diagnosa_pasien.kd_penyakit ");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3,Valid.SetTgl(Tgl1.getSelectedItem()+""));
