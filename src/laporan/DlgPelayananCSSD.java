 ...
 * @author perpustakaan
 */
public final class DlgPelayananCSSD extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPelayananCSSD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] rowRwJlDr={
            "No.","No.Sirkulasi","No.Inventaris","Kode Barang","Nama Barang","Jam Ambil","Jam Steril","Jam Kembali","Ambil-Steril","Steril-Kembali","Ambil-Kembali"
        };
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Lama Pelayanan CSSD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPelayananCSSD dialog = new DlgPelayananCSSD(new javax.swing.JFrame(), true);
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                ...
                "round((TIME_TO_SEC(inventaris_sterilisasi_cssd.tgl_sterilisasi)-TIME_TO_SEC(inventaris_ambil_cssd.tgl_ambil))/60,2) as durasisteril," +
                "round((TIME_TO_SEC(inventaris_kembali_cssd.tgl_kembali)-TIME_TO_SEC(inventaris_sterilisasi_cssd.tgl_sterilisasi))/60,2) as durasikembali," +
                "round((TIME_TO_SEC(inventaris_kembali_cssd.tgl_kembali)-TIME_TO_SEC(inventaris_ambil_cssd.tgl_ambil))/60,2) as durasipelayanan " +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        i,rs.getString("no_sirkulasi"),rs.getString("no_inventaris"),rs.getString("kode_barang"),rs.getString("nama_barang"),
                        rs.getString("tgl_ambil"),rs.getString("tgl_sterilisasi"),rs.getString("tgl_kembali"),rs.getString("durasisteril"),
                        rs.getString("durasikembali"),rs.getString("durasipelayanan")
                    });
                    i++;
                    lamajam=lamajam+rs.getDouble("durasisteril");
                    if(rs.getDouble("durasisteril")<=15){
                        limabelas++;
                    }else if((rs.getDouble("durasisteril")>15)&&(rs.getDouble("durasisteril")<=30)){
                        tigapuluh++;
                    }else if((rs.getDouble("durasisteril")>30)&&(rs.getDouble("durasisteril")<=60)){
                        satujam++;
                    }else if(rs.getDouble("durasisteril")>60){
                        lebihsatujam++;
                    }
                    lamajam2=lamajam2+rs.getDouble("durasikembali");
                    if(rs.getDouble("durasikembali")<=15){
                        limabelas2++;
                    }else if((rs.getDouble("durasikembali")>15)&&(rs.getDouble("durasikembali")<=30)){
                        tigapuluh2++;
                    }else if((rs.getDouble("durasikembali")>30)&&(rs.getDouble("durasikembali")<=60)){
                        satujam2++;
                    }else if(rs.getDouble("durasikembali")>60){
                        lebihsatujam2++;
                    }
