 ...
 * @author perpustakaan
 */
public final class DlgDokterAsalPasienRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDokterAsalPasienRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8,1);
        setSize(885,674);
        tabMode=new DefaultTableModel(null,new String[]{"Kode Dokter","Nama Dokter","Jumlah Pasien","Jasa Perujuk"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Dokter Asal Pasien Ranap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDokterAsalPasienRanap dialog = new DlgDokterAsalPasienRanap(new javax.swing.JFrame(), true);
    ...
    public void tampil(){        
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select dokter.kd_dokter,dokter.nm_dokter from dokter where dokter.status='1' "+
                    (TCari.getText().trim().equals("")?"":"and (dokter.kd_dokter like ? or dokter.nm_dokter like ?) ")+
