        ...
        try {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    jan=0;
                    jan=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-01' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    feb=0;
                    feb=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-02' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    mar=0;
                    mar=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-03' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    apr=0;
                    apr=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-04' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    mei=0;
                    mei=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-05' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    jun=0;
                    jun=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-06' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    jul=0;
                    jul=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-07' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    agu=0;
                    agu=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-08' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    sep=0;
                    sep=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-09' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    okt=0;
                    okt=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-10' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    nov=0;
                    nov=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-11' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    des=0;
                    des=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-12' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Lama'");
                    htmlContent.append(
                        "<tr class='isi'>"+
                            "<td valign='middle' align='center'></td>"+
                    ...
                    jan=0;
                    jan=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-01' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    feb=0;
                    feb=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-02' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    mar=0;
                    mar=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-03' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    apr=0;
                    apr=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-04' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    mei=0;
                    mei=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-05' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    jun=0;
                    jun=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-06' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    jul=0;
                    jul=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-07' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    agu=0;
                    agu=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-08' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    sep=0;
                    sep=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-09' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    okt=0;
                    okt=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-10' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    nov=0;
                    nov=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-11' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                    des=0;
                    des=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-12' and reg_periksa.kd_poli='"+rs.getString("kd_poli")+"' and reg_periksa.stts_daftar='Baru'");
                ...
                while(rs.next()){
                    ...
                    if((jan+feb+mar+apr+mei+jun+jul+agu+sep+okt+nov+des)>0){
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                jan=0;
                                jan=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-01' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                feb=0;
                                feb=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-02' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                mar=0;
                                mar=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-03' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                apr=0;
                                apr=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-04' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                mei=0;
                                mei=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-05' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                jun=0;
                                jun=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-06' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                jul=0;
                                jul=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-07' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                agu=0;
                                agu=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-08' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                sep=0;
                                sep=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-09' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                okt=0;
                                okt=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-10' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                nov=0;
                                nov=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-11' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
                                des=0;
                                des=Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa where DATE_FORMAT(reg_periksa.tgl_registrasi, '%Y-%m')='"+ThnCari.getSelectedItem()+"-12' and reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rs2.getString("kd_poli")+"'");
