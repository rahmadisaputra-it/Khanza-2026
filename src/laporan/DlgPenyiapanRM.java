 ...
 * @author perpustakaan
 */
public final class DlgPenyiapanRM extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenyiapanRM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8,1);
        setSize(885,674);

        Object[] rowRwJlDr={"No.","No.RM","Nama Pasien","Dokter","Poli","Jam Registrasi","Jam Berkas Dikirim","Durasi(m)"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Lama Penyiapan Berkas RM ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPenyiapanRM.jasper",param,"::[ Laporan Data Penyiapan Berkas RM ]::");
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenyiapanRM dialog = new DlgPenyiapanRM(new javax.swing.JFrame(), true);
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                ...
                "and reg_periksa.no_rawat=mutasi_berkas.no_rawat "+
