 ...
 * @author perpustakaan
 */
public final class DlgKunjunganRadRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKunjunganRadRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKunjunganRadRalan dialog = new DlgKunjunganRadRalan(new javax.swing.JFrame(), true);
    ...
    private void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "from periksa_radiologi inner join reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                    "inner join kabupaten inner join kecamatan inner join kelurahan "+
                    "on periksa_radiologi.dokter_perujuk=dokter.kd_dokter and periksa_radiologi.no_rawat=reg_periksa.no_rawat " +
                    ...
                    "where periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and poliklinik.nm_poli like ? or " +
                    "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or " +
                    "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or " +
                    "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or " +
                    "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "+
                    "group by reg_periksa.no_rawat,periksa_radiologi.tgl_periksa,periksa_radiologi.jam order by periksa_radiologi.tgl_periksa,reg_periksa.jam_reg");
            try {
