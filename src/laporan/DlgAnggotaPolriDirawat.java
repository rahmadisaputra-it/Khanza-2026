 ...
 * @author perpustakaan
 */
public final class DlgAnggotaPolriDirawat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAnggotaPolriDirawat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Anggota POLRI/PNS & Keluarga Yang Dirawat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
            ...
            for(int r=0;r<tabMode.getRowCount();r++){ 
                if(!tbBangsal.getValueAt(r,0).toString().contains(">>")){
                    Sequel.menyimpan("temporary","'"+r+"','"+
                                    ...
                                    tabMode.getValueAt(r,7).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Rekap Anggota Polri");
                }                    
            }
               
            Valid.MyReportqry("rptAnggotaPolriDirawat.jasper","report","::[ Laporan Anggota Polri/PNS & Keluarga Yang Dirawat ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
        }
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                ...
                "inner join pasien inner join pangkat_polri inner join satuan_polri inner join pasien_polri "+
                "inner join golongan_polri inner join jabatan_polri on pasien_polri.no_rkm_medis=pasien.no_rkm_medis and "+
                "pasien_polri.pangkat_polri=pangkat_polri.id and pasien_polri.satuan_polri=satuan_polri.id "+
                "and pasien_polri.golongan_polri=golongan_polri.id and pasien_polri.jabatan_polri=jabatan_polri.id "+
                "and pasien.no_rkm_medis=reg_periksa.no_rkm_medis where "+
                "reg_periksa.tgl_registrasi between ? and ? and pangkat_polri.nama_pangkat like ? and satuan_polri.nama_satuan like ? and golongan_polri.nama_golongan like ? and jabatan_polri.nama_jabatan like ? and pasien.nm_pasien like ? or "+
                "reg_periksa.tgl_registrasi between ? and ? and pangkat_polri.nama_pangkat like ? and satuan_polri.nama_satuan like ? and golongan_polri.nama_golongan like ? and jabatan_polri.nama_jabatan like ? and pasien.nip like ? order by reg_periksa.tgl_registrasi");
            try {
                ...
                ps.setString(10,"%"+Pangkat.getText().trim()+"%");
                ps.setString(11,"%"+Satuan.getText().trim()+"%");
                ps.setString(12,"%"+Golongan.getText().trim()+"%");
                ps.setString(13,"%"+Jabatan.getText().trim()+"%");
