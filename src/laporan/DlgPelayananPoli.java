 ...
 * @author perpustakaan
 */
public final class DlgPelayananPoli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPelayananPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPelayananPoli.jasper",param,"::[ Laporan Data Pelayanan Poli ]::");
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPelayananPoli dialog = new DlgPelayananPoli(new javax.swing.JFrame(), true);
