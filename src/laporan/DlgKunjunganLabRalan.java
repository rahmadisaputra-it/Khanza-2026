 ...
 * @author perpustakaan
 */
public final class DlgKunjunganLabRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKunjunganLabRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] rowRwJlDr={
            ...
            "Alamat","Kode","Diagnosa","Jenis Pemeriksaan","Dokter Perujuk/Pengirim","Asal Poli"
        };
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(ceksukses==false){
                ...
                Valid.MyReportqry("rptKunjunganLabRalan.jasper","report","::[ Laporan Kunjungan Laboratorium Rawat Jalan ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }else{
    ...
    private void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "from periksa_lab inner join reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                    ...
                    "where periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and poliklinik.nm_poli like ? or " +
                    "periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or " +
                    "periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or " +
                    "periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or " +
                    "periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "+
