...
public class DlgLamaPelayananPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Lama Pelayanan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label9.setPreferredSize(new java.awt.Dimension(30, 23));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLamaPelayananPasien dialog = new DlgLamaPelayananPasien(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,dokter.nm_dokter,date_format(reg_periksa.tgl_registrasi,'%d/%m/%Y') as tgl_registrasi,reg_periksa.jam_reg,"+
                    ...
                    "round((TIME_TO_SEC(date_format(mutasi_berkas.diterima,'%H:%i:%s'))-TIME_TO_SEC(reg_periksa.jam_reg))/60,2) as JRsdBP,"+
                    "round((TIME_TO_SEC(date_format(nota_jalan.jam,'%H:%i:%s'))-TIME_TO_SEC(reg_periksa.jam_reg))/60,2) as JRsdTB,"+
                    "round((TIME_TO_SEC(date_format(mutasi_berkas.diterima,'%H:%i:%s'))-TIME_TO_SEC(date_format(mutasi_berkas.dikirim,'%H:%i:%s')))/60,2) as SBsdBP,"+
                    "round((TIME_TO_SEC(date_format(nota_jalan.jam,'%H:%i:%s'))-TIME_TO_SEC(date_format(mutasi_berkas.dikirim,'%H:%i:%s')))/60,2) as SBsdTB,"+
                    "round((TIME_TO_SEC(date_format(nota_jalan.jam,'%H:%i:%s'))-TIME_TO_SEC(date_format(mutasi_berkas.diterima,'%H:%i:%s')))/60,2) as BPsdTB  "+
                    "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                    "inner join mutasi_berkas on reg_periksa.no_rawat=mutasi_berkas.no_rawat inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat "+
                    "where reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? "+(TCari.getText().trim().equals("")?"":" and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                    "pasien.nm_pasien like ? or poliklinik.nm_poli like ? or dokter.nm_dokter like ? ) ")+" order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            try {
                ...
                while(rs.next()){
                    ...
                    ttlJRsdDP=ttlJRsdDP+JRsdDP;
                    JRsdRDk=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdikirim+"')-TIME_TO_SEC('"+rs.getString("jam_reg")+"'))/60,2),'')");
                    ttlJRsdRDk=ttlJRsdRDk+JRsdRDk;
                    JRsdRDv=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdivalidasi+"')-TIME_TO_SEC('"+rs.getString("jam_reg")+"'))/60,2),'')");
                    ttlJRsdRDv=ttlJRsdRDv+JRsdRDv;
                    ttlJRsdTB=ttlJRsdTB+rs.getDouble("JRsdTB");
                    ttlSBsdBP=ttlSBsdBP+rs.getDouble("SBsdBP");
                    SBsdDP=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+dilayanipoli+"')-TIME_TO_SEC('"+rs.getString("dikirim")+"'))/60,2),'')");
                    ttlSBsdDP=ttlSBsdDP+SBsdDP;
                    SBsdRDk=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdikirim+"')-TIME_TO_SEC('"+rs.getString("dikirim")+"'))/60,2),'')");
                    ttlSBsdRDk=ttlSBsdRDk+SBsdRDk;
                    SBsdRDv=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdivalidasi+"')-TIME_TO_SEC('"+rs.getString("dikirim")+"'))/60,2),'')");
                    ttlSBsdRDv=ttlSBsdRDv+SBsdRDv;
                    ttlSBsdTB=ttlSBsdTB+rs.getDouble("SBsdTB");
                    BPsdDP=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+dilayanipoli+"')-TIME_TO_SEC('"+rs.getString("diterima")+"'))/60,2),'')");
                    ttlBPsdDP=ttlBPsdDP+BPsdDP;
                    BPsdRDk=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdikirim+"')-TIME_TO_SEC('"+rs.getString("diterima")+"'))/60,2),'')");
                    ttlBPsdRDk=ttlBPsdRDk+BPsdRDk;
                    BPsdRDv=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdivalidasi+"')-TIME_TO_SEC('"+rs.getString("diterima")+"'))/60,2),'')");
                    ttlBPsdRDv=ttlBPsdRDv+BPsdRDv;
                    ttlBPsdTB=ttlBPsdTB+rs.getDouble("BPsdTB");
                    DPsdRDk=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdikirim+"')-TIME_TO_SEC('"+dilayanipoli+"'))/60,2),'')");
                    ttlDPsdRDk=ttlDPsdRDk+DPsdRDk;
                    DPsdRDv=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdivalidasi+"')-TIME_TO_SEC('"+dilayanipoli+"'))/60,2),'')");
                    ttlDPsdRDv=ttlDPsdRDv+DPsdRDv;
                    DPsdTB=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+rs.getString("jambilling")+"')-TIME_TO_SEC('"+dilayanipoli+"'))/60,2),'')");
                    ttlDPsdTB=ttlDPsdTB+DPsdTB;
                    RDksdRDv=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+resepdivalidasi+"')-TIME_TO_SEC('"+resepdikirim+"'))/60,2),'')");
                    ttlRDksdRDv=ttlRDksdRDv+RDksdRDv;
                    RDksdTB=Sequel.cariIsiAngka("select ifnull(round((TIME_TO_SEC('"+rs.getString("jambilling")+"')-TIME_TO_SEC('"+resepdikirim+"'))/60,2),'')");
