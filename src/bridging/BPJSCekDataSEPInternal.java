 ...
 * @author dosen
 */
public final class BPJSCekDataSEPInternal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSCekDataSEPInternal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"No","Kode P.R.","Nama Poli Rujukan","Poli Asal","Tgl.Rujuk","No.SEP","No.SEP Referensi","PPK Pelayanan","No.Kartu",
            "Tanggal SEP","No.Surat","Flag Internal","Kode Poli Asal","Kode Poli Tujuan","Kode Penunjang","Nama Penunjang","Diagnosa PPK",
            "Kode Dokter","Nama Dokter","Flag Prosedur","Opsi Konsul","Flag SEP","FUser","FDate","Nama Diagnosa"
        };
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cek Data SEP Internal VClaim ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        NoSEP.setPreferredSize(new java.awt.Dimension(210, 23));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekDataSEPInternal dialog = new BPJSCekDataSEPInternal(new javax.swing.JFrame(), true);
    ...
    public void bodyWithDeleteRequest() throws Exception {
	    ...
	    headers.add("X-Signature",api.getHmac(utc));
            ...
            requestJson ="{" +
                                "\"request\": {" +
                                    "\"t_sep\": {" +
                                        "\"noSep\": \""+tbKamar.getValueAt(tbKamar.getSelectedRow(),5).toString()+"\"," +
                                        "\"noSurat\": \""+tbKamar.getValueAt(tbKamar.getSelectedRow(),10).toString()+"\"," +
                                        "\"tglRujukanInternal\": \""+tbKamar.getValueAt(tbKamar.getSelectedRow(),4).toString()+"\"," +
                                        "\"kdPoliTuj\": \""+tbKamar.getValueAt(tbKamar.getSelectedRow(),13).toString()+"\"," +
                                        "\"user\": \""+user+"\"" +
                                    "}" +
                                "}" +
                          "}";            
