 ...
 * @author dosen
 */
public final class MandiriMetodePembayaran extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MandiriMetodePembayaran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Biaya.setDocument(new batasInput((byte)6).getOnlyAngka(Biaya));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Metode Pembayaran Bank Mandiri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelGlass7.add(TKd);
        TKd.setBounds(49, 12, 60, 23);

        jLabel4.setText("Metode :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(108, 12, 60, 23);
        ...
        panelGlass7.add(Biaya);
        Biaya.setBounds(452, 12, 70, 23);

        jLabel5.setText("Biaya Transaksi :");
        jLabel5.setName("jLabel5"); // NOI18N
        panelGlass7.add(jLabel5);
        jLabel5.setBounds(358, 12, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Metode Pembayaran");
        }else if(Biaya.getText().trim().equals("")){
            Valid.textKosong(Biaya,"Biaya Transaksi");
        }else{
            if(Sequel.menyimpantf("metode_pembayaran_bankmandiri","'"+TKd.getText()+"','"+TNm.getText()+"','"+Biaya.getText()+"'","Kode")==true){
                tabMode.addRow(new Object[]{
                    TKd.getText(),TNm.getText(),Double.parseDouble(Biaya.getText())
                });
                emptTeks();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Biaya,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbJabatan.getSelectedRow()!= -1){
            if(Sequel.meghapustf("metode_pembayaran_bankmandiri","kode_metode",tbJabatan.getValueAt(tbJabatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriMetodePembayaran dialog = new MandiriMetodePembayaran(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "order by metode_pembayaran_bankmandiri.kode_metode");
            try {
    ...
    private void getData() {
        if(tbJabatan.getSelectedRow()!= -1){
            ...
            Biaya.setText(tbJabatan.getValueAt(tbJabatan.getSelectedRow(),2).toString());
        }
    }
