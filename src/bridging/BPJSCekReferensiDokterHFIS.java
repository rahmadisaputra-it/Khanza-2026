 ...
 * @author dosen
 */
public final class BPJSCekReferensiDokterHFIS extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSCekReferensiDokterHFIS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Dokter HFIS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariBPJSReferensiDokterHFIS.jasper","report","[ Pencarian Referensi Dokter HFIS ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiDokterHFIS dialog = new BPJSCekReferensiDokterHFIS(new javax.swing.JFrame(), true);
                    ...
                    for(JsonNode list:response){
                        if(list.path("namadokter").asText().toLowerCase().contains(poli.toLowerCase())||
                            ...
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kodedokter").asText(),list.path("namadokter").asText()
                            });
                        }
                        i++;
                    }
