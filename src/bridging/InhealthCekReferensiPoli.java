...
public final class InhealthCekReferensiPoli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InhealthCekReferensiPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Poli/Unit Inhealth ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthCekReferensiPoli dialog = new InhealthCekReferensiPoli(new javax.swing.JFrame(), true);
	    ...
	    requestJson ="{ \"token\": \""+koneksiDB.TOKENINHEALTH()+"\"," +
            ...
            if(root.isArray()){
                ...
                for(JsonNode list:root){
                    if(list.path("STATUS").asText().equals("True")){
