 ...
 * @author dosen
 */
public final class PCareCekFaskesThalasemia extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekFaskesThalasemia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        NmSpesialis.setPreferredSize(new java.awt.Dimension(200, 23));
        ...
        jLabel21.setText("Rujukan Khusus :");
        jLabel21.setName("jLabel21"); // NOI18N
        jLabel21.setPreferredSize(new java.awt.Dimension(130, 23));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariPCAREFaskesThalasemia.jasper","report","[ Pencarian Referensi Rujukan Thalasemia ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if(KdSpesialis.getText().trim().equals("")||NmSpesialis.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            tampil(Khusus.getSelectedItem().toString().substring(0,3),KdSpesialis.getText(),NoKartu.getText(),Tanggal.getSelectedItem().toString());
            this.setCursor(Cursor.getDefaultCursor());
       }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekFaskesThalasemia dialog = new PCareCekFaskesThalasemia(new javax.swing.JFrame(), true);
