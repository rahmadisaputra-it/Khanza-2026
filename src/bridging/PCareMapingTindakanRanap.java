 ...
 * @author dosen
 */
public final class PCareMapingTindakanRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareMapingTindakanRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Tindakan Rawat Inap RS & PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdtindakan.getText().trim().equals("")||TTindakan.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("maping_tindakan_ranap_pcare","?,?,?","Mapping Tindakan",3,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdtindakan,"maping_tindakan_ranap_pcare","kd_jenis_prw");
        runBackground(() ->tampil());
        emptTeks();
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    PCareCekReferensiTindakan barangpcare=new PCareCekReferensiTindakan(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingTindakanRanap dialog = new PCareMapingTindakanRanap(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "maping_tindakan_ranap_pcare.kd_jenis_prw like ? or jns_perawatan_inap.nm_perawatan like ? or maping_tindakan_ranap_pcare.kd_tindakan_pcare like ? or maping_tindakan_ranap_pcare.nm_tindakan_pcare like ? order by jns_perawatan_inap.nm_perawatan");
            try {
