...
public final class SatuSehatKirimDiagnosticReportRadiologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatKirimDiagnosticReportRadiologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Diagnostic Report Radiologi Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
                ...
                try {
                    ...
                    try{
                        ...
                        if(!response.asText().equals("")){
                            if(Sequel.menyimpantf2("satu_sehat_diagnosticreport_radiologi","?,?,?","No.Order",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimDiagnosticReportRadiologi dialog = new SatuSehatKirimDiagnosticReportRadiologi(new javax.swing.JFrame(), true);
