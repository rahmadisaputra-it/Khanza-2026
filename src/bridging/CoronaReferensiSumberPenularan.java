 ...
 * @author dosen
 */
public final class CoronaReferensiSumberPenularan extends javax.swing.JDialog {
    ...
    public CoronaReferensiSumberPenularan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{"Kode","Sumber Penularan"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Referensi Sumber Penularan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiSumberPenularan dialog = new CoronaReferensiSumberPenularan(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
	   ...
	   requestEntity = new HttpEntity(headers);
            root = mapper.readTree(api.getRest().exchange(link+"/Referensi/sebab_penularan", HttpMethod.GET, requestEntity, String.class).getBody());
            Valid.tabelKosong(tabMode);
            response = root.path("sebab_penularan");
            if(response.isArray()){
                for(JsonNode list:response){
                    if(list.path("sources").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                           list.path("id_source").asText(),list.path("sources").asText()
                        }); 
                    }
                }
            }
