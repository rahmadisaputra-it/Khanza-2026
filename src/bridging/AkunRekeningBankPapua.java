 ...
 * @author dosen
 */
public class AkunRekeningBankPapua extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public AkunRekeningBankPapua(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Password & Akun Rekening Host to Host Bank Papua ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdrek.getText().trim().equals("")||nmrek.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()>-1){
                Sequel.queryu("delete from set_akun_bankpapua");
                if(Sequel.menyimpantf("set_akun_bankpapua","?,aes_encrypt(?,'nur'),aes_encrypt(?,'windi')","Akun Rekening",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AkunRekeningBankPapua dialog = new AkunRekeningBankPapua(new javax.swing.JFrame(), true);
