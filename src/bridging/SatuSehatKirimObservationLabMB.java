 ...
 * @author dosen
 */
public final class SatuSehatKirimObservationLabMB extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatKirimObservationLabMB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Observation Lab MB Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try{
            ...
            File f = new File("DataSatuSehatObservationLabMB.html");            
                        ...
                        "<table width='1700px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi2'>"+
                                "<td valign='top' align='center'>"+
                                    ...
                                    "<font size='2' face='Tahoma'>DATA PENGIRIMAN SATU SEHAT OBSERVATION LAB MB<br><br></font>"+        
                                "</td>"+
                           "</tr>"+
                        "</table>")
            );
                ...
                try {
                    ...
                    try{
                        ...
                        if(!response.asText().equals("")){
                            if(Sequel.menyimpantf2("satu_sehat_observation_lab_mb","?,?,?,?","No.Order",4,new String[]{
                                tbObat.getValueAt(i,5).toString(),tbObat.getValueAt(i,19).toString(),tbObat.getValueAt(i,12).toString(),response.asText()
                            })==true){
    ...
    */
    ...
    public void isCek(){
        BtnKirim.setEnabled(akses.getsatu_sehat_kirim_observation_labmb());
        BtnUpdate.setEnabled(akses.getsatu_sehat_kirim_observation_labmb());
        BtnPrint.setEnabled(akses.getsatu_sehat_kirim_observation_labmb());
    }
