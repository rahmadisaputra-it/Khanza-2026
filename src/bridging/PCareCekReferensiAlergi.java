...
public final class PCareCekReferensiAlergi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekReferensiAlergi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        this.setLocation(10,2);
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Alergi","Nama Alergi"}){
        ...
        try {
            ...
            URL = prop.getProperty("URLAPIPCARE")+"/alergi/jenis/";          
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Alergi PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel22.setPreferredSize(new java.awt.Dimension(40, 23));
        panelGlass6.add(jLabel22);

        Jenis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01:Makanan", "02:Udara", "03:Obat" }));
        Jenis.setName("Jenis"); // NOI18N
        Jenis.setPreferredSize(new java.awt.Dimension(115, 23));
        panelGlass6.add(Jenis);

        jLabel16.setText("Alergi :");
        jLabel16.setName("jLabel16"); // NOI18N
        jLabel16.setPreferredSize(new java.awt.Dimension(45, 23));
        panelGlass6.add(jLabel16);

        diagnosa.setName("diagnosa"); // NOI18N
        diagnosa.setPreferredSize(new java.awt.Dimension(150, 23));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariPCAREReferensiAlergi.jasper","report","[ Pencarian Referensi Alergi ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiAlergi dialog = new PCareCekReferensiAlergi(new javax.swing.JFrame(), true);
    ...
    public void tampil(String diagnosa) {
	    ...
	    requestEntity = new HttpEntity(headers);
            System.out.println("URL : "+URL+Jenis.getSelectedItem().toString().substring(0,2));
	    root = mapper.readTree(api.getRest().exchange(URL+Jenis.getSelectedItem().toString().substring(0,2), HttpMethod.GET, requestEntity, String.class).getBody());
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kdAlergi").asText().toLowerCase().contains(diagnosa.toLowerCase())||
                                list.path("nmAlergi").asText().toLowerCase().contains(diagnosa.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kdAlergi").asText(),list.path("nmAlergi").asText()
                            });
                            i++;
                        }
                    }
