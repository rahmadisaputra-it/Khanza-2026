...
public final class BPJSCekReferensiProsedur extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSCekReferensiProsedur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Prosedur","Nama Prosedur"}){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariBPJSReferensiProsedur.jasper","report","[ Pencarian Referensi Prosedur/Tindakan ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiProsedur dialog = new BPJSCekReferensiProsedur(new javax.swing.JFrame(), true);
