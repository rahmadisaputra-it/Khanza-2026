 ...
 * @author dosen
 */
public final class YaskiReferensiPropinsi extends javax.swing.JDialog {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            YaskiReferensiPropinsi dialog = new YaskiReferensiPropinsi(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            if(response.isArray()){
                ...
                for(JsonNode list:response){
                    if(list.path("id").asText().toLowerCase().contains(poli.toLowerCase())||list.path("nama").asText().toLowerCase().contains(poli.toLowerCase())){
