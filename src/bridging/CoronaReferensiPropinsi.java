 ...
 * @author dosen
 */
public final class CoronaReferensiPropinsi extends javax.swing.JDialog {
    ...
    public CoronaReferensiPropinsi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{"Kode","Propinsi"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Referensi Sumber Propinsi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiPropinsi dialog = new CoronaReferensiPropinsi(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
	   ...
	   requestEntity = new HttpEntity(headers);
            root = mapper.readTree(api.getRest().exchange(link+"/Referensi/propinsi", HttpMethod.GET, requestEntity, String.class).getBody());
                ...
                for(JsonNode list:response){
                    if(list.path("propinsi_name").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                           list.path("prop_kode").asText(),list.path("propinsi_name").asText()
                        }); 
                    }
                }
            }
