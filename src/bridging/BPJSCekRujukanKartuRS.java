...
public final class BPJSCekRujukanKartuRS extends javax.swing.JDialog {
    ...
    private String kdkel="",kdkec="",kdkab="",kdprop="",nosisrute="",ADDANTRIANAPIMOBILEJKN="no",BASENOREG="",URUTNOREG="",link="",statuspasien="",pengurutan="",tahun="",bulan="",posisitahun="",awalantahun="",awalanbulan="",
    ...
    private void initComponents() {
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2024 11:35:21" }));
        ...
        jLabel58.setText("Tujuan :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormKelengkapanSEP.add(jLabel58);
        jLabel58.setBounds(495, 235, 90, 23);
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if(NoKartu.getText().trim().equals("")){
            ...
            runBackground(() ->tampil(NoKartu.getText().trim()));
        }
    ...
    */
    ...
    public void SetNoKartu(String NoPeserta){
        ...
        runBackground(() ->tampil(NoPeserta));
        empt=true;
    }
