...
public final class SatuSehatKirimDiagnosticReportLabPK extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatKirimDiagnosticReportLabPK(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Diagnostic Report Lab PK Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try{
            ...
            File f = new File("DataSatuSehatDiagnosticReportLabPK.html");            
                        ...
                        "<table width='2100px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi2'>"+
                                "<td valign='top' align='center'>"+
                                    ...
                                    "<font size='2' face='Tahoma'>DATA PENGIRIMAN SATU SEHAT DIAGNOSTIC REPORT LAB PK<br><br></font>"+        
                                "</td>"+
                           "</tr>"+
                        "</table>")
            );
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){
            if(tbObat.getValueAt(i,0).toString().equals("true")&&(!tbObat.getValueAt(i,4).toString().equals(""))&&(!tbObat.getValueAt(i,7).toString().equals(""))&&tbObat.getValueAt(i,20).toString().equals("")){
                try {
                    ...
                    try{
                        ...
                        if(!response.asText().equals("")){
                            if(Sequel.menyimpantf2("satu_sehat_diagnosticreport_lab","?,?,?,?","No.Order",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimDiagnosticReportLabPK dialog = new SatuSehatKirimDiagnosticReportLabPK(new javax.swing.JFrame(), true);
