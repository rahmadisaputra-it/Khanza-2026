 ...
 * @author dosen
 */
public final class InhealthCariReferensiJenpelRuang extends javax.swing.JDialog {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthCariReferensiJenpelRuang dialog = new InhealthCariReferensiJenpelRuang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                       ...
                       "inhealth_jenpel_ruang_rawat.tarif,trf_kamar,kamar.status from inhealth_jenpel_ruang_rawat inner join kamar inner join bangsal "+
