 ...
 * @author dosen
 */
public final class CoronaReferensiStatusKeluar extends javax.swing.JDialog {
    ...
    public CoronaReferensiStatusKeluar(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{"Kode","Status Keluar"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Referensi Status Keluar ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiStatusKeluar dialog = new CoronaReferensiStatusKeluar(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
	   ...
	   requestEntity = new HttpEntity(headers);
            root = mapper.readTree(api.getRest().exchange(link+"/Referensi/status_keluar", HttpMethod.GET, requestEntity, String.class).getBody());
            Valid.tabelKosong(tabMode);
            response = root.path("status_keluar");
            if(response.isArray()){
                for(JsonNode list:response){
                    if(list.path("status").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                           list.path("id_status").asText(),list.path("status").asText()
                        }); 
                    }
                }
            }
