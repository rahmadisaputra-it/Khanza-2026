 ...
 * @author dosen
 */
public final class PCareMapingObat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareMapingObat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode Obat RS","Nama Obat RS","Kode Obat PCare","Nama Obat PCare"}){
        ...
        KdObatPCare.setDocument(new batasInput((byte)15).getKata(KdObatPCare)); 
    ...
    private void initComponents() {
        ...
        KdObatPCare = new widget.TextBox();
        NmObatPCare = new widget.TextBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Obat PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel19.setText("Obat PCare :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(353, 10, 70, 23);

        KdObatPCare.setEditable(false);
        KdObatPCare.setHighlighter(null);
        KdObatPCare.setName("KdObatPCare"); // NOI18N
        FormInput.add(KdObatPCare);
        KdObatPCare.setBounds(426, 10, 70, 23);

        NmObatPCare.setEditable(false);
        NmObatPCare.setName("NmObatPCare"); // NOI18N
        FormInput.add(NmObatPCare);
        NmObatPCare.setBounds(498, 10, 190, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KdObatPCare.getText().trim().equals("")||NmObatPCare.getText().trim().equals("")){
            Valid.textKosong(KdObatPCare,"Obat PCare");
        }else{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdobat.getText().trim().equals("")||TObat.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("maping_obat_pcare","kode_brng=?","kode_brng=?,kode_brng_pcare=?,nama_brng_pcare=?",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingObat dialog = new PCareMapingObat(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox KdObatPCare;
    private widget.Label LCount;
    private widget.TextBox NmObatPCare;
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "maping_obat_pcare.kode_brng like ? or databarang.nama_brng like ? or maping_obat_pcare.kode_brng_pcare like ? or maping_obat_pcare.nama_brng_pcare like ? order by databarang.nama_brng");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("kode_brng_pcare"),rs.getString("nama_brng_pcare")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
       if(tbJnsPerawatan.getSelectedRow()!= -1){
           ...
           KdObatPCare.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
