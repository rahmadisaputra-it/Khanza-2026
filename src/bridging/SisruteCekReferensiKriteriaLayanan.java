 ...
 * @author dosen
 */
public final class SisruteCekReferensiKriteriaLayanan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SisruteCekReferensiKriteriaLayanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Kriteria Layanan"}){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaLayanan dialog = new SisruteCekReferensiKriteriaLayanan(new javax.swing.JFrame(), true);
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        if(list.path("kode").asText().toLowerCase().contains(faskes.toLowerCase())||
                                list.path("layanan").asText().toLowerCase().contains(faskes.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kode").asText(),list.path("layanan").asText()
                            });                        
                            i++;
                        }
                    }
