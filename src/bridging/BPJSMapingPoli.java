 ...
 * @author dosen
 */
public final class BPJSMapingPoli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Poli/Unit RS & BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        NmPoliBPJS.setBounds(498, 10, 190, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdpoli.getText().trim().equals("")||TPoli.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("maping_poli_bpjs","?,?,?","Mapping Unit",3,new String[]{
                kdpoli.getText(),KdPoliBPJS.getText(),NmPoliBPJS.getText()
            })==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdpoli,"maping_poli_bpjs","kd_poli_rs");
        runBackground(() ->tampil());
        emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSMapingPoli dialog = new BPJSMapingPoli(new javax.swing.JFrame(), true);
    ...
    private void getData() {
       if(tbJnsPerawatan.getSelectedRow()!= -1){
           ...
           KdPoliBPJS.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
           NmPoliBPJS.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
        }
    }
