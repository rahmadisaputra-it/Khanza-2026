 ...
 * @author dosen
 */
public final class PCareClubProlanis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareClubProlanis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Club Prolanis PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel19.setText("Kelompok :");
        jLabel19.setName("jLabel19"); // NOI18N
        jLabel19.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass6.add(jLabel19);

        Khusus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01 Diabetes Melitus", "02 Hipertensi" }));
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        ...
        }else{Valid.pindah(evt,Khusus,BtnKeluar);}
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int r=0;r<row;r++){
                Sequel.menyimpan("temporary","'"+r+"','"+
                    ...
                    tabMode.getValueAt(r,9).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Rekap Harian Pengadaan Ipsrs");
            }
            ...
            Valid.MyReportqry("rptCariPCAREClubProlanis.jasper","report","[ Pencarian Referensi Rujukan Alih Rawat ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Khusus,BtnKeluar);
        }
    }//GEN-LAST:event_BtnCariKeyPressed

    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        tampil(Khusus.getSelectedItem().toString().substring(0,2));
        this.setCursor(Cursor.getDefaultCursor());        
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareClubProlanis dialog = new PCareClubProlanis(new javax.swing.JFrame(), true);
