    ...
    */
    ...
    private void tampil2() {
        ...
        try {
            ...
            htmlContent.append(
                "<tr class='head'>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='1%'>No.</td>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='6%'>Edu Id</td>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='6%'>Pelayanan</td>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='10%'>Kegiatan</td>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='10%'>Kelompok</td>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='21%'>Materi</td>"+
                    "<td valign='top' bgcolor='#FFFAFA' align='center' width='14%'>Pembicara</td>"+
