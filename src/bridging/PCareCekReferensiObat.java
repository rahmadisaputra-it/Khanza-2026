 ...
 * @author dosen
 */
public final class PCareCekReferensiObat extends javax.swing.JDialog {
    ...
    public PCareCekReferensiObat(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Obat","Nama Obat","Sedia"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Obat PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel16.setText("Kode/Nama Obat :");
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int r=0;r<row;r++){  
                Sequel.menyimpan("temporary","'"+r+"','"+
                                ...
                                tabMode.getValueAt(r,3).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Rekap Harian Pengadaan Ipsrs"); 
            }
            ...
            Valid.MyReportqry("rptCariPCAREReferensiObat.jasper","report","[ Pencarian Referensi Obat ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiObat dialog = new PCareCekReferensiObat(new javax.swing.JFrame(), true);
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        tabMode.addRow(new Object[]{
                            i+".",list.path("kdObat").asText(),list.path("nmObat").asText(),list.path("sedia").asText()
                        });
                        i++;
                    }
                }
