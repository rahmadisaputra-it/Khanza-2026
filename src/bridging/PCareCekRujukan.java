 ...
 * @author dosen
 */
public final class PCareCekRujukan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekRujukan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if(diagnosa.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Silahkan masukkan No.Rujukan terlebih dahulu..!!!");
        }else{
            tampil(diagnosa.getText());
        }        
        this.setCursor(Cursor.getDefaultCursor());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekRujukan dialog = new PCareCekRujukan(new javax.swing.JFrame(), true);
