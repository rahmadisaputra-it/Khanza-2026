...
public final class AplicareCekReferensiKamar extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public AplicareCekReferensiKamar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kamar Aplicare BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Kelas.setPreferredSize(new java.awt.Dimension(250, 23));
        Kelas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KelasKeyPressed(evt);
            }
        });
        panelGlass6.add(Kelas);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariAplicareReferensiKamar.jasper","report","[ Pencarian Referensi Kamar Aplicare ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Kelas,BtnPrint);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AplicareCekReferensiKamar dialog = new AplicareCekReferensiKamar(new javax.swing.JFrame(), true);
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kodekelas").asText().toLowerCase().contains(Kelas.getText().toLowerCase())||
                                list.path("namakelas").asText().toLowerCase().contains(Kelas.getText().toLowerCase())){
