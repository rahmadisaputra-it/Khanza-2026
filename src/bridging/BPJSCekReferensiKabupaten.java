...
public final class BPJSCekReferensiKabupaten extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSCekReferensiKabupaten(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPropinsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPropinsiActionPerformed
        BPJSCekReferensiPropinsi propinsi=new BPJSCekReferensiPropinsi(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiKabupaten dialog = new BPJSCekReferensiKabupaten(new javax.swing.JFrame(), true);
