...
public final class SatuSehatKirimServiceRequestLabMB extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatKirimServiceRequestLabMB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Service Request Lab MB Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try{
            ...
            File f = new File("DataSatuSehatServiceRequestLabMB.html");            
                        ...
                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi2'>"+
                                "<td valign='top' align='center'>"+
                                    ...
                                    "<font size='2' face='Tahoma'>DATA PENGIRIMAN SATU SEHAT SERVICE REQUEST LAB MB<br><br></font>"+        
                                "</td>"+
                           "</tr>"+
                        "</table>")
            );
                ...
                try {
                    ...
                    try{
                        ...
                        if(!response.asText().equals("")){
                            if(Sequel.menyimpantf2("satu_sehat_servicerequest_lab_mb","?,?,?,?","No.Order",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimServiceRequestLabMB dialog = new SatuSehatKirimServiceRequestLabMB(new javax.swing.JFrame(), true);
