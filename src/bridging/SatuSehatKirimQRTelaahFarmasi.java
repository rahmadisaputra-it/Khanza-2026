 ...
 * @author dosen
 */
public final class SatuSehatKirimQRTelaahFarmasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatKirimQRTelaahFarmasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{
                "P","Tanggal Registrasi","No.Rawat","No.RM","Nama Pasien","No.KTP Pasien","Petugas Telaah","No.KTP Petugas",
                "ID Encounter","Tanggal & Jam Resep","No.Resep","ID Questionnaire Response","resep_identifikasi_pasien",
                "resep_ket_identifikasi_pasien","resep_tepat_obat","resep_ket_tepat_obat","resep_tepat_dosis","resep_ket_tepat_dosis",
                "resep_tepat_cara_pemberian","resep_ket_tepat_cara_pemberian","resep_tepat_waktu_pemberian",
                "resep_ket_tepat_waktu_pemberian","resep_ada_tidak_duplikasi_obat","resep_ket_ada_tidak_duplikasi_obat",
                "resep_interaksi_obat","resep_ket_interaksi_obat","resep_kontra_indikasi_obat","resep_ket_kontra_indikasi_obat",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Questionnaire Response Telaah Farmasi Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Petugas Telaah</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>No.KTP Petugas</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>ID Encounter</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Tanggal & Jam Resep</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>No.Resep</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>ID Questionnaire Response</b></td>"+
                    "</tr>"
                );
                ...
                File f = new File("DataSatuSehatQRTelaah Farmasi.html");            
                            ...
                            "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA PENGIRIMAN SATU SEHAT QUESTIONNAIRE RESPONSE TELAAH FARMASI<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimQRTelaahFarmasi dialog = new SatuSehatKirimQRTelaahFarmasi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or resep_obat.no_resep like ? or pegawai.no_ktp like ?) "));
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nama"),rs.getString("ktppraktisi"),rs.getString("id_encounter"),rs.getString("tgl_peresepan")+" "+rs.getString("jam_peresepan"),
                        rs.getString("no_resep"),rs.getString("id_questionresponse"),rs.getString("resep_identifikasi_pasien"),rs.getString("resep_ket_identifikasi_pasien"),
                        ...
                        rs.getString("resep_interaksi_obat"),rs.getString("resep_ket_interaksi_obat"),rs.getString("resep_kontra_indikasi_obat"),rs.getString("resep_ket_kontra_indikasi_obat"),
                        rs.getString("obat_tepat_pasien"),rs.getString("obat_tepat_obat"),rs.getString("obat_tepat_dosis"),rs.getString("obat_tepat_cara_pemberian"),
                        rs.getString("obat_tepat_waktu_pemberian")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    public void isCek(){
        BtnKirim.setEnabled(akses.getsatu_sehat_kirim_questionresponse_telaah_farmasi());
        BtnUpdate.setEnabled(akses.getsatu_sehat_kirim_questionresponse_telaah_farmasi());
        BtnPrint.setEnabled(akses.getsatu_sehat_kirim_questionresponse_telaah_farmasi());
    }
