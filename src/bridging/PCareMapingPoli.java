 ...
 * @author dosen
 */
public final class PCareMapingPoli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Poli/Unit PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdpoli.getText().trim().equals("")||TPoli.getText().trim().equals("")){
            Valid.textKosong(kdpoli,"Poli RS");
        }else if(KdPoliPCare.getText().trim().equals("")||NmPoliPCare.getText().trim().equals("")){
            Valid.textKosong(KdPoliPCare,"Poli PCare");
        }else{
            if(Sequel.menyimpantf("maping_poliklinik_pcare","?,?,?","Mapping Poli",3,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdpoli,"maping_poliklinik_pcare","kd_poli_rs");
        runBackground(() ->tampil());
        emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingPoli dialog = new PCareMapingPoli(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        ...
        BtnEdit.setEnabled(akses.getpcare_mapping_poli());
