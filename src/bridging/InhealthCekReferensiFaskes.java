...
public final class InhealthCekReferensiFaskes extends javax.swing.JDialog {
    ...
    private int i=0;
    private String kodeppk=Sequel.cariIsi("select setting.kode_ppkinhealth from setting"),requestJson=""; 
    ...
    public InhealthCekReferensiFaskes(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Provider","Nama Provider","Lokasi"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Faskes Inhealth ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthCekReferensiFaskes dialog = new InhealthCekReferensiFaskes(new javax.swing.JFrame(), true);
            ...
            if(root.isArray()){
                ...
                for(JsonNode list:root){
                    tabMode.addRow(new Object[]{
                        i+".",list.path("KDPROVIDER").asText(),list.path("NMPROVIDER").asText(),list.path("LOKASI").asText()
                    });
                    i++;                 
                }
            }       
