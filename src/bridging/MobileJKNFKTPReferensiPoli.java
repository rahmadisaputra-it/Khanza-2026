 ...
 * @author dosen
 */
public final class MobileJKNFKTPReferensiPoli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MobileJKNFKTPReferensiPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MobileJKNFKTPReferensiPoli dialog = new MobileJKNFKTPReferensiPoli(new javax.swing.JFrame(), true);
