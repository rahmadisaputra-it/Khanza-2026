 ...
 * @author dosen
 */
public final class MandiriBankTujuanTransfer extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MandiriBankTujuanTransfer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        panelGlass7.add(TKd);
        TKd.setBounds(74, 12, 75, 23);

        jLabel4.setText("Nama Bank :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(158, 12, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"Kode Bank");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbJabatan.getSelectedRow()!= -1){
            if(Sequel.meghapustf("bank_tujuan_transfer_bankmandiri","kode_bank",tbJabatan.getValueAt(tbJabatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriBankTujuanTransfer dialog = new MandiriBankTujuanTransfer(new javax.swing.JFrame(), true);
