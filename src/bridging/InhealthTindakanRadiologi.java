 ...
 * @author dosen
 */
public final class InhealthTindakanRadiologi extends javax.swing.JDialog {
    ...
    /** Creates new form DlgJnsPerawatanRadiologi
     * @param parent
     * @param modal */
    public InhealthTindakanRadiologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode RS","Nama Tindakan Radiologi","Tarif","Kode Inhealth"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Tindakan Radiologi di Inhealth ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Tindakan Radiologi :");
    ...
    private void btnPoliRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliRSActionPerformed
        DlgJnsPerawatanRadiologi barang=new DlgJnsPerawatanRadiologi(null,false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdtindakan.getText().trim().equals("")||TTindakan.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("inhealth_tindakan_radiologi","?,?","Mapping Tindakan",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdtindakan,"inhealth_tindakan_radiologi","kd_jenis_prw");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdtindakan.getText().trim().equals("")||TTindakan.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("inhealth_tindakan_radiologi","kd_jenis_prw=?","kd_jenis_prw=?,kd_inhealth=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthTindakanRadiologi dialog = new InhealthTindakanRadiologi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "inhealth_tindakan_radiologi.kd_jenis_prw like ? or jns_perawatan_radiologi.nm_perawatan like ? or inhealth_tindakan_radiologi.kd_inhealth like ? order by jns_perawatan_radiologi.nm_perawatan");
            try {
    ...
    public void isCek(){
        ...
        BtnEdit.setEnabled(akses.getinhealth_mapping_tindakan_radiologi());
