 ...
 * @author dosen
 */
public final class SisruteCekReferensiKriteriaJenis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SisruteCekReferensiKriteriaJenis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Kriteria Jenis"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kriteria Jenis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel16.setText("Kode/Kriteria Jenis :");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaJenis dialog = new SisruteCekReferensiKriteriaJenis(new javax.swing.JFrame(), true);
    ...
    public void tampil(String faskes) {
        try {
            URL = link+"/referensi/jenispelayanan";
            ...
            if(nameNode.asText().equals("200")){
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        if(list.path("ID").asText().toLowerCase().contains(faskes.toLowerCase())||
                                list.path("PELAYANAN").asText().toLowerCase().contains(faskes.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("ID").asText(),list.path("PELAYANAN").asText()
                            });                        
                            i++;
                        }
                    }
