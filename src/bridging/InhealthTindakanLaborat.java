 ...
 * @author dosen
 */
public final class InhealthTindakanLaborat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InhealthTindakanLaborat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode RS","Nama Tindakan Laborat","Tarif","Kode Inhealth"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Tindakan Laborat di Inhealth ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Tindakan Laborat :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdtindakan.getText().trim().equals("")||TTindakan.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("inhealth_tindakan_laborat","?,?","Mapping Tindakan",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdtindakan,"inhealth_tindakan_laborat","kd_jenis_prw");
        tampil();
        emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthTindakanLaborat dialog = new InhealthTindakanLaborat(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "inhealth_tindakan_laborat.kd_jenis_prw like ? or jns_perawatan_lab.nm_perawatan like ? or inhealth_tindakan_laborat.kd_inhealth like ? order by jns_perawatan_lab.nm_perawatan");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kd_jenis_prw"),rs.getString("nm_perawatan"),Valid.SetAngka(rs.getDouble("total_byr")),rs.getString("kd_inhealth")
                    });
                }
            } catch (Exception e) {
