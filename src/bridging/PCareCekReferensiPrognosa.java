 ...
 * @author dosen
 */
public final class PCareCekReferensiPrognosa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekReferensiPrognosa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        this.setLocation(10,2);
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Prognosa","Prognosa"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Prognosa PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariPCAREReferensiPrognosa.jasper","report","[ Pencarian Referensi Prognosa ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiPrognosa dialog = new PCareCekReferensiPrognosa(new javax.swing.JFrame(), true);
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kdPrognosa").asText().toLowerCase().contains(diagnosa.toLowerCase())||
                                list.path("nmPrognosa").asText().toLowerCase().contains(diagnosa.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kdPrognosa").asText(),list.path("nmPrognosa").asText()
                            });
                            i++;
                        }
                    }
