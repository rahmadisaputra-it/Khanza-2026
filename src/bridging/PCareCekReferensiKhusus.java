 ...
 * @author dosen
 */
public final class PCareCekReferensiKhusus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekReferensiKhusus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        this.setLocation(10,2);
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Khusus","Nama Khusus"}){
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Kode/Nama Khusus :");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariPCAREReferensiKhusus.jasper","report","[ Pencarian Referensi Khusus ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiKhusus dialog = new PCareCekReferensiKhusus(new javax.swing.JFrame(), true);
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kdKhusus").asText().toLowerCase().contains(diagnosa.toLowerCase())||
                                list.path("nmKhusus").asText().toLowerCase().contains(diagnosa.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kdKhusus").asText(),list.path("nmKhusus").asText()
                            });
                            i++;
                        }
                    }
