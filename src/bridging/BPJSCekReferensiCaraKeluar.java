 ...
 * @author dosen
 */
public final class BPJSCekReferensiCaraKeluar extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSCekReferensiCaraKeluar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Cara Keluar"}){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiCaraKeluar dialog = new BPJSCekReferensiCaraKeluar(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
	    ...
	    root = mapper.readTree(api.getRest().exchange(URL+"/referensi/carakeluar", HttpMethod.GET, requestEntity, String.class).getBody());
