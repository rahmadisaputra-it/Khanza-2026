 ...
 * @author dosen
 */
public final class SisruteCekReferensiKriteriaSarana extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SisruteCekReferensiKriteriaSarana(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Kriteria Sarana"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kriteria Sarana ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel16.setText("Kode/Kriteria Sarana :");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaSarana dialog = new SisruteCekReferensiKriteriaSarana(new javax.swing.JFrame(), true);
            ...
            if(nameNode.asText().equals("200")){
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        if(list.path("kode_sarana").asText().toLowerCase().contains(faskes.toLowerCase())||
                                list.path("sarana").asText().toLowerCase().contains(faskes.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kode_sarana").asText(),list.path("sarana").asText()
                            });                        
                            i++;
                        }
                    }
