...
public final class BPJSCekDetailSEP2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cek Nomor SEP VClaim ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariBPJSDetailSEP.jasper","report","[ Detail SEP Peserta ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if(SEP.getText().trim().equals("")){
            ...
            runBackground(() ->tampil(SEP.getText()));
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    */
    ...
    private void tampil(String sep) {
        try {
	    ...
	    requestEntity = new HttpEntity(headers);
            ...
            if(nameNode.path("code").asText().equals("200")){
                ...
                tabMode.addRow(new Object[]{
                    "","   Kode Kecamatan",": "+response.path("lokasiKejadian").path("kdKec").asText()
                });
                tabMode.addRow(new Object[]{
                    "","   Kode Kabupaten",": "+response.path("lokasiKejadian").path("kdKab").asText()
                });
                tabMode.addRow(new Object[]{
                    "","   Kode Propinsi",": "+response.path("lokasiKejadian").path("kdProp").asText()
                });
                tabMode.addRow(new Object[]{
                    "","   Keterangan Kejadian",": "+response.path("lokasiKejadian").path("ketKejadian").asText()
                });
                tabMode.addRow(new Object[]{
                    "","   Lokasi",": "+response.path("lokasiKejadian").path("lokasi").asText()
                });
                tabMode.addRow(new Object[]{
                    "","   Tanggal Kejadian",": "+response.path("lokasiKejadian").path("tglKejadian").asText()
                });
                tabMode.addRow(new Object[]{
                ...
                tabMode.addRow(new Object[]{
                    "","   Kode Dokter",": "+response.path("kontrol").path("kdDokter").asText()
                });
                tabMode.addRow(new Object[]{
                    "","   Nama Dokter",": "+response.path("kontrol").path("nmDokter").asText()
                });
                tabMode.addRow(new Object[]{
