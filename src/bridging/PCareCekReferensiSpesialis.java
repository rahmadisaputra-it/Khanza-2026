 ...
 * @author dosen
 */
public final class PCareCekReferensiSpesialis extends javax.swing.JDialog {
    ...
    public PCareCekReferensiSpesialis(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Spesialis","Nama Spesialis"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Spesialis PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel16.setText("Kode/Nama Spesialis :");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariPCAREReferensiSpesialis.jasper","report","[ Pencarian Referensi Unit/Spesialis ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiSpesialis dialog = new PCareCekReferensiSpesialis(new javax.swing.JFrame(), true);
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kdSpesialis").asText().toLowerCase().contains(diagnosa.toLowerCase())||
                                list.path("nmSpesialis").asText().toLowerCase().contains(diagnosa.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kdSpesialis").asText(),list.path("nmSpesialis").asText()
                            });
                            i++;
                        }
                    }
