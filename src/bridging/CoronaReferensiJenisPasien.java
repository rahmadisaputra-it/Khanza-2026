 ...
 * @author dosen
 */
public final class CoronaReferensiJenisPasien extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public CoronaReferensiJenisPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"Kode","Jenis Pasien"}){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiJenisPasien dialog = new CoronaReferensiJenisPasien(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
	   ...
	   requestEntity = new HttpEntity(headers);
            root = mapper.readTree(api.getRest().exchange(link+"/Referensi/jenis_pasien", HttpMethod.GET, requestEntity, String.class).getBody());
            Valid.tabelKosong(tabMode);
            response = root.path("jenis_pasien");
            if(response.isArray()){
                for(JsonNode list:response){
                    if(list.path("deskripsi").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                           list.path("id_jenis_pasien").asText(),list.path("deskripsi").asText()
                        }); 
                    }
                }
            }
