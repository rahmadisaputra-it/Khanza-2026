 ...
 * @author dosen
 */
public final class InhealthTindakanRanap extends javax.swing.JDialog {
    ...
    /** Creates new form DlgJnsPerawatanRanap
     * @param parent
     * @param modal */
    public InhealthTindakanRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode RS","Nama Tindakan Ranap","Ttl Biaya Dr","Ttl Biaya Pr","Ttl Biaya Dr & Pr","Kode Inhealth"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Tindakan Rawat Inap di Inhealth ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TTindakan.setBounds(207, 10, 280, 23);
    ...
    private void btnPoliRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliRSActionPerformed
        DlgJnsPerawatanRanap barang=new DlgJnsPerawatanRanap(null,false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdtindakan.getText().trim().equals("")||TTindakan.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("inhealth_tindakan_ranap","?,?","Mapping Tindakan",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdtindakan,"inhealth_tindakan_ranap","kd_jenis_prw");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdtindakan.getText().trim().equals("")||TTindakan.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("inhealth_tindakan_ranap","kd_jenis_prw=?","kd_jenis_prw=?,kd_inhealth=?",3,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptMapingTindakanInhealthRanap.jasper","report","::[ Mapping Tarif Rawat Inap Inhealth ]::",param);            
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthTindakanRanap dialog = new InhealthTindakanRanap(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "inhealth_tindakan_ranap.kd_jenis_prw like ? or jns_perawatan_inap.nm_perawatan like ? or inhealth_tindakan_ranap.kd_inhealth like ? order by jns_perawatan_inap.nm_perawatan");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kd_jenis_prw"),rs.getString("nm_perawatan"),Valid.SetAngka(rs.getDouble("total_byrdr")),Valid.SetAngka(rs.getDouble("total_byrpr")),Valid.SetAngka(rs.getDouble("total_byrdrpr")),rs.getString("kd_inhealth")
                    });
                }
            } catch (Exception e) {
    ...
    public void isCek(){
        ...
        BtnEdit.setEnabled(akses.getinhealth_mapping_tindakan_ranap());
        BtnPrint.setEnabled(akses.getinhealth_mapping_tindakan_ranap());
    }
