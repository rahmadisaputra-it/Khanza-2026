 ...
 * @author dosen
 */
public final class SisruteCekReferensiKriteriaSDM extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SisruteCekReferensiKriteriaSDM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Kriteria SDM"}){
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Kode/Kriteria SDM :");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaSDM dialog = new SisruteCekReferensiKriteriaSDM(new javax.swing.JFrame(), true);
    ...
    public void tampil(String faskes) {
        try {
            URL = link+"/rsonline/referensi/sdm";
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        if(list.path("kode").asText().toLowerCase().contains(faskes.toLowerCase())||
                                list.path("sdm").asText().toLowerCase().contains(faskes.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kode").asText(),list.path("sdm").asText()
                            });                        
                            i++;
                        }
                    }
