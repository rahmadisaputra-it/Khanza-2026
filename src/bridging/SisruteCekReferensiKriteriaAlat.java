 ...
 * @author dosen
 */
public final class SisruteCekReferensiKriteriaAlat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SisruteCekReferensiKriteriaAlat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Kriteria Alat"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kriteria Alat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel16.setText("Kode/Kriteria Alat :");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaAlat dialog = new SisruteCekReferensiKriteriaAlat(new javax.swing.JFrame(), true);
    ...
    public void tampil(String faskes) {
        try {
            URL = link+"/rsonline/referensi/alkes";
