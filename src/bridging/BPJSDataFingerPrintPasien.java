 ...
 * @author dosen
 */
public final class BPJSDataFingerPrintPasien extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSDataFingerPrintPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("peserta","Tanggal : "+Valid.SetTgl(DTPTanggal.getSelectedItem()+""));
            param.put("kontakrs",akses.getkontakrs());
            param.put("emailrs",akses.getemailrs());   
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCariBPJSDataFingerPrint.jasper","report","[ Data Pasien Finger Print ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,DTPTanggal,BtnPrint);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataFingerPrintPasien dialog = new BPJSDataFingerPrintPasien(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
	    ...
	    requestEntity = new HttpEntity(headers);
            URL = link+"/SEP/FingerPrint/List/Peserta/TglPelayanan/"+Valid.SetTgl(DTPTanggal.getSelectedItem()+"");	
