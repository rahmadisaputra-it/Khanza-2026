 ...
 * @author dosen
 */
public final class PCareCekReferensiProvider extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekReferensiProvider(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        this.setLocation(10,2);
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Provider","Nama Provider"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Provider PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel16.setText("Kode/Nama Provider :");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptCariPCAREReferensiProvider.jasper","report","[ Pencarian Referensi Provider ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiProvider dialog = new PCareCekReferensiProvider(new javax.swing.JFrame(), true);
            ...
            if(nameNode.path("message").asText().equals("OK")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kdProvider").asText().toLowerCase().contains(diagnosa.toLowerCase())||
                                list.path("nmProvider").asText().toLowerCase().contains(diagnosa.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kdProvider").asText(),list.path("nmProvider").asText()
                            });
                            i++;
                        }
                    }
