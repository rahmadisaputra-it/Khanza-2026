 ...
 * @author dosen
 */
public final class InhealthMapingPoli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InhealthMapingPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        KdPoliInhealth = new widget.TextBox();
        NmPoliInhealth = new widget.TextBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Poli/Unit RS & Inhealth ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel19.setText("Unit Inhealth :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(353, 10, 80, 23);

        KdPoliInhealth.setEditable(false);
        KdPoliInhealth.setHighlighter(null);
        KdPoliInhealth.setName("KdPoliInhealth"); // NOI18N
        FormInput.add(KdPoliInhealth);
        KdPoliInhealth.setBounds(436, 10, 70, 23);

        NmPoliInhealth.setEditable(false);
        NmPoliInhealth.setName("NmPoliInhealth"); // NOI18N
        FormInput.add(NmPoliInhealth);
        NmPoliInhealth.setBounds(508, 10, 180, 23);

        btnPoliInhealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        btnPoliInhealth.setMnemonic('3');
        btnPoliInhealth.setToolTipText("ALt+3");
        ...
        btnPoliInhealth.setBounds(690, 10, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KdPoliInhealth.getText().trim().equals("")||NmPoliInhealth.getText().trim().equals("")){
            Valid.textKosong(KdPoliInhealth,"Unit Inhealth");
        }else{
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        ...
        }else{Valid.pindah(evt,btnPoliInhealth, BtnBatal);}
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdpoli.getText().trim().equals("")||TPoli.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("inhealth_maping_poli","kd_poli_rs=?","kd_poli_rs=?,kd_poli_inhealth=?,nm_poli_inhealth=?",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthMapingPoli dialog = new InhealthMapingPoli(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox KdPoliInhealth;
    private widget.Label LCount;
    private widget.TextBox NmPoliInhealth;
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "inhealth_maping_poli.kd_poli_rs like ? or poliklinik.nm_poli like ? or inhealth_maping_poli.kd_poli_inhealth like ? or inhealth_maping_poli.nm_poli_inhealth like ? order by poliklinik.nm_poli");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kd_poli_rs"),rs.getString("nm_poli"),rs.getString("kd_poli_inhealth"),rs.getString("nm_poli_inhealth")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        kdpoli.setText("");
        TPoli.setText("");
        KdPoliInhealth.setText("");
        NmPoliInhealth.setText("");
        kdpoli.requestFocus();
    }
    ...
    private void getData() {
       if(tbJnsPerawatan.getSelectedRow()!= -1){
           ...
           KdPoliInhealth.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
           NmPoliInhealth.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
        }
    }
