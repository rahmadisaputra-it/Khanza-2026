 ...
 * @author dosen
 */
public class MasterMasalahKeperawatanAnak extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterMasalahKeperawatanAnak(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Masalah Keperawatan Bayi/Anak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("master_masalah_keperawatan_anak","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_masalah_keperawatan_anak","kode_masalah")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_masalah_keperawatan_anak","kode_masalah=?","kode_masalah=?,nama_masalah=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanAnak dialog = new MasterMasalahKeperawatanAnak(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_masalah_keperawatan_anak where master_masalah_keperawatan_anak.kode_masalah like ? or master_masalah_keperawatan_anak.nama_masalah like ? order by master_masalah_keperawatan_anak.kode_masalah");
            try {
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getmaster_masalah_keperawatan_anak());
       BtnHapus.setEnabled(akses.getmaster_masalah_keperawatan_anak());
       BtnEdit.setEnabled(akses.getmaster_masalah_keperawatan_anak());
    }
