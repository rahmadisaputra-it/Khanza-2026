 ...
 * @author dosen
 */
public class MasterMasalahKeperawatanGigi extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("master_masalah_keperawatan_gigi","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_masalah_keperawatan_gigi","kode_masalah")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_masalah_keperawatan_gigi","kode_masalah=?","kode_masalah=?,nama_masalah=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanGigi dialog = new MasterMasalahKeperawatanGigi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_masalah_keperawatan_gigi where master_masalah_keperawatan_gigi.kode_masalah like ? or master_masalah_keperawatan_gigi.nama_masalah like ? order by master_masalah_keperawatan_gigi.kode_masalah");
            try {
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getmaster_masalah_keperawatan_gigi());
    }
