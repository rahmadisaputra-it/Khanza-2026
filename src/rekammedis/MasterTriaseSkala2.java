 ...
 * @author dosen
 */
public class MasterTriaseSkala2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTriaseSkala2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Triase Skala 2 Emergensi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdskala.getText().trim().equals("")){
            ...
            Sequel.menyimpan("master_triase_skala2","'"+kdpemeriksaan.getText()+"','"+kdskala.getText()+"','"+namaskala.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
       if(Valid.hapusTabletf(tabMode,kdskala,"master_triase_skala2","kode_skala2")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdskala.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_triase_skala2","kode_skala2=?","kode_skala2=?,pengkajian_skala2=?,kode_pemeriksaan=?",4,new String[]{
    ...
    private void btnPemeriksaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPemeriksaanActionPerformed
        MasterTriasePemeriksaan pemeriksaan=new MasterTriasePemeriksaan(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseSkala2 dialog = new MasterTriaseSkala2(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "master_triase_skala2.kode_skala2,master_triase_skala2.pengkajian_skala2 from master_triase_skala2 "+
                    "inner join master_triase_pemeriksaan on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala2.kode_pemeriksaan "+
                    "where master_triase_skala2.kode_skala2 like ? or master_triase_skala2.pengkajian_skala2 like ? or "+
                    "master_triase_pemeriksaan.nama_pemeriksaan like ? order by master_triase_skala2.kode_skala2");
            try {
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getmaster_triase_skala2());
       BtnHapus.setEnabled(akses.getmaster_triase_skala2());
       BtnEdit.setEnabled(akses.getmaster_triase_skala2());
    }
