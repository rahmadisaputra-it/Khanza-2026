 ...
 * @author dosen
 */
public class MasterRencanaKeperawatanGigi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterRencanaKeperawatanGigi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            Sequel.menyimpan("master_rencana_keperawatan_gigi","'"+kdmasalah.getText()+"','"+kdrencana.getText()+"','"+namarencana.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,kdrencana,"master_rencana_keperawatan_gigi","kode_rencana")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_rencana_keperawatan_gigi","kode_rencana=?","kode_rencana=?,rencana_keperawatan=?,kode_masalah=?",4,new String[]{
    ...
    private void btnPemeriksaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPemeriksaanActionPerformed
        MasterMasalahKeperawatanGigi masalah=new MasterMasalahKeperawatanGigi(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanGigi dialog = new MasterRencanaKeperawatanGigi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select master_masalah_keperawatan_gigi.kode_masalah,master_masalah_keperawatan_gigi.nama_masalah,"+
                    "master_rencana_keperawatan_gigi.kode_rencana,master_rencana_keperawatan_gigi.rencana_keperawatan from master_rencana_keperawatan_gigi "+
                    "inner join master_masalah_keperawatan_gigi on master_masalah_keperawatan_gigi.kode_masalah=master_rencana_keperawatan_gigi.kode_masalah "+
                    "where master_rencana_keperawatan_gigi.kode_rencana like ? or master_rencana_keperawatan_gigi.rencana_keperawatan like ? or "+
                    "master_masalah_keperawatan_gigi.nama_masalah like ? order by master_rencana_keperawatan_gigi.kode_rencana");
            try {
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getmaster_rencana_keperawatan_gigi());
       BtnHapus.setEnabled(akses.getmaster_rencana_keperawatan_gigi());
       BtnEdit.setEnabled(akses.getmaster_rencana_keperawatan_gigi());
    }
