...
public class DlgSOAPRalanAggotaTNI extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgSOAPRalanAggotaTNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ SOAP Rawat Jalan Anggota TNI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            File f = new File("SOAPRalanAnggotaTni.html");            
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSOAPRalanAggotaTNI dialog = new DlgSOAPRalanAggotaTNI(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            if(Pangkat.getText().trim().equals("")&&Satuan.getText().trim().equals("")&&Golongan.getText().trim().equals("")&&
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "reg_periksa.no_rawat,golongan_tni.nama_golongan,jabatan_tni.nama_jabatan,pasien.jk,pasien.umur,dokter.nm_dokter,poliklinik.nm_poli,"+
    ...
    public void isCek(){
        BtnPrint.setEnabled(akses.getsoap_ralan_tni());
    }
