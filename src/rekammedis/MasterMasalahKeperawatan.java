 ...
 * @author dosen
 */
public class MasterMasalahKeperawatan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterMasalahKeperawatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatan dialog = new MasterMasalahKeperawatan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_masalah_keperawatan where master_masalah_keperawatan.kode_masalah like ? or master_masalah_keperawatan.nama_masalah like ? order by master_masalah_keperawatan.kode_masalah");
            try {
