 ...
 * @author dosen
 */
public class MasterTriaseSkala1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTriaseSkala1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Triase Skala 1 Immediate/Segera ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdskala.getText().trim().equals("")){
            ...
            Sequel.menyimpan("master_triase_skala1","'"+kdpemeriksaan.getText()+"','"+kdskala.getText()+"','"+namaskala.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdskala.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_triase_skala1","kode_skala1=?","kode_skala1=?,pengkajian_skala1=?,kode_pemeriksaan=?",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseSkala1 dialog = new MasterTriaseSkala1(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "master_triase_skala1.kode_skala1,master_triase_skala1.pengkajian_skala1 from master_triase_skala1 "+
                    "inner join master_triase_pemeriksaan on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala1.kode_pemeriksaan "+
                    "where master_triase_skala1.kode_skala1 like ? or master_triase_skala1.pengkajian_skala1 like ? or "+
                    "master_triase_pemeriksaan.nama_pemeriksaan like ? order by master_triase_skala1.kode_skala1");
            try {
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getmaster_triase_skala1());
    }
