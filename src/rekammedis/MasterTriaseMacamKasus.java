 ...
 * @author dosen
 */
public class MasterTriaseMacamKasus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTriaseMacamKasus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Macam Kasus"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Macam Kasus");
        }else{
            Sequel.menyimpan("master_triase_macam_kasus","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_triase_macam_kasus","kode_kasus=?","kode_kasus=?,macam_kasus=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseMacamKasus dialog = new MasterTriaseMacamKasus(new javax.swing.JFrame(), true);
