 ...
 * @author dosen
 */
public class MasterTemplateInformasiEdukasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTemplateInformasiEdukasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Template Informasi & Edukasi","Lama Edukasi","Metode"};
        ...
        KodeEdukasi.setDocument(new batasInput((byte)3).getKata(KodeEdukasi));
        LamaEdukasi.setDocument(new batasInput((int)100).getKata(LamaEdukasi));
    ...
    private void initComponents() {
        ...
        KodeEdukasi = new widget.TextBox();
        LamaEdukasi = new widget.TextBox();
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(44, 115));
        ...
        jLabel4.setText("Lama Edukasi :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(124, 10, 105, 23);

        KodeEdukasi.setHighlighter(null);
        KodeEdukasi.setName("KodeEdukasi"); // NOI18N
        KodeEdukasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KodeEdukasiKeyPressed(evt);
            }
        });
        panelGlass7.add(KodeEdukasi);
        KodeEdukasi.setBounds(49, 10, 70, 23);

        LamaEdukasi.setName("LamaEdukasi"); // NOI18N
        LamaEdukasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                LamaEdukasiKeyPressed(evt);
            }
        });
        panelGlass7.add(LamaEdukasi);
        LamaEdukasi.setBounds(233, 10, 50, 23);
        ...
        scrollPane2.setBounds(14, 60, 503, 43);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("menit");
        jLabel13.setName("jLabel13"); // NOI18N
        panelGlass7.add(jLabel13);
        jLabel13.setBounds(286, 10, 50, 23);
        ...
        panelGlass7.add(Metode);
        Metode.setBounds(402, 10, 115, 23);

        jLabel22.setText("Metode :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass7.add(jLabel22);
        jLabel22.setBounds(328, 10, 70, 23);

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Kode");
        jLabel5.setName("jLabel5"); // NOI18N
        panelGlass7.add(jLabel5);
        jLabel5.setBounds(14, 10, 43, 23);

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel8.setText("Template Informasi & Edukasi :");
        jLabel8.setName("jLabel8"); // NOI18N
        panelGlass7.add(jLabel8);
        jLabel8.setBounds(14, 40, 190, 23);
    ...
    private void KodeEdukasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeEdukasiKeyPressed
        Valid.pindah(evt,TCari,LamaEdukasi);
}//GEN-LAST:event_KodeEdukasiKeyPressed

    private void LamaEdukasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LamaEdukasiKeyPressed
        Valid.pindah(evt,KodeEdukasi,Metode);
}//GEN-LAST:event_LamaEdukasiKeyPressed

    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KodeEdukasi.getText().trim().equals("")){
            Valid.textKosong(KodeEdukasi,"Kode");
        }else if(LamaEdukasi.getText().trim().equals("")){
            Valid.textKosong(LamaEdukasi,"Lama Edukasi");
        }else if(Template.getText().trim().equals("")){
            Valid.textKosong(Template,"Template Informasi & Edukasi");
        }else{
            if(Sequel.menyimpantf("template_pelaksanaan_informasi_edukasi","'"+KodeEdukasi.getText()+"','"+Template.getText()+"','"+LamaEdukasi.getText()+"','"+Metode.getSelectedItem()+"'","Kode")==true){
                tabMode.addRow(new Object[]{KodeEdukasi.getText(),Template.getText(),LamaEdukasi.getText(),Metode.getSelectedItem().toString()});
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,KodeEdukasi,"template_pelaksanaan_informasi_edukasi","no_template")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(KodeEdukasi.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("template_pelaksanaan_informasi_edukasi","no_template=?","no_template=?,materi_edukasi=?,lama_edukasi=?,metode_edukasi=?",5,new String[]{
                    KodeEdukasi.getText(),Template.getText(),LamaEdukasi.getText(),Metode.getSelectedItem().toString(),tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString()
                })==true){
                    tbSpesialis.setValueAt(KodeEdukasi.getText(),tbSpesialis.getSelectedRow(),0);
                    tbSpesialis.setValueAt(Template.getText(),tbSpesialis.getSelectedRow(),1);
                    tbSpesialis.setValueAt(LamaEdukasi.getText(),tbSpesialis.getSelectedRow(),2);
                    tbSpesialis.setValueAt(Metode.getSelectedItem().toString(),tbSpesialis.getSelectedRow(),3);
                    emptTeks();
                }
            }
        }
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, BtnCari, KodeEdukasi);
        }
    ...
    private void TemplateKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TemplateKeyPressed
        Valid.pindah2(evt,Metode,BtnSimpan);
    ...
    private void MetodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MetodeKeyPressed
        Valid.pindah(evt,LamaEdukasi,Template);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTemplateInformasiEdukasi dialog = new MasterTemplateInformasiEdukasi(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox KodeEdukasi;
    private widget.Label LCount;
    private widget.TextBox LamaEdukasi;
    ...
    private void emptTeks() {
        ...
        KodeEdukasi.requestFocus();
        Valid.autoNomer(tabMode,"E",3,KodeEdukasi);
        KodeEdukasi.requestFocus();
    }

    private void getData() {
        if(tbSpesialis.getSelectedRow()!= -1){
            KodeEdukasi.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString());
            Template.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),1).toString());
            LamaEdukasi.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),2).toString());
