 ...
 * @author dosen
 */
public class MasterRencanaKeperawatanGeriatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterRencanaKeperawatanGeriatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,kdrencana,"master_rencana_keperawatan_geriatri","kode_rencana")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_rencana_keperawatan_geriatri","kode_rencana=?","kode_rencana=?,rencana_keperawatan=?,kode_masalah=?",4,new String[]{
    ...
    private void btnPemeriksaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPemeriksaanActionPerformed
        MasterMasalahKeperawatanGeriatri masalah=new MasterMasalahKeperawatanGeriatri(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanGeriatri dialog = new MasterRencanaKeperawatanGeriatri(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "inner join master_masalah_keperawatan_geriatri on master_masalah_keperawatan_geriatri.kode_masalah=master_rencana_keperawatan_geriatri.kode_masalah "+
                    "where master_rencana_keperawatan_geriatri.kode_rencana like ? or master_rencana_keperawatan_geriatri.rencana_keperawatan like ? or "+
                    "master_masalah_keperawatan_geriatri.nama_masalah like ? order by master_rencana_keperawatan_geriatri.kode_rencana");
            try {
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getmaster_rencana_keperawatan_geriatri());
       BtnHapus.setEnabled(akses.getmaster_rencana_keperawatan_geriatri());
       BtnEdit.setEnabled(akses.getmaster_rencana_keperawatan_geriatri());
    }
