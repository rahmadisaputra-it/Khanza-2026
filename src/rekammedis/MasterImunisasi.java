 ...
 * @author dosen
 */
public class MasterImunisasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterImunisasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Imunisasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Nama Imunisasi :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Imunisasi");
        }else{
            if(Sequel.menyimpantf("master_imunisasi","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_imunisasi","kode_imunisasi")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_imunisasi","kode_imunisasi=?","kode_imunisasi=?,nama_imunisasi=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterImunisasi dialog = new MasterImunisasi(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getmaster_imunisasi());
       BtnHapus.setEnabled(akses.getmaster_imunisasi());
       BtnEdit.setEnabled(akses.getmaster_imunisasi());
    }
