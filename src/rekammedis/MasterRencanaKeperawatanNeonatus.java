 ...
 * @author dosen
 */
public class MasterRencanaKeperawatanNeonatus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterRencanaKeperawatanNeonatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Rencana Keperawatan Neonatus ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            Sequel.menyimpan("master_rencana_keperawatan_neonatus","'"+kdmasalah.getText()+"','"+kdrencana.getText()+"','"+namarencana.getText()+"'","Kode");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,kdrencana,"master_rencana_keperawatan_neonatus","kode_rencana")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_rencana_keperawatan_neonatus","kode_rencana=?","kode_rencana=?,rencana_keperawatan=?,kode_masalah=?",4,new String[]{
    ...
    private void btnPemeriksaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPemeriksaanActionPerformed
        MasterMasalahKeperawatanNeonatus masalah=new MasterMasalahKeperawatanNeonatus(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanNeonatus dialog = new MasterRencanaKeperawatanNeonatus(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select master_masalah_keperawatan_neonatus.kode_masalah,master_masalah_keperawatan_neonatus.nama_masalah,"+
                    "master_rencana_keperawatan_neonatus.kode_rencana,master_rencana_keperawatan_neonatus.rencana_keperawatan from master_rencana_keperawatan_neonatus "+
                    "inner join master_masalah_keperawatan_neonatus on master_masalah_keperawatan_neonatus.kode_masalah=master_rencana_keperawatan_neonatus.kode_masalah "+
                    "where master_rencana_keperawatan_neonatus.kode_rencana like ? or master_rencana_keperawatan_neonatus.rencana_keperawatan like ? or "+
                    "master_masalah_keperawatan_neonatus.nama_masalah like ? order by master_rencana_keperawatan_neonatus.kode_rencana");
            try {
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getmaster_rencana_keperawatan_neonatus());
    }
