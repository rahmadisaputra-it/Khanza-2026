...
public class RMMasterKesimpulanAnjuranMCU extends javax.swing.JDialog {
    ...
    public RMMasterKesimpulanAnjuranMCU(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kesimpulan/Diagnosa","Anjuran"};
    ...
    private void initComponents() {
        ...
        Kesimpulan.setBounds(84, 10, 430, 23);
        ...
        Anjuran.setBounds(84, 40, 430, 23);
        ...
        if(Kesimpulan.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_kesimpulan_anjuran_mcu","kesimpulan=? and anjuran=?","kesimpulan=?,anjuran=?",4,new String[]{
                    ...
                    tbSpesialis.setValueAt(Kesimpulan.getText(),tbSpesialis.getSelectedRow(),0);
                    tbSpesialis.setValueAt(Anjuran.getText(),tbSpesialis.getSelectedRow(),1);
                    emptTeks();
                }
            }
        }
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, BtnCari, Kesimpulan);
        }
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    " order by master_kesimpulan_anjuran_mcu.kesimpulan");
            try {
    ...
    private void getData() {
        if(tbSpesialis.getSelectedRow()!= -1){
            Kesimpulan.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString());
    ...
    public void isCek(){
       ...
       BtnEdit.setEnabled(akses.getmaster_kesimpulan_anjuran_mcu());
    }
