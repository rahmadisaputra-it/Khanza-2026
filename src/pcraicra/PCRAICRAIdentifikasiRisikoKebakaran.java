 ...
 * @author dosen
 */
public final class PCRAICRAIdentifikasiRisikoKebakaran extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCRAICRAIdentifikasiRisikoKebakaran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Identifikasi Risiko Kebakaran ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Risiko Kebakaran :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KodeRisiko.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pcra_icra_identifkasi_risiko_kebakaran","'"+KodeRisiko.getText()+"','"+NamaRisiko.getText()+"'","Kode Aktivitas")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbJabatan.getSelectedRow()!= -1){
            if(Sequel.meghapustf("pcra_icra_identifkasi_risiko_kebakaran","kode_risiko",tbJabatan.getValueAt(tbJabatan.getSelectedRow(),0).toString())==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(KodeRisiko.getText().trim().equals("")){
            ...
            if(tbJabatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("pcra_icra_identifkasi_risiko_kebakaran","kode_risiko=?","kode_risiko=?,nama_risiko=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCRAICRAIdentifikasiRisikoKebakaran dialog = new PCRAICRAIdentifikasiRisikoKebakaran(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer(" pcra_icra_identifkasi_risiko_kebakaran ","RA",3,KodeRisiko);
    }
