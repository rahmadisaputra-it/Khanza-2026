 ...
 * @author dosen
 */
public final class PCRAICRACariKelasRisikoPencegahan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCRAICRACariKelasRisikoPencegahan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCRAICRACariKelasRisikoPencegahan dialog = new PCRAICRACariKelasRisikoPencegahan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            file=new File("./cache/pcraicrakelasrisikopencegahan.iyem");
            file.createNewFile();
    ...
    private void tampil2() {
        try {
            ...
            Valid.tabelKosong(tabMode);
            response = root.path("pcraicrakelasrisikopencegahan");
            if(response.isArray()){
