 ...
 * @author dosen
 */
public final class DlgRuangOperasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRuangOperasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(545,599);

        tabMode=new DefaultTableModel(null,new Object[]{"Kode Ruang","Nama Ruang Operasi"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Ruang Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Nama Ruang Operasi :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass8.add(jLabel4);
        jLabel4.setBounds(192, 12, 130, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"Kode Ruang Operasi");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Nama Ruang Operasi");
        }else{
            if(Sequel.menyimpantf("ruang_ok","?,?","Kode Ruang",2,new String[]{TKd.getText(),TNm.getText()})==true){
                runBackground(() ->tampil());
                emptTeks();
            }else{
                TKd.requestFocus();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbBangsal.getSelectedRow()>-1){
            Sequel.meghapus("ruang_ok","kd_ruang_ok",tbBangsal.getValueAt(tbBangsal.getSelectedRow(),0).toString());
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRuangOperasi dialog = new DlgRuangOperasi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from ruang_ok where kd_ruang_ok like ? "+
                    "or nm_ruang_ok like ? order by kd_ruang_ok");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(" ruang_ok ","O",1,TKd);
    }

    private void getData() {
        if(tbBangsal.getSelectedRow()!= -1){
            TKd.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),0).toString());
    ...
    public void isCek(){
        ...
        BtnHapus.setEnabled(akses.getruang_ok());
        BtnPrint.setEnabled(akses.getruang_ok());
    }
