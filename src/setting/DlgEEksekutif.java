 ...
 * @author perpustakaan
 */
public class DlgEEksekutif extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgEEksekutif(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(457,249);

        Object[] row={"ID User","Password"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup E-Eksekutif ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"ID User");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Password");
        }else if(tabMode.getRowCount()==0){
            Sequel.menyimpan("e_eksekutif","AES_ENCRYPT('"+TKd.getText()+"','nur'),AES_ENCRYPT('"+TNm.getText()+"','windi')","Kode User");
            runBackground(() ->tampil());
            emptTeks();
        }else if(tabMode.getRowCount()>0){
            JOptionPane.showMessageDialog(null,"Maaf, Hanya diijinkan satu User ...!!!!");
            TKd.requestFocus();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Sequel.queryu("delete from e_eksekutif");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data e_eksekutif tidak boleh kosong ...!!!!");
            TKd.requestFocus();
        }else if(! (tabMode.getRowCount()==0)) {
            dispose();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgEEksekutif dialog = new DlgEEksekutif(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select AES_DECRYPT(usere,'nur'),AES_DECRYPT(passworde,'windi') from e_eksekutif");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
