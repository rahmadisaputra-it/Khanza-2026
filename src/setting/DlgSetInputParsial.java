 ...
 * @author dosen
 */
public class DlgSetInputParsial extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgSetInputParsial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Cara Bayar Yang Bisa Menggunakan Billing Parsial Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdpj.getText().trim().equals("")||nmpj.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()>-1){
                Sequel.mengedit("set_input_parsial","kd_pj=?","kd_pj=?",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdpj,"set_input_parsial","kd_pj");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,kdpj,BtnBatal);
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdpj.getText().trim().equals("")||nmpj.getText().trim().equals("")){
            ...
            Sequel.menyimpan("set_input_parsial","?","Cara Bayar",1,new String[]{
                kdpj.getText()
            });
            runBackground(() ->tampil());
            emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetInputParsial dialog = new DlgSetInputParsial(new javax.swing.JFrame(), true);
