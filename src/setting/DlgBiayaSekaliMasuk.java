...
public class DlgBiayaSekaliMasuk extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Biaya Inap Sekali Masuk ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
        ...
        jLabel3.setBounds(0, 42, 82, 23);

        jLabel4.setText("Tarif Harian :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(296, 42, 100, 23);
        ...
        NmBiaya.setBounds(86, 42, 210, 23);
        ...
        BiayaHarian.setBounds(400, 42, 120, 23);

        jLabel12.setText("Kamar :");
        jLabel12.setName("jLabel12"); // NOI18N
        panelGlass7.add(jLabel12);
        jLabel12.setBounds(0, 12, 82, 23);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                "select biaya_sekali.kd_kamar,bangsal.nm_bangsal,biaya_sekali.nama_biaya,biaya_sekali.besar_biaya from biaya_sekali "+
                "inner join kamar on biaya_sekali.kd_kamar=kamar.kd_kamar inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal  "+
                (TCari.getText().trim().equals("")?"":"where biaya_sekali.kd_kamar like ? or bangsal.nm_bangsal like ? or "+
                "biaya_sekali.nama_biaya like ? or biaya_sekali.besar_biaya like ? ")+"order by bangsal.nm_bangsal,biaya_sekali.nama_biaya");
            try {
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    tabMode.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),Valid.SetAngka(rs.getDouble(4))});
                 }
            } catch (Exception e) {
