 ...
 * @author perpustakaan
 */
public final class DlgLhtBankPapua extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgLhtBankPapua(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pembayaran Bank Papua ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLhtBankPapua dialog = new DlgLhtBankPapua(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement("select * from tagihan_bpd_papua where tagihan_bpd_papua.tgl_closing between ? and ? "+
                   ...
                   "tagihan_bpd_papua.status_lanjut like ? or tagihan_bpd_papua.status_bayar like ? or tagihan_bpd_papua.kasir like ? or "+
                   "tagihan_bpd_papua.keterangan like ?) ")+"order by tagihan_bpd_papua.tgl_closing");
            try {
