...
public class KeuanganCariTagihanDapur extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KeuanganCariTagihanDapur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void btnPegawaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPegawaiActionPerformed
        DlgCariPetugas pegawai=new DlgCariPetugas(null,false);
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'"+i+"','"+
                                ...
                                tabMode.getValueAt(i,4).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Titip Faktur"); 
            }
            i++;
            ...
            Valid.MyReportqry("rptTagihanDapur.jasper","report","::[ Data Titip Faktur/Tagihan Barang Dapur Kering & Basah ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    private void MnHapusTagihanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusTagihanActionPerformed
        if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                try {
                    ps=koneksi.prepareStatement("select dapur_detail_titip_faktur.no_faktur from dapur_detail_titip_faktur where dapur_detail_titip_faktur.no_tagihan=?");
                    try {
                       ps.setString(1,tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                       rs=ps.executeQuery();
                       while(rs.next()){
                           Sequel.queryu("update dapurpemesanan set status='Belum Lunas' where no_faktur=?",rs.getString("no_faktur"));
                       }
                    } catch (Exception e) {
                    ...
                    Sequel.queryu("delete from dapur_titip_faktur where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                    runBackground(() ->tampil());
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                }
    ...
    private void MnDitagihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDitagihkanActionPerformed
       if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                Sequel.queryu("update dapur_titip_faktur set status='Ditagihkan' where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                runBackground(() ->tampil());
            }  
        }
    ...
    private void MnDibayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDibayarActionPerformed
        if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                if(Sequel.cariIsi("select status from dapur_titip_faktur where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()).equals("Ditagihkan")){
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    KeuanganHutangDapurBelumLunas form=new KeuanganHutangDapurBelumLunas(null,false);
                    form.isCek();
    ...
    private void MnDitagihkan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDitagihkan1ActionPerformed
        if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                Sequel.queryu("update dapur_titip_faktur set status='Dibayar' where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                runBackground(() ->tampil());
            }  
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganCariTagihanDapur dialog = new KeuanganCariTagihanDapur(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
         ...
         try{
             ...
             if(!NoTagihan.getText().trim().equals("")){
                 notagihan=" and dapur_titip_faktur.no_tagihan like '%"+NoTagihan.getText()+"%' ";
             }
             
             tanggal=" dapur_titip_faktur.tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' ";
             
             if(!Status.getSelectedItem().toString().equals("Semua")){
                 status=" and dapur_titip_faktur.status like '%"+Status.getSelectedItem().toString()+"%' ";
             }
             
             if(!NmPeg.getText().trim().equals("")){
                 petugas=" and concat(dapur_titip_faktur.nip,petugas.nama) like '%"+KdPeg.getText()+NmPeg.getText()+"%' ";
             }
             
             if(!TCari.getText().trim().equals("")){
                 cari=" and (dapur_titip_faktur.no_tagihan like '%"+TCari.getText()+"%' or petugas.nama like '%"+TCari.getText()+"%' or dapur_titip_faktur.keterangan like '%"+TCari.getText()+"%' or dapur_detail_titip_faktur.no_faktur like '%"+TCari.getText()+"%' or dapursuplier.nama_suplier like '%"+TCari.getText()+"%' ) ";
             }
             
             ps=koneksi.prepareStatement(
                     "select dapur_titip_faktur.no_tagihan,dapur_titip_faktur.tanggal,dapur_titip_faktur.nip,petugas.nama as petugas,"+
                     "dapur_titip_faktur.keterangan,dapur_titip_faktur.status from dapur_titip_faktur "+
                     "inner join petugas on petugas.nip=dapur_titip_faktur.nip "+
                     "inner join dapur_detail_titip_faktur on dapur_detail_titip_faktur.no_tagihan=dapur_titip_faktur.no_tagihan "+
                     "inner join dapurpemesanan on dapur_detail_titip_faktur.no_faktur=dapurpemesanan.no_faktur "+
                     "inner join dapursuplier on dapursuplier.kode_suplier=dapurpemesanan.kode_suplier "+
                     "where "+tanggal+status+notagihan+petugas+cari+" group by dapur_titip_faktur.no_tagihan order by dapur_titip_faktur.tanggal");
             try {
                rs=ps.executeQuery();
                totaltagihan=0;
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        "select dapurpemesanan.tgl_tempo,dapurpemesanan.no_faktur,dapurpemesanan.kode_suplier,dapursuplier.nama_suplier,dapurpemesanan.tagihan,"+
                        "(SELECT ifnull(SUM(besar_bayar),0) FROM bayar_pemesanan_dapur where bayar_pemesanan_dapur.no_faktur=dapurpemesanan.no_faktur) as bayar from dapur_titip_faktur "+
                        "inner join petugas on petugas.nip=dapur_titip_faktur.nip "+
                        "inner join dapur_detail_titip_faktur on dapur_detail_titip_faktur.no_tagihan=dapur_titip_faktur.no_tagihan "+
                        "inner join dapurpemesanan on dapur_detail_titip_faktur.no_faktur=dapurpemesanan.no_faktur "+
                        "inner join dapursuplier on dapursuplier.kode_suplier=dapurpemesanan.kode_suplier "+
                        "where dapur_detail_titip_faktur.no_tagihan='"+rs.getString("no_tagihan")+"' and "+
                        tanggal+status+notagihan+petugas+cari+" order by dapur_titip_faktur.tanggal");
                    try {
                        nilaitagihan=0;
    ...
    public void isCek(){
        TCari.requestFocus();
        MnHapusTagihan.setEnabled(akses.gettitip_faktur_dapur());
        MnDitagihkan.setEnabled(akses.gettitip_faktur_dapur());
        MnDibayar.setEnabled(akses.getbayar_pesan_dapur());
    }
