 ...
 * @author perpustakaan
 */
public final class KeuanganRekapPengajuanBiaya extends javax.swing.JDialog {
    ...
    private int i=0,ttljan=0,ttlfeb=0,ttlmar=0,ttlapr=0,ttlmei=0,ttljun=0,ttljul=0,ttlagu=0,ttlsep=0,ttlokt=0,ttlnov=0,ttldes=0,
            ...
            ttljandivalidasi=0,ttlfebdivalidasi=0,ttlmardivalidasi=0,ttlaprdivalidasi=0,ttlmeidivalidasi=0,ttljundivalidasi=0,ttljuldivalidasi=0,ttlagudivalidasi=0,ttlsepdivalidasi=0,ttloktdivalidasi=0,ttlnovdivalidasi=0,ttldesdivalidasi=0,
     ...
     * @param parent
     * @param modal */
    public KeuanganRekapPengajuanBiaya(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Pengajuan Biaya/Anggaran Per Departemen ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganRekapPengajuanBiaya dialog = new KeuanganRekapPengajuanBiaya(new javax.swing.JFrame(), true);
        ...
        try{   
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    jan=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-01%");
                    feb=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-02%");
                    mar=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-03%");
                    apr=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    mei=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    jun=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    jul=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    agu=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    sep=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                    okt=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-10%");
                    nov=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-11%");
                    des=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-12%");
                    jmljan=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-01%");
                    jmlfeb=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-02%");
                    jmlmar=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-03%");
                    jmlapr=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    jmlmei=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    jmljun=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    jmljul=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    jmlagu=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    jmlsep=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                    ...
                    aprdisetujui=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    meidisetujui=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    jundisetujui=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    juldisetujui=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    agudisetujui=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    sepdisetujui=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                    ...
                    aprdivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    meidivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    jundivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    juldivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    agudivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    sepdivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                    oktdivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-10%");
                    novdivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-11%");
                    desdivalidasi=Sequel.cariInteger("select sum(pengajuan_biaya_disetujui.total) as total from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-12%");
                    jmljandivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-01%");
                    jmlfebdivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-02%");
                    jmlmardivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-03%");
                    jmlaprdivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    jmlmeidivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    jmljundivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    jmljuldivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    jmlagudivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    jmlsepdivalidasi=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pengajuan_biaya_disetujui inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id and pengajuan_biaya_disetujui.no_pengajuan=pengajuan_biaya.no_pengajuan where pengajuan_biaya.status='Divalidasi' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                    ...
                    aprditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    meiditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    junditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    julditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    aguditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    sepditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                    oktditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-10%");
                    novditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-11%");
                    desditolak=Sequel.cariInteger("select sum(pengajuan_biaya.total) as total from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-12%");
                    jmljanditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-01%");
                    jmlfebditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-02%");
                    jmlmarditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-03%");
                    jmlaprditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-04%");
                    jmlmeiditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-05%");
                    jmljunditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-06%");
                    jmljulditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-07%");
                    jmlaguditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-08%");
                    jmlsepditolak=Sequel.cariInteger("select count(departemen.dep_id) as jumlah from pengajuan_biaya inner join pegawai inner join departemen on pengajuan_biaya.nik=pegawai.nik and pegawai.departemen=departemen.dep_id  where pengajuan_biaya.status='Ditolak' and departemen.dep_id=? and tanggal like ?",rs.getString("dep_id"),"%"+ThnCari.getSelectedItem()+"-09%");
                ...
                if(i>1){
                    ...
                    tabMode.addRow(new Object[]{
                        "","Jumlah Divalidasi",ttljmljandivalidasi+"("+Valid.SetAngka(ttljandivalidasi)+")",ttljmlfebdivalidasi+"("+Valid.SetAngka(ttlfebdivalidasi)+")",ttljmlmardivalidasi+"("+Valid.SetAngka(ttlmardivalidasi)+")",ttljmlaprdivalidasi+"("+Valid.SetAngka(ttlaprdivalidasi)+")",ttljmlmeidivalidasi+"("+Valid.SetAngka(ttlmeidivalidasi)+")",ttljmljundivalidasi+"("+Valid.SetAngka(ttljundivalidasi)+")",
                        ttljmljuldivalidasi+"("+Valid.SetAngka(ttljuldivalidasi)+")",ttljmlagudivalidasi+"("+Valid.SetAngka(ttlagudivalidasi)+")",ttljmlsepdivalidasi+"("+Valid.SetAngka(ttlsepdivalidasi)+")",ttljmloktdivalidasi+"("+Valid.SetAngka(ttloktdivalidasi)+")",ttljmlnovdivalidasi+"("+Valid.SetAngka(ttlnovdivalidasi)+")",ttljmldesdivalidasi+"("+Valid.SetAngka(ttldesdivalidasi)+")",
                        (ttljmljandivalidasi+ttljmlfebdivalidasi+ttljmlmardivalidasi+ttljmlaprdivalidasi+ttljmlmeidivalidasi+ttljmljundivalidasi+ttljmljuldivalidasi+ttljmlagudivalidasi+ttljmlsepdivalidasi+ttljmloktdivalidasi+ttljmlnovdivalidasi+ttljmldesdivalidasi)+"("+Valid.SetAngka((ttljandivalidasi+ttlfebdivalidasi+ttlmardivalidasi+ttlaprdivalidasi+ttlmeidivalidasi+ttljundivalidasi+ttljuldivalidasi+ttlagudivalidasi+ttlsepdivalidasi+ttloktdivalidasi+ttlnovdivalidasi+ttldesdivalidasi))+")"
                    });
                    tabMode.addRow(new Object[]{
