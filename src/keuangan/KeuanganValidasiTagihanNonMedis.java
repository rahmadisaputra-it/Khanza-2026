 ...
 * @author perpustakaan
 */
public final class KeuanganValidasiTagihanNonMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KeuanganValidasiTagihanNonMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi Titip Faktur/Tagihan Barang Non Medis dan Penunjang ( Lab & RO ) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptValidasiTagihanNonMedis.jasper","report","::[ Data Pegajuan Titip Faktur/Tagihan Non Medis ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiTagihanNonMedis dialog = new KeuanganValidasiTagihanNonMedis(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ...
            if(!nmsuplier.getText().trim().equals("")){
                carisuplier=" and ipsrspemesanan.kode_suplier='"+kdsuplier.getText()+"' ";
            }
            ...
            ps=koneksi.prepareStatement(
                     "select ipsrs_titip_faktur.no_tagihan,ipsrs_titip_faktur.tanggal,ipsrs_titip_faktur.nip,petugas.nama,"+
                     "ipsrs_titip_faktur.keterangan,ipsrs_titip_faktur.status,sum(ipsrspemesanan.tagihan) as tagihan from ipsrs_titip_faktur "+
                     ...
                     "where ipsrs_titip_faktur.status='Ditagihkan' "+carisuplier+cari+" group by ipsrs_titip_faktur.no_tagihan order by ipsrs_titip_faktur.tanggal");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    bayar=0;
                    ps2=koneksi.prepareStatement(
                        "select (SELECT ifnull(SUM(besar_bayar),0) FROM bayar_pemesanan_non_medis where bayar_pemesanan_non_medis.no_faktur=ipsrspemesanan.no_faktur) as bayar "+
                        "from ipsrs_detail_titip_faktur inner join ipsrspemesanan on ipsrs_detail_titip_faktur.no_faktur=ipsrspemesanan.no_faktur "+
                        "where ipsrs_detail_titip_faktur.no_tagihan='"+rs.getString("no_tagihan")+"'");
                    try {
