 ...
 * @author dosen
 */
public final class KeuanganBayarPemesananAset extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Bayar Pemesanan Barang Aset/Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
                    ...
                    if(koderekening.equals("")){
                        ...
                        if(koderekening.equals(Host_to_Host_Bank_Mandiri)){
                            ...
                            ps=koneksi.prepareStatement(
                                    "select inventaris_suplier.nama_suplier,inventaris_suplier.kota,inventaris_suplier.nama_bank,inventaris_suplier.rekening "+
                                    ...
                                    "where inventaris_pemesanan.no_faktur=?");
                            try{
                            ...
                            if(sukses==true){
                                if((sisahutang<=Double.parseDouble(BesarBayar.getText()))||(sisahutang<=-Double.parseDouble(BesarBayar.getText()))){
                                    Sequel.mengedit("inventaris_pemesanan","no_faktur=?","status='Sudah Dibayar'",1,new String[]{NoFaktur.getText()});
                                }else{
                                    Sequel.mengedit("inventaris_pemesanan","no_faktur=?","status='Belum Lunas'",1,new String[]{NoFaktur.getText()});
                                }
        ...
        try {
            ...
            if(Sequel.queryu2tf("delete from bayar_pemesanan_inventaris where tgl_bayar=? and no_faktur=? and "+
                ...
                if(Double.parseDouble(tbKamar.getValueAt(tbKamar.getSelectedRow(),8).toString())==Double.parseDouble(BesarBayar.getText())){
                    Sequel.mengedit("inventaris_pemesanan","no_faktur=?","status='Belum Dibayar'",1,new String[]{NoFaktur.getText()});
                }else{
                    Sequel.mengedit("inventaris_pemesanan","no_faktur=?","status='Belum Lunas'",1,new String[]{NoFaktur.getText()});
                }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptBayarPemesananAset.jasper","report","::[ Bayar Pemesanan Aset/Inventaris ]::",
                    ...
                    "bayar_pemesanan_inventaris.tgl_bayar between '"+Valid.SetTgl(TglCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglCari2.getSelectedItem()+"")+"' and inventaris_suplier.nama_suplier like '%"+nmsup.getText().trim()+"%' and bayar_pemesanan_inventaris.no_faktur like '%"+TCari.getText().trim()+"%' or "+
                    "bayar_pemesanan_inventaris.tgl_bayar between '"+Valid.SetTgl(TglCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglCari2.getSelectedItem()+"")+"' and inventaris_suplier.nama_suplier like '%"+nmsup.getText().trim()+"%' and inventaris_suplier.nama_suplier like '%"+TCari.getText().trim()+"%' or "+
                    "bayar_pemesanan_inventaris.tgl_bayar between '"+Valid.SetTgl(TglCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglCari2.getSelectedItem()+"")+"' and inventaris_suplier.nama_suplier like '%"+nmsup.getText().trim()+"%' and bayar_pemesanan_inventaris.nama_bayar like '%"+TCari.getText().trim()+"%' or "+
                    "bayar_pemesanan_inventaris.tgl_bayar between '"+Valid.SetTgl(TglCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglCari2.getSelectedItem()+"")+"' and inventaris_suplier.nama_suplier like '%"+nmsup.getText().trim()+"%' and bayar_pemesanan_inventaris.no_bukti like '%"+TCari.getText().trim()+"%' or "+
                    "bayar_pemesanan_inventaris.tgl_bayar between '"+Valid.SetTgl(TglCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglCari2.getSelectedItem()+"")+"' and inventaris_suplier.nama_suplier like '%"+nmsup.getText().trim()+"%' and bayar_pemesanan_inventaris.keterangan like '%"+TCari.getText().trim()+"%' or "+
                    "bayar_pemesanan_inventaris.tgl_bayar between '"+Valid.SetTgl(TglCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglCari2.getSelectedItem()+"")+"' and inventaris_suplier.nama_suplier like '%"+nmsup.getText().trim()+"%' and petugas.nama like '%"+TCari.getText().trim()+"%' "+
...
private void BtnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPetugasActionPerformed
    ...
    private void BtnSeek2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek2ActionPerformed
        InventarisSuplier suplier=new InventarisSuplier(null,false);
                ...
                if(sukses==true){
                    ...
                    if(Sequel.menyimpantf2("bayar_pemesanan_inventaris","?,?,?,?,?,?,?","data", 7,new String[]{
                        ...
                        if(Sequel.menyimpantf("pembayaran_pihak_ke3_bankmandiri","?,now(),?,?,?,?,?,?,?,?,?,?,?","No.Bukti", 12,new String[]{
                                NoBukti.getText(),norekening,NoRekening.getText(),RekeningAtasNama.getText(),KotaAtasNamaRekening.getText(),BesarBayar.getText(),NoFaktur.getText(),KodeMetode.getText(),KodeBank.getText(),KodeTransaksi.getText(),"Bayar Pesan Aset/Inventaris","Baru"
                            })==false){
                            sukses=false;
                        }
                    }else{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganBayarPemesananAset dialog = new KeuanganBayarPemesananAset(new javax.swing.JFrame(), true);
