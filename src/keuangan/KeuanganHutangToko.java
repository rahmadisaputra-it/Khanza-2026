 ...
 * @author perpustakaan
 */
public final class KeuanganHutangToko extends javax.swing.JDialog {
    ...
    private int row=0,i;
    private String koderekening="",tanggaldatang="",tanggaltempo="",Bayar_Pemesanan_Toko=Sequel.cariIsi("select set_akun.Bayar_Pemesanan_Toko from set_akun"),Host_to_Host_Bank_Mandiri="",Akun_Biaya_Mandiri="",kodemcm="",norekening="";
     ...
     * @param parent
     * @param modal */
    public KeuanganHutangToko(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Hutang Barang Toko / Minimarket / Koperasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnSeek2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek2ActionPerformed
        TokoCariSuplier suplier=new TokoCariSuplier(null,false);
            ...
            if(koderekening.equals("")){
                ...
                if(koderekening.equals(Host_to_Host_Bank_Mandiri)){
                    if(KodeSuplier.getText().trim().equals("")||NamaSuplier.getText().trim().equals("")){
                        ...
                        try {
                            myObj = new FileReader("./cache/supliertoko.iyem");
                            root = mapper.readTree(myObj);
                            response = root.path("supliertoko");
                            if(response.isArray()){
                                for(JsonNode list:response){
