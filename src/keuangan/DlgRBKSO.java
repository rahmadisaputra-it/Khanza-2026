...
public class DlgRBKSO extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRBKSO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"No.","Cara Bayar","Tindakan Medis","Jumlah","KSO"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptRBKSO.jasper","report","[ Rekap Bulanan KSO ]","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBKSO dialog = new DlgRBKSO(new javax.swing.JFrame(), true);
                ...
                while(rs.next()){
                   ...
                   if(chkRalan.isSelected()==true){
                        ...
                        psralandr=koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_dr.kso,"+
                            ...
                            "where reg_periksa.tgl_registrasi between ? and ? and reg_periksa.kd_pj like ? and rawat_jl_dr.kso>0 "+
                   ...
                   if(chkRadiologi.isSelected()==true){
                        psperiksaradiologi=koneksi.prepareStatement(
                            ...
                            "sum(periksa_radiologi.kso) as total, "+
