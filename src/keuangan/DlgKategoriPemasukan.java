 ...
 * @author dosen
 */
public final class DlgKategoriPemasukan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKategoriPemasukan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,Kd,"kategori_pemasukan_lain ","kode_kategori")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(tbKamar.getSelectedRow()>-1){
                if(Sequel.mengedittf("kategori_pemasukan_lain","kode_kategori=?","kode_kategori=?,nama_kategori=?,kd_rek=?,kd_rek2=?",5,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptKategoriPemasukanLain.jasper","report","::[ Kategori Pemasukan Lain ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
        }
...
//   Valid.pindah(evt,Kd,Tahun);
    ...
    private void BtnAkunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAkunActionPerformed
        akses.setform("DlgKategoriPemasukan");
        pilihan=1;
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKategoriPemasukan dialog = new DlgKategoriPemasukan(new javax.swing.JFrame(), true);
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            Sequel.cariIsi("select kd_rek from kategori_pemasukan_lain where kode_kategori=?",KdAkun,tbKamar.getValueAt(row,0).toString());
            Sequel.cariIsi("select kd_rek2 from kategori_pemasukan_lain where kode_kategori=?",KdKontraAkun,tbKamar.getValueAt(row,0).toString());
        }
    }
