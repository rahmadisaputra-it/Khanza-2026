 ...
 * @author perpustakaan
 */
public final class KeuanganPiutangJasaPerusahaanBelumLunas extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KeuanganPiutangJasaPerusahaanBelumLunas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "P","No.Piutang","Tgl.Piutang","Kode","Instansi/Perusahaan","Keterangan","Total Piutang","Cicilan","Sisa Piutang","Jatuh Tempo","Bayar"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Piutang Jasa Perusahaan Belum Lunas ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
            ...
            for(i=0;i<row;i++){  
                if(tabMode.getValueAt(i,0).toString().equals("true")){
                    if(Double.parseDouble(tabMode.getValueAt(i,8).toString())<0){
                        ...
                        //"P"0,"No.Piutang"1,"Tgl.Piutang"2,"Kode"3,"Instansi/Perusahaan"4,"Keterangan"5,"Total Piutang"6,"Cicilan"7,"Sisa Piutang"8,"Jatuh Tempo"9,"Bayar"10
                        if(Sequel.menyimpantf("bayar_piutang_jasa_perusahaan","?,?,?,?,?,?,?","Data",7,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganPiutangJasaPerusahaanBelumLunas dialog = new KeuanganPiutangJasaPerusahaanBelumLunas(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ...
            ps=koneksi.prepareStatement(
                    ...
                    (TCari.getText().trim().equals("")?"":"and (piutang_jasa_perusahaan.no_piutang like ? or piutang_jasa_perusahaan.tgl_piutang like ? or piutang_jasa_perusahaan.kode_perusahaan like ? or perusahaan_pasien.nama_perusahaan like ? or piutang_jasa_perusahaan.jatuh_tempo like ?)")+
                    "order by piutang_jasa_perusahaan.tgl_piutang");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        false,rs.getString("no_piutang"),rs.getString("tgl_piutang"),rs.getString("kode_perusahaan"),rs.getString("nama_perusahaan"),rs.getString("keterangan"),
                        rs.getDouble("totalpiutang"),rs.getDouble("cicilan"),rs.getDouble("sisapiutang"),rs.getString("jatuh_tempo"),rs.getDouble("sisapiutang")
                    });
