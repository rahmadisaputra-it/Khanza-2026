            ...
            try {
                ...
                while(rstanggal.next()){
                    psdokter=koneksi.prepareStatement(
                            ...
                            "where poliklinik.nm_poli like '%anak%' and tgl_registrasi=? "+(nmdokter.getText().trim().equals("")?"":"and reg_periksa.kd_dokter=? ")+" group by reg_periksa.kd_dokter");
                    try {                        
                        ...
                        while(rsdokter.next()){
                            htmlContent.append(                                
                                ...
                                "<tr class='isi2'>"+
                                    "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                       "<tr class='isi3'>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='3%' rowspan='3'>NO.</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%' rowspan='3'>NO.RM</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='10%' rowspan='3'>NAMA IBU</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='10%' rowspan='3'>NAMA ANAK</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='12%' rowspan='3'>ALAMAT</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='4%' rowspan='3'>TGL.LAHIR</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='6%'>LAHIR</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='1%' rowspan='2'>L/B</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='25%' colspan='10'>USIA</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='20%' rowspan='2'>TINDAKAN & HARGA</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' width='4%'>L.P.</td>"+
                                        "</tr>"+
                                        "<tr class='isi3'>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>DIMANA</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>0-6 hari</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>7-28 hari</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>28-1 thn</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>1-4 thn</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>5-14 thn</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>BERAPA</td>"+
                                        "</tr>"+
                                        "<tr class='isi3'>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>&nbsp;</td>"+
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>&nbsp;</td>"+
            ...
            if((ttlh0s6l+ttlh0s6p+ttlh7s28l+ttlh7s28p+ttlh29st1l+ttlh29st1p+ttlt1s4l+ttlt1s4p+ttlt5s14l+ttlt5s14p)>0){
                htmlContent.append(
                    ...
                    "<tr class='isi2'>"+
                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi3'>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='right' width='10%'>Usia : </td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='18%' colspan='2'>0-6 hari</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='18%' colspan='2'>7-28 hari</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='18%' colspan='2'>28-1 thn</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='18%' colspan='2'>1-4 thn</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='18%' colspan='2'>5-14 thn</td>"+
                            "</tr>"+
                            "<tr class='isi3'>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='right'>Jenis Kelamin :</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center'>L</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center'>P</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center'>L</td>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='center'>P</td>"+
                            ...
                            "</tr>"+
                            "<tr class='isi3'>"+
                                "<td valign='middle' bgcolor='#FFFAFA' align='right'>Jumlah Total :</td>"+
