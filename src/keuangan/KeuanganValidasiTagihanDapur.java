 ...
 * @author perpustakaan
 */
public final class KeuanganValidasiTagihanDapur extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KeuanganValidasiTagihanDapur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptValidasiTagihanDapur.jasper","report","::[ Data Pegajuan Titip Faktur/Tagihan Dapur ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiTagihanDapur dialog = new KeuanganValidasiTagihanDapur(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ...
            if(!nmsuplier.getText().trim().equals("")){
                carisuplier=" and dapurpemesanan.kode_suplier='"+kdsuplier.getText()+"' ";
            }
            ...
            ps=koneksi.prepareStatement(
                     "select dapur_titip_faktur.no_tagihan,dapur_titip_faktur.tanggal,dapur_titip_faktur.nip,petugas.nama,"+
                     "dapur_titip_faktur.keterangan,dapur_titip_faktur.status,sum(dapurpemesanan.tagihan) as tagihan from dapur_titip_faktur "+
                     ...
                     "where dapur_titip_faktur.status='Ditagihkan' "+carisuplier+cari+" group by dapur_titip_faktur.no_tagihan order by dapur_titip_faktur.tanggal");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    bayar=0;
                    ps2=koneksi.prepareStatement(
                        "select (SELECT ifnull(SUM(besar_bayar),0) FROM bayar_pemesanan_non_medis where bayar_pemesanan_non_medis.no_faktur=dapurpemesanan.no_faktur) as bayar "+
                        "from dapur_detail_titip_faktur inner join dapurpemesanan on dapur_detail_titip_faktur.no_faktur=dapurpemesanan.no_faktur "+
                        "where dapur_detail_titip_faktur.no_tagihan='"+rs.getString("no_tagihan")+"'");
                    try {
