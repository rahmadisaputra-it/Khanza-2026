...
public class KeuanganCariTagihanAset extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KeuanganCariTagihanAset(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                try {
                    ...
                    try {
                       ...
                       rs=ps.executeQuery();
                       while(rs.next()){
                           Sequel.queryu("update inventaris_pemesanan set status='Belum Lunas' where no_faktur=?",rs.getString("no_faktur"));
                       }
                    } catch (Exception e) {
                    ...
                    Sequel.queryu("delete from inventaris_titip_faktur where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                    runBackground(() ->tampil());
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                }
    ...
    private void MnDitagihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDitagihkanActionPerformed
       if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                Sequel.queryu("update inventaris_titip_faktur set status='Ditagihkan' where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                runBackground(() ->tampil());
            }  
        }
    ...
    private void MnDibayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDibayarActionPerformed
        if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                if(Sequel.cariIsi("select status from inventaris_titip_faktur where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()).equals("Ditagihkan")){
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void MnDitagihkan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDitagihkan1ActionPerformed
        if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                Sequel.queryu("update inventaris_titip_faktur set status='Dibayar' where no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                runBackground(() ->tampil());
            }  
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganCariTagihanAset dialog = new KeuanganCariTagihanAset(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
         ...
         try{
             ...
             if(!NoTagihan.getText().trim().equals("")){
                 notagihan=" and inventaris_titip_faktur.no_tagihan like '%"+NoTagihan.getText()+"%' ";
             }
             
             tanggal=" inventaris_titip_faktur.tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' ";
             
             if(!Status.getSelectedItem().toString().equals("Semua")){
                 status=" and inventaris_titip_faktur.status like '%"+Status.getSelectedItem().toString()+"%' ";
             }
             
             if(!NmPeg.getText().trim().equals("")){
                 petugas=" and concat(inventaris_titip_faktur.nip,petugas.nama) like '%"+KdPeg.getText()+NmPeg.getText()+"%' ";
             }
             ...
             ps=koneksi.prepareStatement(
                     ...
                     "where "+tanggal+status+notagihan+petugas+cari+" group by inventaris_titip_faktur.no_tagihan order by inventaris_titip_faktur.tanggal");
             try {
                rs=ps.executeQuery();
                totaltagihan=0;
                while(rs.next()){
    ...
    public void isCek(){
        TCari.requestFocus();
        MnHapusTagihan.setEnabled(akses.gettitip_faktur_aset());
        MnDitagihkan.setEnabled(akses.gettitip_faktur_aset());
        MnDibayar.setEnabled(akses.getbayar_pemesanan_iventaris());
    }
