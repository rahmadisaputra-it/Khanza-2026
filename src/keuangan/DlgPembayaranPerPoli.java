...
public class DlgPembayaranPerPoli extends javax.swing.JDialog {
    ...
    private String stringjml="",stringtotal="";
     ...
     * @param parent
     * @param modal */
    public DlgPembayaranPerPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pembayaran Per Bagian/Unit Berdasarkan Shift Jaga ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembayaranPerPoli dialog = new DlgPembayaranPerPoli(new javax.swing.JFrame(), true);
        ...
        try{   
            ...
            try {
                ...
                while(rspoli.next()){
                    ...
                    try {
                        i=1;
                        psdokter.setString(1,rspoli.getString("kd_poli"));
                            ...
                            try{
                                ...
                                while(rsjamshift.next()){                                    
                                    ...
                                    try {
                                        ...
                                        psmasuk.setString(3,Valid.SetTgl(Tgl1.getSelectedItem()+"")+" "+rsjamshift.getString("jam_masuk"));
                                        if(rsjamshift.getString("shift").equals("Malam")){
                                            psmasuk.setString(4,Sequel.cariIsi("select DATE_ADD('"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+" "+rsjamshift.getString("jam_pulang")+"',INTERVAL 1 DAY)"));
                                        }else{
                                            psmasuk.setString(4,Valid.SetTgl(Tgl1.getSelectedItem()+"")+" "+rsjamshift.getString("jam_pulang"));
                                        }
                        ...
                        System.out.println("Notif Dokter : "+e);
                    } finally{
                        if(rsdokter!=null){
                            rsdokter.close();
                        }
