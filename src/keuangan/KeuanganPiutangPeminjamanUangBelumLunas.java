 ...
 * @author perpustakaan
 */
public final class KeuanganPiutangPeminjamanUangBelumLunas extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KeuanganPiutangPeminjamanUangBelumLunas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "P","No.Piutang","Tgl.Piutang","Kode","Peminjam","Keterangan","Total Piutang","Cicilan","Sisa Piutang","Jatuh Tempo","Bayar","Kode Rek","Akun"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Piutang Peminjaman Uang Perusahaan/Lain-lain Belum Lunas ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
            ...
            for(i=0;i<row;i++){  
                if(tabMode.getValueAt(i,0).toString().equals("true")){
                    if(Double.parseDouble(tabMode.getValueAt(i,8).toString())<0){
                        ...
                        ////"P"0,"No.Piutang"1,"Tgl.Piutang"2,"Kode"3,"Peminjam"4,"Keterangan"5,"Total Piutang"6,"Cicilan"7,"Sisa Piutang"8,"Jatuh Tempo"9,"Bayar"10,"Kode Rek"11,"Akun"12
                        if(Sequel.menyimpantf("bayar_piutang_lainlain","?,?,?,?,?,?,?","Data",7,new String[]{
                            Valid.SetTgl(Tanggal.getSelectedItem()+""),tabMode.getValueAt(i,3).toString(),tabMode.getValueAt(i,10).toString(),"diverifikasi oleh "+akses.getkode(),
                            tabMode.getValueAt(i,1).toString(),koderekening,AkunBayar.getSelectedItem().toString()
                        })==true){
                            ...
                            if(Sequel.menyimpantf2("tampjurnal","'"+tbBangsal.getValueAt(i,11).toString()+"','"+tbBangsal.getValueAt(i,12).toString()+"','0','"+tbBangsal.getValueAt(i,10).toString()+"'","Rekening")==false){
                                sukses=false;
                            }    
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganPiutangPeminjamanUangBelumLunas dialog = new KeuanganPiutangPeminjamanUangBelumLunas(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ...
            ps=koneksi.prepareStatement(
                    "select piutang_lainlain.nota_piutang,piutang_lainlain.tgl_piutang,piutang_lainlain.kode_peminjam,peminjampiutang.nama_peminjam,piutang_lainlain.keterangan,piutang_lainlain.nominal,piutang_lainlain.sisapiutang,piutang_lainlain.tgltempo,"+
                    "(piutang_lainlain.nominal-piutang_lainlain.sisapiutang) as cicilan,peminjampiutang.kd_rek,rekening.nm_rek from piutang_lainlain inner join peminjampiutang on piutang_lainlain.kode_peminjam=peminjampiutang.kode_peminjam "+
                    "inner join rekening on peminjampiutang.kd_rek=rekening.kd_rek where piutang_lainlain.status='Belum Lunas' "+
                    (TCari.getText().trim().equals("")?"":"and (piutang_lainlain.nota_piutang like ? or piutang_lainlain.tgl_piutang like ? or piutang_lainlain.kode_peminjam like ? or peminjampiutang.nama_peminjam like ? or piutang_lainlain.tgltempo like ?)")+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        false,rs.getString("nota_piutang"),rs.getString("tgl_piutang"),rs.getString("kode_peminjam"),rs.getString("nama_peminjam"),rs.getString("keterangan"),
                        rs.getDouble("nominal"),rs.getDouble("cicilan"),rs.getDouble("sisapiutang"),rs.getString("tgltempo"),rs.getDouble("sisapiutang"),
                        rs.getString("kd_rek"),rs.getString("nm_rek")
                    });
                    ...
                    if(Double.parseDouble(tabMode.getValueAt(pilih,8).toString())<0){
                       ...
                       tbBangsal.setValueAt(false,pilih,0);
                        ...
                        tbBangsal.setValueAt(
                                ...
                                Double.parseDouble(tbBangsal.getValueAt(pilih,10).toString())),
                                pilih,8);
                    }
    ...
    public void isCek(){
        TCari.requestFocus();
        BtnBayar.setEnabled(akses.getbayar_piutang_lain());
    }
