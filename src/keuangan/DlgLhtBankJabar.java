 ...
 * @author perpustakaan
 */
public final class DlgLhtBankJabar extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgLhtBankJabar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pembayaran Bank Jabar ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptHtHBankJabar.jasper","report","::[ Data Pembayaran Bank Jabar ]::",
               "select * from tagihan_bpd_jabar where tagihan_bpd_jabar.tgl_closing between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
               (TCari.getText().equals("")?"":"and (tagihan_bpd_jabar.no_rkm_medis like '%"+TCari.getText().trim()+"%' or tagihan_bpd_jabar.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
               "tagihan_bpd_jabar.no_nota like '%"+TCari.getText().trim()+"%' or tagihan_bpd_jabar.referensi like '%"+TCari.getText().trim()+"%' or tagihan_bpd_jabar.no_rawat like '%"+TCari.getText().trim()+"%' or "+
               "tagihan_bpd_jabar.status_lanjut like '%"+TCari.getText().trim()+"%' or tagihan_bpd_jabar.status_bayar like '%"+TCari.getText().trim()+"%' or tagihan_bpd_jabar.kasir like '%"+TCari.getText().trim()+"%' or "+
               "tagihan_bpd_jabar.keterangan like '%"+TCari.getText().trim()+"%') ")+"order by tagihan_bpd_jabar.tgl_closing",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLhtBankJabar dialog = new DlgLhtBankJabar(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement("select * from tagihan_bpd_jabar where tagihan_bpd_jabar.tgl_closing between ? and ? "+
                   (TCari.getText().equals("")?"":"and (tagihan_bpd_jabar.no_rkm_medis like ? or tagihan_bpd_jabar.nm_pasien like ? or "+
                   "tagihan_bpd_jabar.no_nota like ? or tagihan_bpd_jabar.referensi like ? or tagihan_bpd_jabar.no_rawat like ? or "+
                   "tagihan_bpd_jabar.status_lanjut like ? or tagihan_bpd_jabar.status_bayar like ? or tagihan_bpd_jabar.kasir like ? or "+
                   "tagihan_bpd_jabar.keterangan like ?) ")+"order by tagihan_bpd_jabar.tgl_closing");
            try {
