...
public class DlgRHPaketBHP extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,psrawatjalandr,psrawatjalandrpr,psrawatjalanpr,psrawatinapdr,psrawatinapdrpr,
            psrawatinappr,psperiksa_lab,psdetail_lab,psperiksa_radiologi;
     ...
     * @param parent
     * @param modal */
    public DlgRHPaketBHP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"No.","Cara Bayar","Tgl.Tindakan","Nama Pasien","Tindakan Medis","BHP Medis/Paket Obat"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Harian BHP Medis/Paket Obat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRHPaketBHP dialog = new DlgRHPaketBHP(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while(rs.next()){
                   ...
                   if(chkRalan.isSelected()==true){
                        psrawatjalandr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_dr.bhp,"+
                            ...
                            " and rawat_jl_dr.bhp>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                        psrawatjalandrpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.bhp,"+
                            "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "+
                            "from pasien inner join reg_periksa  "+
                            ...
                            "where reg_periksa.tgl_registrasi between ? and ? and reg_periksa.kd_pj=? "+
                            " and rawat_jl_drpr.bhp>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                        psrawatjalanpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_pr.bhp,"+
                            "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "+
                            "from pasien inner join reg_periksa  "+
                            ...
                            "where reg_periksa.tgl_registrasi between ? and ? and reg_periksa.kd_pj=? "+
                            " and rawat_jl_pr.bhp>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");                          
                        ...
                        try {
                            ...
                            while(rsrawatjalandr.next()){
                                tabMode.addRow(new Object[]{"","","     "+rsrawatjalandr.getString("tgl_registrasi"),rsrawatjalandr.getString("nm_pasien"),
                                    rsrawatjalandr.getString("nm_perawatan"),Valid.SetAngka(rsrawatjalandr.getDouble("bhp"))});                   
                                total=total+rsrawatjalandr.getDouble("bhp");
                            }
                            ...
                            while(rsrawatjalandrpr.next()){
                                tabMode.addRow(new Object[]{"","","     "+rsrawatjalandrpr.getString("tgl_registrasi"),rsrawatjalandrpr.getString("nm_pasien"),
                                    rsrawatjalandrpr.getString("nm_perawatan"),Valid.SetAngka(rsrawatjalandrpr.getDouble("bhp"))});                   
                                total=total+rsrawatjalandrpr.getDouble("bhp");
                            }
                            ...
                            while(rsrawatjalanpr.next()){
                                tabMode.addRow(new Object[]{"","","     "+rsrawatjalanpr.getString("tgl_registrasi"),rsrawatjalanpr.getString("nm_pasien"),
                                    rsrawatjalanpr.getString("nm_perawatan"),Valid.SetAngka(rsrawatjalanpr.getDouble("bhp"))});                   
                                total=total+rsrawatjalanpr.getDouble("bhp");
                            }                           
                        } catch (Exception e) {
                   ...
                   if(chkRanap.isSelected()==true){
                        psrawatinapdr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_inap_dr.bhp,"+
                            ...
                            " and rawat_inap_dr.bhp>0 order by rawat_inap_dr.tgl_perawatan,jns_perawatan_inap.nm_perawatan");
                        psrawatinapdrpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_inap_drpr.bhp,"+
                            ...
                            " and rawat_inap_drpr.bhp>0 order by rawat_inap_drpr.tgl_perawatan,jns_perawatan_inap.nm_perawatan");
                        psrawatinappr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_inap_pr.bhp,"+
                            ...
                            " and rawat_inap_pr.bhp>0 order by rawat_inap_pr.tgl_perawatan,jns_perawatan_inap.nm_perawatan");                          
                        ...
                        try {
                            ...
                            while(rsrawatinapdr.next()){
                                tabMode.addRow(new Object[]{"","","     "+rsrawatinapdr.getString("tgl_perawatan")+" "+rsrawatinapdr.getString("jam_rawat"),rsrawatinapdr.getString("nm_pasien"),
                                    rsrawatinapdr.getString("nm_perawatan"),Valid.SetAngka(rsrawatinapdr.getDouble("bhp"))});                   
                                total=total+rsrawatinapdr.getDouble("bhp");
                            }
                            ...
                            while(rsrawatinapdrpr.next()){
                                tabMode.addRow(new Object[]{"","","     "+rsrawatinapdrpr.getString("tgl_perawatan")+" "+rsrawatinapdrpr.getString("jam_rawat"),rsrawatinapdrpr.getString("nm_pasien"),
                                    rsrawatinapdrpr.getString("nm_perawatan"),Valid.SetAngka(rsrawatinapdrpr.getDouble("bhp"))});                   
                                total=total+rsrawatinapdrpr.getDouble("bhp");
                            }
                            ...
                            while(rsrawatinappr.next()){
                                tabMode.addRow(new Object[]{"","","     "+rsrawatinappr.getString("tgl_perawatan")+" "+rsrawatinappr.getString("jam_rawat"),rsrawatinappr.getString("nm_pasien"),
                                    rsrawatinappr.getString("nm_perawatan"),Valid.SetAngka(rsrawatinappr.getDouble("bhp"))});                   
                                total=total+rsrawatinappr.getDouble("bhp");
                            }                           
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        } finally{
                   ...
                   if(chkLaborat.isSelected()==true){
                       psperiksa_lab=koneksi.prepareStatement("select periksa_lab.bhp,pasien.nm_pasien,"+
                       ...
                       try {
                            ...
                            while(rsperiksa_lab.next()){
                                ...
                                psdetail_lab=koneksi.prepareStatement(
                                    "select sum(detail_periksa_lab.bhp) as total from detail_periksa_lab "+
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsperiksa_lab.getString("nm_perawatan"),Valid.SetAngka(rsperiksa_lab.getDouble("bhp")+detail_lab)
                                });    
                                total=total+rsperiksa_lab.getDouble("bhp")+detail_lab;
                            }
                       } catch (Exception e) {
                           System.out.println("Notifikasi : "+e);
                       } finally{
                   ...
                   if(chkRadiologi.isSelected()==true){
                       psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.bhp,pasien.nm_pasien,"+
                       ...
                       try {
                            ...
                            while(rsperiksa_radiologi.next()){                                
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsperiksa_radiologi.getString("nm_perawatan"),Valid.SetAngka(rsperiksa_radiologi.getDouble("bhp"))
                                });    
                                total=total+rsperiksa_radiologi.getDouble("bhp");
                            }
                       } catch (Exception e) {
                           System.out.println("Notifikasi : "+e);
                       } finally{
                ...
                if(totaljm>0){
                   tabMode.addRow(new Object[]{">> ","Total BHP Medis/Paket Obat :","","","",Valid.SetAngka(totaljm)});     
                }
            } catch (Exception e) {
