...
public final class DlgCariKategoriPemasukanLain extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariKategoriPemasukanLain(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        DlgKategoriPemasukan penjab=new DlgKategoriPemasukan(null,false);
        penjab.emptTeks();
        penjab.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKategoriPemasukanLain dialog = new DlgCariKategoriPemasukanLain(new javax.swing.JFrame(), true);
