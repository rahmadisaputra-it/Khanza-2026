 ...
 * @author dosen
 */
public class DlgAkunBayar extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAkunBayar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"P","Nama Akun","Kode Rekening","Nama Rekening","PPN(%)"};
    ...
    private void initComponents() {
        ...
        nama.setBounds(84, 10, 350, 23);

        jLabel9.setText("PPN(%) :");
        jLabel9.setName("jLabel9"); // NOI18N
        jLabel9.setPreferredSize(new java.awt.Dimension(70, 23));
        panelBiasa1.add(jLabel9);
        jLabel9.setBounds(451, 10, 70, 23);

        ppn.setName("ppn"); // NOI18N
        ppn.setPreferredSize(new java.awt.Dimension(340, 23));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(ppn.getText().trim().equals("")){
            Valid.textKosong(ppn,"PPN");
        }else{
            if(Sequel.menyimpantf("akun_bayar","?,?,?","Nama Akun",3,new String[]{
                nama.getText(),kdrek.getText(),ppn.getText()
            })==true){
                tabMode.addRow(new Object[]{
                    false,nama.getText(),kdrek.getText(),nmrek.getText(),Double.parseDouble(ppn.getText())
                });
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(int i=0;i<tbJadwal.getRowCount();i++){ 
            if(tbJadwal.getValueAt(i,0).toString().equals("true")){
                if(Sequel.meghapustf("akun_bayar","nama_bayar",tbJadwal.getValueAt(i,1).toString())==true){
                    tabMode.removeRow(i);
                    i--;
                }
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(nama.getText().trim().equals("")){
            ...
            if(tbJadwal.getSelectedRow()>-1){
                if(Sequel.mengedittf("akun_bayar","nama_bayar=?","nama_bayar=?,kd_rek=?,ppn=?",4,new String[]{
                    nama.getText(),kdrek.getText(),ppn.getText(),tbJadwal.getValueAt(tbJadwal.getSelectedRow(),1).toString()
                })==true){
                    tbJadwal.setValueAt(false,tbJadwal.getSelectedRow(),0);
                    tbJadwal.setValueAt(nama.getText(),tbJadwal.getSelectedRow(),1);
                    tbJadwal.setValueAt(kdrek.getText(),tbJadwal.getSelectedRow(),2);
                    tbJadwal.setValueAt(nmrek.getText(),tbJadwal.getSelectedRow(),3);
                    tbJadwal.setValueAt(Double.parseDouble(ppn.getText()),tbJadwal.getSelectedRow(),4);
                    emptTeks();
                }
            }else{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAkunBayar dialog = new DlgAkunBayar(new javax.swing.JFrame(), true);
