...
public class DlgCariPermintaanLabPA extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPermintaanLabPA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-02-2026 11:58:37" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Permintaan Laboratorium Patologi Anatomi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnCetakHasilLab.setPreferredSize(new java.awt.Dimension(160, 23));
        ...
        BtnBarcodePermintaan.setPreferredSize(new java.awt.Dimension(160, 23));
        ...
        BtnBarcodePermintaan2.setPreferredSize(new java.awt.Dimension(160, 23));
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                if(NoPermintaan.trim().equals("")){
                    ...
                    if(Sequel.mengedittf("permintaan_labpa","noorder=?","tgl_sampel=?,jam_sampel=?",3,new String[]{
                ...
                if(NoPermintaan.trim().equals("")){
                    ...
                    try {
                        ps2=koneksi.prepareStatement(
                                ...
                                "from permintaan_pemeriksaan_labpa inner join jns_perawatan_lab on "+
                                "permintaan_pemeriksaan_labpa.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                    ...
                    param.put("diperolehdengan",diperolehdengan);
                    param.put("lokasijaringan",lokasijaringan);
                    param.put("diawetkandengan",diawetkandengan);
                    param.put("pernahdilakukandi",pernahdilakukandi);
                    param.put("tanggalpa",(pernahdilakukandi.equals("")?"":tanggalpa));
                    param.put("diagnosapa",diagnosapa);
                    param.put("nomorpa",nomorpa);
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    param.put("kotars",akses.getkabupatenrs());
                    param.put("propinsirs",akses.getpropinsirs());
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "permintaan_labpa.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,permintaan_labpa.informasi_tambahan,permintaan_labpa.diagnosa_klinis, "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    try {
                        ...
                        rs2=ps2.executeQuery();
                        while(rs2.next()){
                            itempermintaan=rs2.getString("nm_perawatan")+", "+itempermintaan;
                        }
                    } catch (Exception e) {
                        System.out.println("Notif 2 : "+e);
                    } finally{
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("pengambilan_bahan"),
                        rs.getString("diperoleh_dengan"),rs.getString("lokasi_jaringan"),rs.getString("diawetkan_dengan"),
                        rs.getString("pernah_dilakukan_di"),rs.getString("tanggal_pa_sebelumnya"),rs.getString("nomor_pa_sebelumnya"),
    ...
    private void tampil2() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "permintaan_labpa.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,permintaan_labpa.informasi_tambahan,"+
                "permintaan_labpa.diagnosa_klinis,permintaan_labpa.pengambilan_bahan,permintaan_labpa.diperoleh_dengan,"+
                "permintaan_labpa.lokasi_jaringan,permintaan_labpa.diawetkan_dengan,permintaan_labpa.pernah_dilakukan_di,"+
                "if(permintaan_labpa.tanggal_pa_sebelumnya='0000-00-00','',permintaan_labpa.tanggal_pa_sebelumnya) as tanggal_pa_sebelumnya,"+
                "permintaan_labpa.nomor_pa_sebelumnya,permintaan_labpa.diagnosa_pa_sebelumnya "+
                "from permintaan_labpa inner join reg_periksa on permintaan_labpa.no_rawat=reg_periksa.no_rawat "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode2.addRow(new Object[]{
                        ...
                        rs.getString("nm_perawatan"),rs.getString("tgl_permintaan"),rs.getString("jam_permintaan"),rs.getString("tgl_sampel"),
                        ...
                        rs.getString("diagnosa_klinis"),rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("pengambilan_bahan"),
                        rs.getString("diperoleh_dengan"),rs.getString("lokasi_jaringan"),rs.getString("diawetkan_dengan"),
                        rs.getString("pernah_dilakukan_di"),rs.getString("tanggal_pa_sebelumnya"),rs.getString("nomor_pa_sebelumnya"),
            ...
            try {
                ...
                while(rs.next()){
                    tabMode4.addRow(new Object[]{
                        rs.getString("noorder"),rs.getString("no_rawat"),rs.getString("no_rkm_medis")+" "+rs.getString("nm_pasien"),
                        rs.getString("nm_perawatan"),rs.getString("tgl_permintaan"),rs.getString("jam_permintaan"),rs.getString("tgl_sampel"),rs.getString("jam_sampel"),
