 ...
 * @author dosen
 */
public final class TokoJenis extends javax.swing.JDialog {
     ...
     *@param parent
     *@param modal */
    public TokoJenis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Jenis Barang Toko / Minimarket / Koperasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelisi4.add(Kd);
        Kd.setBounds(79, 12, 80, 23);

        label36.setText("Jenis Barang :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Kode Jenis Barang");
        }else if(Nm.getText().trim().equals("")){
            Valid.textKosong(Nm,"Nama Jenis Barang");
        }else{
            Sequel.menyimpan("tokojenisbarang","'"+Kd.getText()+"','"+Nm.getText()+"'","Kode Jenis Barang");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("tokojenisbarang","kd_jenis",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptIpsrsJenis.jasper","report","::[ Data Jenis Barang ]::","select kd_jenis, nm_jenis "+
                " from tokojenisbarang where  kd_jenis like '%"+TCari.getText().trim()+"%' or "+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoJenis dialog = new TokoJenis(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Kd.requestFocus();        
        Valid.autoNomer("tokojenisbarang","J",2,Kd);
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.gettoko_jenis());
        BtnHapus.setEnabled(akses.gettoko_jenis());
        BtnEdit.setEnabled(akses.gettoko_jenis());
        BtnPrint.setEnabled(akses.gettoko_jenis());
        
        ppGanti.setEnabled(akses.gettoko_jenis());        
        ppHapus.setEnabled(akses.gettoko_jenis());
        ppCetak.setEnabled(akses.gettoko_jenis());
        ppSimpan.setEnabled(akses.gettoko_jenis());
    }
