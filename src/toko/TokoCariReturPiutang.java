...
public class TokoCariReturPiutang extends javax.swing.JDialog {
    ...
    private String carifaktur,carimember,caripetugas,carijenis,caribarang;
    private boolean sukses=false;

    /** Creates new form DlgProgramStudi
     * @param parent
     * @param modal */
    public TokoCariReturPiutang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"No.Retur","Member","Petugas","Keterangan","Jml","Harga(Rp)","Total(Rp)"};
        ...
        kdmem.setDocument(new batasInput((byte)5).getKata(kdmem));
    ...
    private void initComponents() {
        ...
        ppHapus.setText("Hapus Data Retur Piutang Dari Member");
        ppHapus.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppHapus.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppHapus.setName("ppHapus"); // NOI18N
        ppHapus.setPreferredSize(new java.awt.Dimension(240, 25));
...
*/
    ...
    private void TglBeli1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TglBeli1KeyPressed
        Valid.pindah(evt,NoFaktur,kdmem);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptReturPiutangToko.jasper","report","::[ Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli ]::",param);
        }
             ...
             try {
                ...
                if(rs.next()){
                    ...
                    try {
                        ...
                        rs2=pstoko_detail_returpiutang.executeQuery();
                        while(rs2.next()){
                            Trackbarang.catatRiwayat(rs2.getString("kode_brng"),0,rs2.getDouble("jml_retur"),"Retur Piutang", akses.getkode(),"Hapus");
                        ...
                        if(pstoko_detail_returpiutang!=null){
                            pstoko_detail_returpiutang.close();
                        }
                    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoCariReturPiutang dialog = new TokoCariReturPiutang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
       Valid.tabelKosong(tabMode);
        try{   
            carifaktur="";carimember="";caripetugas="";carijenis="";caribarang="";
            if(!NoFaktur.getText().equals("")){
                carifaktur=" and tokoreturpiutang.no_retur_piutang like '%"+NoFaktur.getText()+"%' ";
            }
            if(!nmmem.getText().equals("")){
                carimember=" and tokomember.nama like '%"+nmmem.getText()+"%' ";
            }
            if(!nmptg.getText().equals("")){
                caripetugas=" and petugas.nama like '%"+nmptg.getText()+"%' ";
            }
            if(!nmjenis.getText().equals("")){
                carijenis=" and tokojenisbarang.nm_jenis like '%"+nmjenis.getText()+"%' ";
            }
            ...
            ps=koneksi.prepareStatement(
                    ...
                    " from tokoreturpiutang inner join tokomember inner join petugas  "+
                    " inner join toko_detail_returpiutang inner join tokobarang inner join kodesatuan "+
                    " inner join tokojenisbarang "+
                    " on toko_detail_returpiutang.kode_brng=tokobarang.kode_brng "+
                    " and toko_detail_returpiutang.kode_sat=kodesatuan.kode_sat "+
                    " and tokoreturpiutang.no_retur_piutang=toko_detail_returpiutang.no_retur_piutang "+
                    " and tokoreturpiutang.no_member=tokomember.no_member "+
                    " and tokoreturpiutang.nip=petugas.nip and tokobarang.jenis=tokojenisbarang.kd_jenis"+
                    " where tokoreturpiutang.tgl_retur between '"+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglBeli2.getSelectedItem()+"")+"' "+carifaktur+carimember+caripetugas+carijenis+caribarang+
                    (TCari.getText().trim().equals("")?"":" and (tokoreturpiutang.no_retur_piutang like '%"+TCari.getText()+"%' or tokoreturpiutang.no_member like '%"+TCari.getText()+"%' or tokomember.nama like '%"+TCari.getText()+"%' or "+
                    " tokoreturpiutang.nip like '%"+TCari.getText()+"%' or petugas.nama like '%"+TCari.getText()+"%' or toko_detail_returpiutang.kode_brng like '%"+TCari.getText()+"%' or "+
                    " tokobarang.nama_brng like '%"+TCari.getText()+"%' or toko_detail_returpiutang.kode_sat like '%"+TCari.getText()+"%' or tokojenisbarang.nm_jenis like '%"+TCari.getText()+"%') ")+
                    " group by tokoreturpiutang.no_retur_piutang order by tokoreturpiutang.tgl_retur,tokoreturpiutang.no_retur_piutang ");
            try {
                rs=ps.executeQuery();
                tagihan=0;
                while(rs.next()){
                    tabMode.addRow(new Object[]{rs.getString("no_retur_piutang"),rs.getString("no_member")+" "+rs.getString("nama"),
                    ...
                    ps2=koneksi.prepareStatement("select toko_detail_returpiutang.kode_brng,tokobarang.nama_brng, "+
                        ...
                        "from toko_detail_returpiutang inner join tokobarang inner join kodesatuan inner join tokojenisbarang "+
                        " on toko_detail_returpiutang.kode_brng=tokobarang.kode_brng and tokobarang.jenis=tokojenisbarang.kd_jenis "+
                        " and toko_detail_returpiutang.kode_sat=kodesatuan.kode_sat where "+
                        " toko_detail_returpiutang.no_retur_piutang='"+rs.getString("no_retur_piutang")+"'"+carijenis+caribarang+
                        " and (toko_detail_returpiutang.kode_brng like '%"+TCari.getText().trim()+"%' or tokobarang.nama_brng like '%"+TCari.getText().trim()+"%' or "+
                        " toko_detail_returpiutang.kode_sat like '%"+TCari.getText().trim()+"%' or tokojenisbarang.nm_jenis like '%"+TCari.getText().trim()+"%' or "+
                        " toko_detail_returpiutang.nota_piutang like '%"+TCari.getText().trim()+"%') "+
                        "order by toko_detail_returpiutang.kode_brng  ");
                    try {
                        ...
                        while(rs2.next()){
                            ...
                            tabMode.addRow(new Object[]{
                                i+". "+rs2.getString("kode_brng"),rs2.getString("nama_brng"),"No. Nota : "+rs2.getString("nota_piutang"),rs2.getString("satuan"),rs2.getString("jml_retur"),Valid.SetAngka(rs2.getDouble("h_retur")),Valid.SetAngka(rs2.getDouble("total"))
                            });
                            i++;
                        }                        
                    } catch (Exception e) {
    ...
    public void isCek(){
        BtnPrint.setEnabled(akses.gettoko_retur_piutang());
