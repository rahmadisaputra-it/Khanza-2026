...
public final class TokoStokOpname extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public TokoStokOpname(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"Kode Barang","Nama Barang","Harga Dasar","Satuan","Tanggal","Stok","Real",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,Kdbar,"tokoopname","tanggal='"+Tanggal.getSelectedItem()+"' and kode_brng");
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoStokOpname dialog = new TokoStokOpname(new javax.swing.JFrame(), true);
