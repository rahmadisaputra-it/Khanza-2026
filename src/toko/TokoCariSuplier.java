...
public class TokoCariSuplier extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public TokoCariSuplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if(Valid.daysOld("./cache/supliertoko.iyem")<30){
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        TokoSuplier form=new TokoSuplier(null,false);
        form.emptTeks();
        form.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoCariSuplier dialog = new TokoCariSuplier(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ...
            if (iyembuilder.length() > 0) {
                ...
                fileWriter.write("{\"supliertoko\":["+iyembuilder+"]}");
                fileWriter.flush();
            }
    ...
    public void isCek(){
        BtnTambah.setEnabled(akses.gettoko_suplier());
    }
