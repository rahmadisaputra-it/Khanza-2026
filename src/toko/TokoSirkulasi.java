...
public class TokoSirkulasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public TokoSirkulasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptSirkulasiToko.jasper","report","::[ Sirkulasi Barang Toko ]::",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoSirkulasi dialog = new TokoSirkulasi(new javax.swing.JFrame(), true);
