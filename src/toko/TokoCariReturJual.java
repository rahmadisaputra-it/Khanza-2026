...
public class TokoCariReturJual extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public TokoCariReturJual(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        ppHapus.setText("Hapus Data Retur Jual Dari Pembeli");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Retur Jual Barang Toko / Minimarket / Koperasi Dari Pembeli ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptReturJualToko.jasper","report","::[ Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli ]::",param);
        }
             ...
             try {
                ...
                if(rs.next()){
                    ...
                    try {
                        ...
                        rs2=pstoko_detail_returjual.executeQuery();
                        while(rs2.next()){
                            Trackbarang.catatRiwayat(rs2.getString("kode_brng"),0,rs2.getDouble("jml_retur"),"Retur Jual", akses.getkode(),"Hapus");
                        ...
                        if(pstoko_detail_returjual!=null){
                            pstoko_detail_returjual.close();
                        }
                    }
                        
                    Sequel.queryu("delete from tampjurnal");
                    if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{
                            Sequel.cariIsi("select Retur_Jual_Toko from set_akun"),"RETUR JUAL TOKO","0",rs.getString("total")
                        })==false){
                            sukses=false;
                    }    
                    if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoCariReturJual dialog = new TokoCariReturJual(new javax.swing.JFrame(), true);
       ...
       Valid.tabelKosong(tabMode);
        try{   
            ...
            if(!NoFaktur.getText().equals("")){
                carifaktur=" and tokoreturjual.no_retur_jual like '%"+NoFaktur.getText()+"%' ";
            }
            ...
            ps=koneksi.prepareStatement(
                    ...
                    " from tokoreturjual inner join tokomember inner join petugas  "+
                    " inner join toko_detail_returjual inner join tokobarang inner join kodesatuan "+
                    " inner join tokojenisbarang "+
                    " on toko_detail_returjual.kode_brng=tokobarang.kode_brng "+
                    " and toko_detail_returjual.kode_sat=kodesatuan.kode_sat "+
                    " and tokoreturjual.no_retur_jual=toko_detail_returjual.no_retur_jual "+
                    " and tokoreturjual.no_member=tokomember.no_member "+
                    " and tokoreturjual.nip=petugas.nip and tokobarang.jenis=tokojenisbarang.kd_jenis"+
                    " where tokoreturjual.tgl_retur between '"+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglBeli2.getSelectedItem()+"")+"' "+carifaktur+carimember+caripetugas+carijenis+caribarang+
                    (TCari.getText().trim().equals("")?"":" and (tokoreturjual.no_retur_jual like '%"+TCari.getText()+"%' or tokoreturjual.no_member like '%"+TCari.getText()+"%' or tokomember.nama like '%"+TCari.getText()+"%' or "+
                    " tokoreturjual.nip like '%"+TCari.getText()+"%' or petugas.nama like '%"+TCari.getText()+"%' or toko_detail_returjual.kode_brng like '%"+TCari.getText()+"%' or "+
                    " tokobarang.nama_brng like '%"+TCari.getText()+"%' or toko_detail_returjual.kode_sat like '%"+TCari.getText()+"%' or tokojenisbarang.nm_jenis like '%"+TCari.getText()+"%') ")+
                    " group by tokoreturjual.no_retur_jual order by tokoreturjual.tgl_retur,tokoreturjual.no_retur_jual ");
            try {
                rs=ps.executeQuery();
                tagihan=0;
                while(rs.next()){
                    tabMode.addRow(new Object[]{rs.getString("no_retur_jual"),rs.getString("no_member")+" "+rs.getString("nama"),
                    ...
                    ps2=koneksi.prepareStatement("select toko_detail_returjual.kode_brng,tokobarang.nama_brng, "+
                        ...
                        "from toko_detail_returjual inner join tokobarang inner join kodesatuan inner join tokojenisbarang "+
                        " on toko_detail_returjual.kode_brng=tokobarang.kode_brng and tokobarang.jenis=tokojenisbarang.kd_jenis "+
                        " and toko_detail_returjual.kode_sat=kodesatuan.kode_sat where "+
                        " toko_detail_returjual.no_retur_jual='"+rs.getString("no_retur_jual")+"'"+carijenis+caribarang+
                        " and (toko_detail_returjual.kode_brng like '%"+TCari.getText().trim()+"%' or tokobarang.nama_brng like '%"+TCari.getText().trim()+"%' or "+
                        " toko_detail_returjual.kode_sat like '%"+TCari.getText().trim()+"%' or tokojenisbarang.nm_jenis like '%"+TCari.getText().trim()+"%' or "+
                        " toko_detail_returjual.nota_jual like '%"+TCari.getText().trim()+"%') "+
                        "order by toko_detail_returjual.kode_brng  ");
                    try {
    ...
    public void isCek(){
        BtnPrint.setEnabled(akses.gettoko_retur_jual());
