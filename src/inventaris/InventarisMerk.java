 ...
 * @author dosen
 */
public class InventarisMerk extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisMerk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Merk Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"ID Merk");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Nama Merk");
        }else{
            Sequel.menyimpan("inventaris_merk","'"+TKd.getText()+"','"+TNm.getText()+"'","ID Merk");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"inventaris_merk","id_merk");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("inventaris_merk","id_merk=?","id_merk=?,nama_merk=?",3,new String[]{
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari("select * from inventaris_merk where id_merk like '%"+TCari.getText().trim()+"%' "+
                "or nama_merk like '%"+TCari.getText().trim()+"%' ");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisMerk dialog = new InventarisMerk(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"MI",5,TKd);
        TKd.requestFocus();
    }

    private void getData() {
        i=tbSpesialis.getSelectedRow();
        if(i!= -1){
