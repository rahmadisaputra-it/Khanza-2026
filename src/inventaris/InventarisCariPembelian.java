...
public class InventarisCariPembelian extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisCariPembelian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Pengadaan Barang Aset/Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        btnSatuan.setBounds(291, 10, 28, 23);
            ...
            if(ceksukses==false){
                ...
                for(i=0;i<row;i++){  
                    Sequel.menyimpan("temporary","'"+i+"','"+
                                    ...
                                    tabMode.getValueAt(i,9).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Pembelian"); 
                }
                i++;
                Sequel.menyimpan("temporary","'0','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Pembelian"); 
                i++;
                Sequel.menyimpan("temporary","'0','Jumlah Total :','','','','','','',' ','"+LTotal.getText()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Pembelian"); 
                ...
                Valid.MyReportqry("rptPembelianAset.jasper","report","::[ Transaksi Pembelian Barang Aset/Inventaris ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }else{
           ...
           try {
               ...
               try {
                  ...
                  if(rs.next()){
                      ...
                      if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{rs.getString("kd_rek_aset"),"PEMBELIAN","0",rs.getString("total")})==false){
                          sukses=false;
                      }    
                      if(rs.getDouble("ppn")>0){
                          if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{PPN_Masukan,"PPN Masukan Inventaris","0",rs.getString("ppn")})==false){
                              sukses=false;
                          } 
                      }
                      if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{rs.getString("kd_rek"),"KAS DI TANGAN",rs.getString("tagihan"),"0"})==false){
                          sukses=false;
                      } 
                      if(sukses==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisCariPembelian dialog = new InventarisCariPembelian(new javax.swing.JFrame(), true);
