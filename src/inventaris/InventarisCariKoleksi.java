 ...
 * @author dosen
 */
public final class InventarisCariKoleksi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisCariKoleksi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        InventarisKoleksi form=new InventarisKoleksi(null,false);
        form.emptTeks();
        form.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisCariKoleksi dialog = new InventarisCariKoleksi(new javax.swing.JFrame(), true);
