...
public class InventarisBarangCSSD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelGlass7.add(no_inventaris);
        no_inventaris.setBounds(92, 10, 130, 23);

        nama_barang.setEditable(false);
        nama_barang.setName("nama_barang"); // NOI18N
        panelGlass7.add(nama_barang);
        nama_barang.setBounds(223, 10, 255, 23);
