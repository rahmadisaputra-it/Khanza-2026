...
public final class InventarisPemeliharaan extends javax.swing.JDialog {
    ...
    public InventarisPemeliharaan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Inventaris","Kode Barang","Nama Barang","Ruang","NIP","Penanggung Jawab","Kegiatan","Tanggal","Pelaksana","Biaya","Jenis Pemeliharaan"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pemeliharaan Aset/Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setBounds(384, 100, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoInventaris.getText().trim().equals("")||KodeBarang.getText().trim().equals("")||NamaBarang.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pemeliharaan_inventaris","?,?,?,?,?,?,?","Nomor Inventaris",7,new String[]{
