...
public class InventarisAsalHibah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisAsalHibah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"Kode Pemberi","Nama Pemberi","Alamat Pemberi Hibah","Kota","No.Telp"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pemberi Hibah/Asal Hibah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(660, 98));
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Valid.hapusTable(tabMode,Kd,"pemberihibah","kode_pemberi");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Kode Pemberi Hibah");
        }else if(Nm.getText().trim().equals("")){
            Valid.textKosong(Nm,"Nama Pemberi Hibah");
        }else if(Alamat.getText().trim().equals("")){
            Valid.textKosong(Alamat,"Alamat Pemberi Hibah");
        }else if(Telp.getText().trim().equals("")){
            Valid.textKosong(Telp,"No.Telp");
        }else if(Kota.getText().trim().equals("")){
            Valid.textKosong(Kota,"Kota");
        }else{
            Valid.editTable(tabMode,"pemberihibah","kode_pemberi","?","kode_pemberi=?,nama_pemberi=?,alamat=?,kota=?,no_telp=?",6,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptAsalHibah.jasper","report","::[ Data Pemberi Hibah/Asal Hibah ]::","select pemberihibah.kode_pemberi, pemberihibah.nama_pemberi, "+
                    ...
                    " pemberihibah.nama_pemberi like '%"+TCari.getText().trim()+"%' or "+
                    " pemberihibah.alamat like '%"+TCari.getText().trim()+"%' or "+
                    " pemberihibah.kota like '%"+TCari.getText().trim()+"%' or "+
                    " pemberihibah.no_telp like '%"+TCari.getText().trim()+"%' order by pemberihibah.kode_pemberi",param);            
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pemberihibah","?,?,?,?,?","Kode Pemberi Hibah",5,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisAsalHibah dialog = new InventarisAsalHibah(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select pemberihibah.kode_pemberi, pemberihibah.nama_pemberi, "+
                    " pemberihibah.alamat,pemberihibah.kota, pemberihibah.no_telp from pemberihibah "+
                    " where pemberihibah.kode_pemberi like ? or "+
                    " pemberihibah.nama_pemberi like ? or "+
                    " pemberihibah.alamat like ? or "+
                    " pemberihibah.kota like ? or "+
                    " pemberihibah.no_telp like ? order by pemberihibah.kode_pemberi");
            try {
    ...
    public void emptTeks() {
        ...
        Kd.requestFocus();
        Valid.autoNomer("pemberihibah","H",4,Kd);
    }
    ...
    public void isCek(){
        ...
        BtnHapus.setEnabled(akses.getasal_hibah());
        BtnEdit.setEnabled(akses.getasal_hibah());
        BtnPrint.setEnabled(akses.getasal_hibah());
    }
