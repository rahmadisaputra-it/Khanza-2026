...
public class InventarisCariHibah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisCariHibah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Hibah Barang Aset/Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
           ...
           try {
               ...
               try {
                  ...
                  if(rs.next()){
                      ...
                      if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{rs.getString("kd_rek_aset"),"JENIS ASET/INVENTARIS","0",rs.getString("totalhibah")})==false){
                          sukses=false;
                      }    
                      if(Sequel.menyimpantf2("tampjurnal","?,?,?,?","Rekening",4,new String[]{Kontra_Hibah_Aset,"PENDAPATAN HIBAH",rs.getString("totalhibah"),"0"})==false){
                          sukses=false;
                      } 
                      if(sukses==true){
    ...
    */
    ...
    public void isCek(){
        BtnPrint.setEnabled(akses.gethibah_aset_inventaris());
