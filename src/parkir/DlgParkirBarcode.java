...
public class DlgParkirBarcode extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nomer_kartu = new widget.TextBox();
        ...
        panelGlass7.add(barcode);
        barcode.setBounds(94, 12, 180, 23);

        jLabel5.setText("Nomer Kartu :");
        ...
        nomer_kartu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nomer_kartuKeyPressed(evt);
            }
        });
        panelGlass7.add(nomer_kartu);
        nomer_kartu.setBounds(437, 12, 180, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(nomer_kartu.getText().trim().equals("")){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if((! TCari.getText().trim().equals(""))&&(CmbCrGd.getSelectedItem().equals("SHOW ALL"))&&(CmbCrStts.getSelectedItem().equals("SHOW ALL"))&&(cmbCrJk.getSelectedItem().equals("SHOW ALL"))){
            BtnCariActionPerformed(evt);
        }
        if(tabMode.getRowCount()==0){
            ...
            if((TCari.getText().trim().equals(""))&&(CmbCrGd.getSelectedItem().equals("SHOW ALL"))&&(CmbCrStts.getSelectedItem().equals("SHOW ALL"))&&(cmbCrJk.getSelectedItem().equals("SHOW ALL"))){
                ...
                Valid.MyReport("rptDokter.jasper","report","::[ Data Dokter ]::","select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                    ...
                    " order by kd_dokter",param);
            }else if((! TCari.getText().trim().equals(""))&&(CmbCrGd.getSelectedItem().equals("SHOW ALL"))&&(CmbCrStts.getSelectedItem().equals("SHOW ALL"))&&(cmbCrJk.getSelectedItem().equals("SHOW ALL"))){
                Map<String, Object> param = new HashMap<>();
                param.put("namars",var.getnamars());
                param.put("alamatrs",var.getalamatrs());
                param.put("kotars",var.getkabupatenrs());
                ...
                Valid.MyReport("rptDokter.jasper","report","::[ Data Dokter ]::","select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                    ...
                    "from dokter,spesialis "+
                    "where "+
                    sql+"and kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                    ...
                    sql+"and gol_drh like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and agama like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and almt_tgl like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and no_telp like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and stts_nikah like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and nm_sps like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and alumni like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and no_ijn_praktek like '%"+TCari.getText().trim()+"%' "+
                    " order by kd_dokter",param);
            }else if(TCari.getText().trim().equals("")&&(! CmbCrGd.getSelectedItem().equals("SHOW ALL")|| !CmbCrStts.getSelectedItem().equals("SHOW ALL")|| !cmbCrJk.getSelectedItem().equals("SHOW ALL"))){
                if((CmbCrGd.getItemCount()>0)&&(CmbCrStts.getItemCount()>0)&&(cmbCrJk.getItemCount()>0)){
                    String sql="";
                    if(cmbCrJk.getSelectedItem().toString().equals("SHOW ALL")&&CmbCrGd.getSelectedItem().toString().equals("SHOW ALL")&&CmbCrStts.getSelectedItem().toString().equals("SHOW ALL")){
                        sql="";
                    }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&CmbCrGd.getSelectedItem().toString().equals("SHOW ALL")&&CmbCrStts.getSelectedItem().toString().equals("SHOW ALL")){
                        sql="and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' ";
                    }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&CmbCrStts.getSelectedItem().toString().equals("SHOW ALL")){
                        sql="and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' "+
                        "and gol_drh='"+CmbCrGd.getSelectedItem()+"' ";
                    }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                        sql="and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' "+
                        "and gol_drh='"+CmbCrGd.getSelectedItem()+"' "+
                        "and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ";
                    }else if((cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                        sql="and gol_drh='"+CmbCrGd.getSelectedItem()+"' "+
                        "and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ";
                    }else if((cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                        sql="and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ";
                    }else if((! cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                        sql="and jk='"+cmbCrJk.getSelectedItem().toString().substring(0,1)+"' "+
                        "and stts_nikah='"+CmbCrStts.getSelectedItem()+"' ";
                    }else if((cmbCrJk.getSelectedItem().toString().equals("SHOW ALL"))&&(! CmbCrGd.getSelectedItem().toString().equals("SHOW ALL"))&&(CmbCrStts.getSelectedItem().toString().equals("SHOW ALL"))){
                    ...
                    Valid.MyReport("rptDokter.jasper","report","::[ Data Dokter ]::","select kd_dokter,nm_dokter,jk,tmp_lahir, "+
                        ...
                        "stts_nikah,nm_sps,alumni,no_ijn_praktek "+
                        "from dokter,spesialis "+
                        "where dokter.kd_sps=spesialis.kd_sps "+sql+
                        " order by kd_dokter ",param);
                }
            }
        }
    ...
    */
    ...
    private widget.TextBox nomer_kartu;
