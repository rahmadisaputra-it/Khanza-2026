 ...
 * @author dosen
 */
public final class ZISKursiRumahPenerimaDankes extends javax.swing.JDialog {
     ...
     *@param parent
     *@param modal */
    public ZISKursiRumahPenerimaDankes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Keterangan Kursi Rumah Penerima Dana Kesehatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("zis_keterangan_kursi_rumah_penerima_dankes","'"+Kd.getText()+"','"+Nm.getText()+"'","Kode");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("zis_keterangan_kursi_rumah_penerima_dankes","kode",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(tbKamar.getSelectedRow()> -1){
                Valid.editTable(tabMode,"zis_keterangan_kursi_rumah_penerima_dankes","kode","?","keterangan=?,kode=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ZISKursiRumahPenerimaDankes dialog = new ZISKursiRumahPenerimaDankes(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{            
            ps=koneksi.prepareStatement("select kode,keterangan  "+
                    " from zis_keterangan_kursi_rumah_penerima_dankes where  kode like ? or "+
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Kd.requestFocus();        
        Valid.autoNomer("zis_keterangan_kursi_rumah_penerima_dankes","",3,Kd);
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getzis_kursi_rumah_penerima_dankes());
        BtnHapus.setEnabled(akses.getzis_kursi_rumah_penerima_dankes());
        BtnEdit.setEnabled(akses.getzis_kursi_rumah_penerima_dankes());
        
        ppGanti.setEnabled(akses.getzis_kursi_rumah_penerima_dankes());        
        ppHapus.setEnabled(akses.getzis_kursi_rumah_penerima_dankes());
        ppSimpan.setEnabled(akses.getzis_kursi_rumah_penerima_dankes());
    }
