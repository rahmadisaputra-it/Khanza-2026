...
public class DapurCariReturBeli extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,ps2,pscaripesan,psdapur_detail_returbeli;
     ...
     * @param parent
     * @param modal */
    public DapurCariReturBeli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurCariReturBeli dialog = new DapurCariReturBeli(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnPrint.setEnabled(akses.getdapur_returbeli());
