 ...
 * @author dosen
 */
public class DapurStokKeluarBarangPerTanggal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurStokKeluarBarangPerTanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurStokKeluarBarangPerTanggal dialog = new DapurStokKeluarBarangPerTanggal(new javax.swing.JFrame(), true);
    ...
    String konversi(int year, int month, int day){
        ...
        try {
            ...
            Logger.getLogger(DapurStokKeluarBarangPerTanggal.class.getName()).log(Level.SEVERE, null, ex);
        }
