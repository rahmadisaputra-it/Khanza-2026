...
public class DapurVerifikasiPenerimaan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurVerifikasiPenerimaan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Verifikasi Penerimaan Barang Non Medis dan Penunjang ( Lab & RO ) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
*/
                            ...
                            "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA VERIFIKASI PENERIMAAN DAPUR KERING & BASAH<br>PERIODE "+TglBeli1.getSelectedItem()+" s.d. "+TglBeli2.getSelectedItem()+"<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        htmlContent.append(                             
            "<tr class='isi'>"+
                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50%' colspan='9'>Data Surat Pemesanan Barang Dapur Kering & Basah</td>"+
                "<td valign='middle' bgcolor='#FFFAFA' align='center' width='35%' colspan='7'>Data Penerimaan Barang Dapur Kering & Basah</td>"+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurVerifikasiPenerimaan dialog = new DapurVerifikasiPenerimaan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ...
            if(!NoFaktur.getText().trim().equals("")){
                carifaktur=" and surat_pemesanan_dapur.no_pemesanan='"+NoFaktur.getText()+"' ";
            }
            if(!nmsup.getText().trim().equals("")){
                carisuplier=" and surat_pemesanan_dapur.kode_suplier='"+kdsup.getText()+"' ";
            }
            if(!nmptg.getText().trim().equals("")){
                caripegawai=" and surat_pemesanan_dapur.nip='"+kdptg.getText()+"' ";
            }
            if(!TCari.getText().trim().equals("")){
                carikeyword=" and (surat_pemesanan_dapur.no_pemesanan like '%"+TCari.getText().trim()+"%' or "+
                            " surat_pemesanan_dapur.kode_suplier like '%"+TCari.getText().trim()+"%' or "+
                            " dapursuplier.nama_suplier like '%"+TCari.getText().trim()+"%' or "+
                            " surat_pemesanan_dapur.nip like '%"+TCari.getText().trim()+"%' or "+
                            " pegawai.nama like '%"+TCari.getText().trim()+"%') ";
            }
            
            ps=koneksi.prepareStatement("select date_format(surat_pemesanan_dapur.tanggal,'%d/%m/%Y') as tanggal,surat_pemesanan_dapur.no_pemesanan, "+
                    "surat_pemesanan_dapur.kode_suplier,dapursuplier.nama_suplier,surat_pemesanan_dapur.nip,pegawai.nama,surat_pemesanan_dapur.subtotal,"+
                    "surat_pemesanan_dapur.status,surat_pemesanan_dapur.total,surat_pemesanan_dapur.ppn,surat_pemesanan_dapur.meterai,"+
                    "surat_pemesanan_dapur.potongan,surat_pemesanan_dapur.tanggal as tglpesan,surat_pemesanan_dapur.tagihan from surat_pemesanan_dapur "+
                    "inner join dapursuplier on surat_pemesanan_dapur.kode_suplier=dapursuplier.kode_suplier "+
                    "inner join pegawai on surat_pemesanan_dapur.nip=pegawai.nik where surat_pemesanan_dapur.status='Sudah Datang' "+
                    "and surat_pemesanan_dapur.tanggal between '"+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglBeli2.getSelectedItem()+"")+"' "+
                    carifaktur+carisuplier+caripegawai+carikeyword+" order by surat_pemesanan_dapur.tanggal,surat_pemesanan_dapur.no_pemesanan ");
            ...
            try {
                ...
                while(rs.next()){
                    pspenerimaan=koneksi.prepareStatement(
                            "select date_format(dapurpemesanan.tgl_pesan,'%d/%m/%Y') as tanggal,dapurpemesanan.no_faktur,dapurpemesanan.total1,dapurpemesanan.potongan, "+
                            "dapurpemesanan.nip,petugas.nama,date_format(dapurpemesanan.tgl_faktur,'%d/%m/%Y') as tgl_faktur, "+
                            "date_format(dapurpemesanan.tgl_tempo,'%d/%m/%Y') as tgl_tempo,dapurpemesanan.status,dapurpemesanan.total2,dapurpemesanan.ppn,"+
                            "dapurpemesanan.meterai,dapurpemesanan.tagihan,dapurpemesanan.no_order,(to_days(dapurpemesanan.tgl_pesan)-to_days('"+rs.getString("tglpesan")+"')) as lama "+
                            "from dapurpemesanan inner join petugas on dapurpemesanan.nip=petugas.nip "+
                            "where dapurpemesanan.no_order='"+rs.getString("no_pemesanan")+"'");
                    try {
                        ...
                        if(rspenerimaan.next()){
                           ...
                           htmlContent.append(                             
                            ...
                            pssub=koneksi.prepareStatement(
                                    "select detail_surat_pemesanan_dapur.kode_brng,dapurbarang.nama_brng,kodesatuan.satuan,detail_surat_pemesanan_dapur.jumlah,detail_surat_pemesanan_dapur.h_pesan, "+
                                    ...
                                    "inner join kodesatuan on detail_surat_pemesanan_dapur.kode_sat=kodesatuan.kode_sat where detail_surat_pemesanan_dapur.no_pemesanan='"+rs.getString("no_pemesanan")+"'");
                            try {
                                ...
                                while(rssub.next()){
                                    ...
                                    pssubpenerimaan=koneksi.prepareStatement(
                                        "select kodesatuan.satuan,dapurdetailpesan.jumlah,dapurdetailpesan.harga,"+
                                        "dapurdetailpesan.subtotal,dapurdetailpesan.dis,dapurdetailpesan.besardis,dapurdetailpesan.total "+
                                        "from dapurdetailpesan inner join kodesatuan on dapurdetailpesan.kode_sat=kodesatuan.kode_sat "+
                                        "where dapurdetailpesan.no_faktur='"+rspenerimaan.getString("no_faktur")+"' and dapurdetailpesan.kode_brng='"+rssub.getString("kode_brng")+"'");
                                    try {
                                        ...
                                        if(rssubpenerimaan.next()){
                                            ...
                                            h_pesan=rssubpenerimaan.getDouble("harga");
                                        ...
                                        if(jumlah2==rssub.getDouble("jumlah")){
                                            status="Tepat";
                                            index=2;
                                            if(!satuan.equals(rssub.getString("satuan"))){
                                                index=1;
                                            }
                                        }else if(jumlah2==0){
                                            status="Kosong";
                                            index=0;
                                        }else if(jumlah2>rssub.getDouble("jumlah")){
                                            status="Lebih";
                                            index=1;
                                        }else if(jumlah2<rssub.getDouble("jumlah")){
                                            status="Kurang";
                            ...
                            pssisipan=koneksi.prepareStatement(
                                    "select sum(subtotal),sum(besardis),sum(total) from dapurdetailpesan where no_faktur='"+rspenerimaan.getString("no_faktur")+"' "+
                                    "and kode_brng not in (select kode_brng from detail_surat_pemesanan_dapur where no_pemesanan='"+rs.getString("no_pemesanan")+"')");
                            try {
                            ...
                            htmlContent.append(
                                ...
                                "<tr class='isi'>"+
                                    ...
                                    "<td align='right'>"+Valid.SetAngka(rs.getDouble("total"))+"</td>"+
                                    "<td align='right' colspan='2'></td>"+
