...
public class DapurSuplier extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurSuplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Valid.hapusTable(tabMode,Kd,"dapursuplier","kode_suplier");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"dapursuplier","kode_suplier","?","kode_suplier=?,nama_suplier=?,alamat=?,kota=?,no_telp=?,nama_bank=?,rekening=?",8,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptSuplier.jasper","report","::[ Data Suplier ]::","select dapursuplier.kode_suplier, dapursuplier.nama_suplier, "+
                    " dapursuplier.alamat,dapursuplier.kota, dapursuplier.no_telp,dapursuplier.nama_bank,dapursuplier.rekening from dapursuplier "+
                    " where dapursuplier.kode_suplier like '%"+TCari.getText().trim()+"%' or "+
                    " dapursuplier.nama_suplier like '%"+TCari.getText().trim()+"%' or "+
                    " dapursuplier.alamat like '%"+TCari.getText().trim()+"%' or "+
                    " dapursuplier.kota like '%"+TCari.getText().trim()+"%' or "+
                    " dapursuplier.nama_bank like '%"+TCari.getText().trim()+"%' or "+
                    " dapursuplier.no_telp like '%"+TCari.getText().trim()+"%' order by dapursuplier.kode_suplier",param);            
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("dapursuplier","?,?,?,?,?,?,?","Kode Supplier",7,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurSuplier dialog = new DapurSuplier(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select dapursuplier.kode_suplier, dapursuplier.nama_suplier, "+
                    ...
                    " where dapursuplier.kode_suplier like ? or "+
                    " dapursuplier.nama_suplier like ? or "+
                    " dapursuplier.alamat like ? or "+
                    " dapursuplier.kota like ? or "+
                    " dapursuplier.nama_bank like ? or "+
                    " dapursuplier.no_telp like ? order by dapursuplier.kode_suplier");
            try {
    ...
    public void emptTeks() {
        ...
        Kd.requestFocus();
        Valid.autoNomer("dapursuplier","S",4,Kd);
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getdapur_suplier());
        BtnHapus.setEnabled(akses.getdapur_suplier());
        BtnEdit.setEnabled(akses.getdapur_suplier());
        BtnPrint.setEnabled(akses.getdapur_suplier());
    }
