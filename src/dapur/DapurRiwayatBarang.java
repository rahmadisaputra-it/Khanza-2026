...
public class DapurRiwayatBarang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurRiwayatBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void kdbarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdbarKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select nama_brng from dapurbarang where kode_brng=?",nmbar,kdbar.getText());
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
            Sequel.cariIsi("select nama_brng from dapurbarang where kode_brng=?",nmbar,kdbar.getText());
            TCari.requestFocus();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurRiwayatBarang dialog = new DapurRiwayatBarang(new javax.swing.JFrame(), true);
       ...
       try{   
            if(nmbar.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "dapur_riwayat_barang.status from dapur_riwayat_barang "+
                    "inner join dapurbarang on dapur_riwayat_barang.kode_brng=dapurbarang.kode_brng where "+
                    "dapur_riwayat_barang.tanggal between ? and ? and dapurbarang.nama_brng like ? and "+
                    "(dapur_riwayat_barang.kode_brng like ? or dapurbarang.nama_brng like ? or "+
                    "dapur_riwayat_barang.petugas like ? or dapur_riwayat_barang.status like ?) "+
                    "order by dapur_riwayat_barang.tanggal,dapur_riwayat_barang.jam ");
            }
