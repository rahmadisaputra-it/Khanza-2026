...
public class DapurRingkasanReturBeliBarang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurRingkasanReturBeliBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        label17.setBounds(315, 10, 70, 23);
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(!NoFaktur.getText().equals("")){
                carifaktur=" and dapurreturbeli.no_retur_beli like '%"+NoFaktur.getText()+"%' ";
            }
            if(!nmsup.getText().equals("")){
                carisuplier=" and dapursuplier.nama_suplier like '%"+nmsup.getText()+"%' ";
            }
            if(!nmptg.getText().equals("")){
                caripetugas=" and petugas.nama like '%"+nmptg.getText()+"%' ";
            }
            if(!Jenis.getSelectedItem().toString().equals("Semua")){
                carijenis=" and dapurbarang.jenis like '%"+Jenis.getSelectedItem().toString()+"%' ";
            }
            if(!nmbar.getText().equals("")){
                caribarang= " and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' ";
            }
            Valid.MyReportqry("rptRingkasanReturSuplierDapur.jasper","report","::[ Laporan Ringkasan Retur Ke Suplier Barang Dapur ]::",
                    ...
                    " group by dapur_detail_returbeli.kode_brng "+order,param); 
    ...
    private void MnTotalAscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTotalAscActionPerformed
        order="order by sum(dapur_detail_returbeli.total) asc";
        runBackground(() ->tampil());
    ...
    private void MnTotalDescActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTotalDescActionPerformed
        order="order by sum(dapur_detail_returbeli.total) desc";
        runBackground(() ->tampil());
    ...
    private void MnJumlahAscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJumlahAscActionPerformed
        order="order by sum(dapur_detail_returbeli.jml_retur) asc";
        runBackground(() ->tampil());
    ...
    private void MnJumlahDescActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJumlahDescActionPerformed
        order="order by sum(dapur_detail_returbeli.jml_retur) desc";
        runBackground(() ->tampil());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurRingkasanReturBeliBarang dialog = new DapurRingkasanReturBeliBarang(new javax.swing.JFrame(), true);
       ...
       Valid.tabelKosong(tabMode);
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    " dapurreturbeli.nip like '%"+TCari.getText()+"%' or petugas.nama like '%"+TCari.getText()+"%' or dapur_detail_returbeli.kode_brng like '%"+TCari.getText()+"%' or "+
                    " dapurbarang.nama_brng like '%"+TCari.getText()+"%' or dapur_detail_returbeli.kode_sat like '%"+TCari.getText()+"%' or dapurbarang.jenis like '%"+TCari.getText()+"%') ")+
                    " group by dapur_detail_returbeli.kode_brng "+order);
            try {
                rs=ps.executeQuery();
                while(rs.next()){
    ...
    public void isCek(){
        BtnPrint.setEnabled(akses.getringkasan_returbeli_dapur());
    }
