...
public class DapurRingkasanPengajuanBarang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurRingkasanPengajuanBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptRingkasanPengajuanDapur.jasper","report","::[ Laporan Ringkasan Pengajuan Barang Dapur ]::",
                    ...
                    "from pengajuan_barang_dapur inner join pegawai on pengajuan_barang_dapur.nip=pegawai.nik "+
                    "inner join detail_pengajuan_barang_dapur on pengajuan_barang_dapur.no_pengajuan=detail_pengajuan_barang_dapur.no_pengajuan "+
                    "inner join dapurbarang on detail_pengajuan_barang_dapur.kode_brng=dapurbarang.kode_brng "+
                    "inner join kodesatuan on dapurbarang.kode_sat=kodesatuan.kode_sat where pengajuan_barang_dapur.tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' and pengajuan_barang_dapur.no_pengajuan like '%"+NoPermintaan.getText()+"%' and pengajuan_barang_dapur.status like '%"+Status.getSelectedItem().toString().replaceAll("Semua","")+"%' and pegawai.nama like '%"+NmPeg.getText()+"%'  and dapurbarang.jenis like '%"+Jenis.getSelectedItem().toString().replaceAll("Semua","")+"%' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and pengajuan_barang_dapur.no_pengajuan like '%"+TCari.getText()+"%' or "+
                    " pengajuan_barang_dapur.tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' and pengajuan_barang_dapur.no_pengajuan like '%"+NoPermintaan.getText()+"%' and pengajuan_barang_dapur.status like '%"+Status.getSelectedItem().toString().replaceAll("Semua","")+"%' and pegawai.nama like '%"+NmPeg.getText()+"%'  and dapurbarang.jenis like '%"+Jenis.getSelectedItem().toString().replaceAll("Semua","")+"%' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and pengajuan_barang_dapur.nip like '%"+TCari.getText()+"%' or "+
                    ...
                    " pengajuan_barang_dapur.tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' and pengajuan_barang_dapur.no_pengajuan like '%"+NoPermintaan.getText()+"%' and pengajuan_barang_dapur.status like '%"+Status.getSelectedItem().toString().replaceAll("Semua","")+"%' and pegawai.nama like '%"+NmPeg.getText()+"%'  and dapurbarang.jenis like '%"+Jenis.getSelectedItem().toString().replaceAll("Semua","")+"%' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and detail_pengajuan_barang_dapur.kode_brng like '%"+TCari.getText()+"%' or "+
                    ...
                    " group by detail_pengajuan_barang_dapur.kode_brng "+order,param); 
    ...
    private void MnTotalAscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTotalAscActionPerformed
        order="order by sum(detail_pengajuan_barang_dapur.total) asc";
        runBackground(() ->tampil());
    ...
    private void MnTotalDescActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTotalDescActionPerformed
        order="order by sum(detail_pengajuan_barang_dapur.total) desc";
        runBackground(() ->tampil());
    ...
    private void MnJumlahAscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJumlahAscActionPerformed
        order="order by sum(detail_pengajuan_barang_dapur.jumlah) asc";
        runBackground(() ->tampil());
    ...
    private void MnJumlahDescActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJumlahDescActionPerformed
        order="order by sum(detail_pengajuan_barang_dapur.jumlah) desc";
        runBackground(() ->tampil());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurRingkasanPengajuanBarang dialog = new DapurRingkasanPengajuanBarang(new javax.swing.JFrame(), true);
       ...
       Valid.tabelKosong(tabMode);
        try{  
            ps=koneksi.prepareStatement(
                    ...
                    "pengajuan_barang_dapur.tanggal between ? and ? and pengajuan_barang_dapur.no_pengajuan like ? and pengajuan_barang_dapur.status like ? and pegawai.nama like ?  and dapurbarang.jenis like ? and dapurbarang.nama_brng like ? "+
                    (TCari.getText().trim().equals("")?"":"and (pengajuan_barang_dapur.no_pengajuan like ? or pengajuan_barang_dapur.nip like ? or pegawai.nama like ? or "+
                    "dapurbarang.jenis like ? or detail_pengajuan_barang_dapur.kode_brng like ? or dapurbarang.nama_brng like ? or detail_pengajuan_barang_dapur.kode_sat like ? or "+
                    "kodesatuan.satuan like ?) ")+"group by detail_pengajuan_barang_dapur.kode_brng "+order);
            try {
