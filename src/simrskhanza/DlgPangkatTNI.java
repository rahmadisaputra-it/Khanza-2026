 ...
 * @author dosen
 */
public class DlgPangkatTNI extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgpangkat_tni
     * @param parent
     * @param modal */
    public DlgPangkatTNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.menyimpan("pangkat_tni","'0','"+Nama.getText()+"'","Pangkat TNI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPangkatTNI dialog = new DlgPangkatTNI(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpangkat_tni());
        BtnHapus.setEnabled(akses.getpangkat_tni());
    }
