 ...
 * @author dosen
 */
public class DlgJabatanTNI extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgjabatan_tni
     * @param parent
     * @param modal */
    public DlgJabatanTNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Jabatan TNI"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Jabatan TNI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.menyimpan("jabatan_tni","'0','"+Nama.getText()+"'","Jabatan TNI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJabatanTNI dialog = new DlgJabatanTNI(new javax.swing.JFrame(), true);
