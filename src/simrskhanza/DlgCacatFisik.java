 ...
 * @author dosen
 */
public class DlgCacatFisik extends javax.swing.JDialog {
    ...
    public DlgCacatFisik(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Cacat Fisik"}){
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cacat Fisik :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(0, 12, 80, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Cacat Fisik");
        }else{
            Sequel.menyimpan("cacat_fisik","'0','"+Nama.getText()+"'","Cacat Fisik");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            if(tbkecamatan.getSelectedRow()!= -1){
                if(Sequel.meghapustf("cacat_fisik","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCacatFisik dialog = new DlgCacatFisik(new javax.swing.JFrame(), true);
