 ...
 * @author dosen
 */
public class DlgPangkatPolri extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgpangkat_polri
     * @param parent
     * @param modal */
    public DlgPangkatPolri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Pangkat POLRI"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };

        tbkecamatan.setModel(tabMode);
        //runBackground(() ->tampil());
        //tbPangkat.setDefaultRenderer(Object.class, new WarnaTable(Scroll.getBackground(),Color.GREEN));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Pangkat POLRI");
        }else{
            Sequel.menyimpan("pangkat_polri","'0','"+Nama.getText()+"'","Pangkat POLRI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            if(tbkecamatan.getSelectedRow()!= -1){
                if(Sequel.meghapustf("pangkat_polri","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPangkatPolri dialog = new DlgPangkatPolri(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from pangkat_polri where nama_pangkat like ? ");
            try {
