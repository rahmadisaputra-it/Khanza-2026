 ...
 * @author dosen
 */
public class DlgSatuanTNI extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgsatuan_tni
     * @param parent
     * @param modal */
    public DlgSatuanTNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Satuan TNI"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Satuan TNI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Satuan TNI");
        }else{
            Sequel.menyimpan("satuan_tni","'0','"+Nama.getText()+"'","Satuan TNI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.meghapus("satuan_tni","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString());  
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSatuanTNI dialog = new DlgSatuanTNI(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from satuan_tni where nama_satuan like ? ");
            try {
