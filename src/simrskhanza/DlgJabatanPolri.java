 ...
 * @author dosen
 */
public class DlgJabatanPolri extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgjabatan_polri
     * @param parent
     * @param modal */
    public DlgJabatanPolri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Jabatan POLRI"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Jabatan POLRI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Jabatan POLRI");
        }else{
            Sequel.menyimpan("jabatan_polri","'0','"+Nama.getText()+"'","Jabatan POLRI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            if(tbkecamatan.getSelectedRow()!= -1){
                if(Sequel.meghapustf("jabatan_polri","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJabatanPolri dialog = new DlgJabatanPolri(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from jabatan_polri where nama_jabatan like ? ");
            try {
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getjabatan_polri());
        BtnHapus.setEnabled(akses.getjabatan_polri());
    }
