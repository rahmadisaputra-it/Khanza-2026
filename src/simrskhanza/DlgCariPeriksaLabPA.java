...
public class DlgCariPeriksaLabPA extends javax.swing.JDialog {
    ...
    private String diagnosa_klinik, makroskopik, mikroskopik, kesimpulan, kesan,status="";
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        Sequel.menyimpan("temporary_lab","'"+i+"','"+rs2.getString("nm_perawatan").replaceAll("'","")+"','"+rs3.getString("diagnosa_klinik").replaceAll("'","")+"','"+rs3.getString("makroskopik").replaceAll("'","")
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("tgl_periksa"),rs.getString("jam"),Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rs.getString("dokter_perujuk")),
