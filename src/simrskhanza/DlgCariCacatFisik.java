 ...
 * @author dosen
 */
public final class DlgCariCacatFisik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariCacatFisik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariCacatFisik dialog = new DlgCariCacatFisik(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            try{           
                ...
                while(rs.next()){
                    ...
                    iyembuilder.append("{\"ID\":\"").append(rs.getString(1)).append("\",\"Cacat\":\"").append(rs.getString(2)).append("\"},");
                }
            }catch(Exception e){
            ...
            if (iyembuilder.length() > 0) {
                ...
                fileWriter.write("{\"cacatfisik\":["+iyembuilder+"]}");
                fileWriter.flush();
            }
            fileWriter.close();
