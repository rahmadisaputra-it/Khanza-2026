 ...
 * @author dosen
 */
public class DlgGolonganTNI extends javax.swing.JDialog {
    ...
    /** Creates new form Dlggolongan_tni
     * @param parent
     * @param modal */
    public DlgGolonganTNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Golongan TNI");
        }else{
            Sequel.menyimpan("golongan_tni","'0','"+Nama.getText()+"'","Golongan TNI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            if(tbkecamatan.getSelectedRow()!= -1){
                if(Sequel.meghapustf("golongan_tni","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgGolonganTNI dialog = new DlgGolonganTNI(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from golongan_tni where nama_golongan like ? ");
            try {
