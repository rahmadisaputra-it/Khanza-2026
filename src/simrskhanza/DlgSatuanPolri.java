 ...
 * @author dosen
 */
public class DlgSatuanPolri extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgsatuan_polri
     * @param parent
     * @param modal */
    public DlgSatuanPolri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Satuan POLRI"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Satuan POLRI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Satuan POLRI");
        }else{
            Sequel.menyimpan("satuan_polri","'0','"+Nama.getText()+"'","Satuan POLRI");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            Sequel.meghapus("satuan_polri","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString());  
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSatuanPolri dialog = new DlgSatuanPolri(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getsatuan_polri());
        BtnHapus.setEnabled(akses.getsatuan_polri());
    }
