 ...
 * @author dosen
 */
public class GrafikInventarisPerRuang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikInventarisPerRuang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"Nama Ruang","Jumlah","Persentase(%)","Nilai Aset","Nilai Aset(%)"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Jumlah Inventaris Per Ruang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptInventarisPerRuang.jasper","report","::[ Laporan Jumlah Inventaris Per Ruang Inventaris ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikInventarisPerRuang dialog = new GrafikInventarisPerRuang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               "select inventaris_ruang.id_ruang,count(inventaris.id_ruang) as jumlah,inventaris_ruang.nama_ruang,sum(inventaris.harga) as harga "+
               "from inventaris inner join inventaris_ruang on inventaris_ruang.id_ruang=inventaris.id_ruang group by inventaris_ruang.id_ruang");
            try {
                rs=ps.executeQuery();
                total=0;
                totalaset=0;
