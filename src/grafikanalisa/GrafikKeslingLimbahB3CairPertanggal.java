 ...
 * @author dosen
 */
public class GrafikKeslingLimbahB3CairPertanggal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikKeslingLimbahB3CairPertanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-02-2023" }));
        ...
        Tanggal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-02-2023" }));
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d'),sum(kesling_limbah_b3medis_cair.jmllimbah) as jumlah "+
                "from kesling_limbah_b3medis_cair where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+" 23:59:59' group by DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d')").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Tanggal","Jumlah (Kg)", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal",freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas=new grafiksql2("Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d'),sum(kesling_limbah_b3medis_cair.jmllimbah) as jumlah from kesling_limbah_b3medis_cair "+
               "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+" 23:59:59' "+
               "group by DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d')","Tanggal");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal",freeChart);
        cf.setSize(panelBiasa3.getWidth(),panelBiasa3.getHeight());   
        cf.setLocationRelativeTo(panelBiasa3);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingLimbahB3CairPertanggal dialog = new GrafikKeslingLimbahB3CairPertanggal(new javax.swing.JFrame(), true);
