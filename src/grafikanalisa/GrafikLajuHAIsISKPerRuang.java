 ...
 * @author dosen
 */
public class GrafikLajuHAIsISKPerRuang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikLajuHAIsISKPerRuang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Laju HAIs ISK Per Ruang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select bangsal.nm_bangsal,ROUND((count(distinct data_HAIs.no_rawat)/sum(data_HAIs.ISK))*1000,2) from data_HAIs inner join kamar inner join bangsal "+
               "on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where data_HAIs.tanggal "+
               "between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' and data_HAIs.ISK>0 group by bangsal.kd_bangsal").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Grafik Laju HAIs ISK Per Ruang Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Ruang","Jumlah", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Grafik Laju HAIs ISK Per Ruang",freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Laju HAIs ISK Per Ruang Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select bangsal.nm_bangsal,ROUND((count(distinct data_HAIs.no_rawat)/sum(data_HAIs.ISK))*1000,2) from data_HAIs inner join kamar inner join bangsal "+
               "on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where data_HAIs.tanggal "+
               "between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' "+
               "and data_HAIs.ISK>0 group by bangsal.kd_bangsal","Ruang");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Laju HAIs ISK Per Ruang Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Laju HAIs ISK Per Ruang",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptLajuHAIsISKPerRuang.jasper","report","::[ Laporan Laju HAIs ISK Per Ruang ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLajuHAIsISKPerRuang dialog = new GrafikLajuHAIsISKPerRuang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                "select bangsal.nm_bangsal,count(distinct data_HAIs.no_rawat),sum(data_HAIs.ISK),ROUND((count(distinct data_HAIs.no_rawat)/sum(data_HAIs.ISK))*1000,2) "+
                ...
                "and data_HAIs.ISK>0 group by bangsal.kd_bangsal");
            try {
                rs=ps.executeQuery();
                total=0;
                while(rs.next()){
