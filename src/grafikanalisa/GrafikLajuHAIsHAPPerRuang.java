 ...
 * @author dosen
 */
public class GrafikLajuHAIsHAPPerRuang extends javax.swing.JDialog {
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Laju HAIs HAP Per Ruang Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select bangsal.nm_bangsal,ROUND((count(distinct data_HAIs.no_rawat)/sum(data_HAIs.HAP))*1000,2) from data_HAIs inner join kamar inner join bangsal "+
               "on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where data_HAIs.tanggal "+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLajuHAIsHAPPerRuang dialog = new GrafikLajuHAIsHAPPerRuang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                "select bangsal.nm_bangsal,count(distinct data_HAIs.no_rawat),sum(data_HAIs.HAP),ROUND((count(distinct data_HAIs.no_rawat)/sum(data_HAIs.HAP))*1000,2) "+
                ...
                "and data_HAIs.HAP>0 group by bangsal.kd_bangsal");
            try {
                rs=ps.executeQuery();
                total=0;
                while(rs.next()){
