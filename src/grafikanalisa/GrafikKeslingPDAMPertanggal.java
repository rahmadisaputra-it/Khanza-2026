 ...
 * @author dosen
 */
public class GrafikKeslingPDAMPertanggal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikKeslingPDAMPertanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select DATE_FORMAT(kesling_pemakaian_air_pdam.tanggal, '%y-%m-%d'),sum(kesling_pemakaian_air_pdam.jumlahharian) as jumlah "+
                "from kesling_pemakaian_air_pdam where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+" 23:59:59' group by DATE_FORMAT(kesling_pemakaian_air_pdam.tanggal, '%y-%m-%d')").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Grafik Pemakaian Air PDAM Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Tanggal","Jumlah Harian (M³)", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Grafik Pemakaian Air PDAM Per Tanggal",freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas=new grafiksql2("Grafik Pemakaian Air PDAM Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select DATE_FORMAT(kesling_pemakaian_air_pdam.tanggal, '%y-%m-%d'),sum(kesling_pemakaian_air_pdam.jumlahharian) as jumlah from kesling_pemakaian_air_pdam "+
               "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+" 23:59:59' "+
               "group by DATE_FORMAT(kesling_pemakaian_air_pdam.tanggal, '%y-%m-%d')","Tanggal");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Pemakaian Air PDAM Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Pemakaian Air PDAM Per Tanggal",freeChart);
        cf.setSize(panelBiasa3.getWidth(),panelBiasa3.getHeight());   
        cf.setLocationRelativeTo(panelBiasa3);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingPDAMPertanggal dialog = new GrafikKeslingPDAMPertanggal(new javax.swing.JFrame(), true);
