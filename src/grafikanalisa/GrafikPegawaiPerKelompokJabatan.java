 ...
 * @author dosen
 */
public class GrafikPegawaiPerKelompokJabatan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPegawaiPerKelompokJabatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"Kelompok Jabatan Pegawai","Jumlah","Persentase(%)","Laki-Laki","Laki-Laki(%)","Perempuan","Perempuan(%)"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Pegawai Per Kelompok Jabatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select kelompok_jabatan.kode_kelompok,count(pegawai.kode_kelompok) as jumlah,kelompok_jabatan.nama_kelompok from pegawai inner join kelompok_jabatan "+
                           "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by kelompok_jabatan.kode_kelompok").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart("Grafik Pegawai Per Kelompok Jabatan","Kelompok Jabatan","Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf = new ChartFrame("Grafik Pegawai Per Kelompok Jabatan",freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select kelompok_jabatan.kode_kelompok,count(pegawai.kode_kelompok) as jumlah,kelompok_jabatan.nama_kelompok from pegawai inner join kelompok_jabatan "+
                           "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by kelompok_jabatan.kode_kelompok").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart("Grafik Pegawai Per Kelompok Jabatan","Kelompok Jabatan","Jumlah Pegawai", dcd2, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf2 = new ChartFrame("Grafik Pegawai Per Kelompok Jabatan",freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select kelompok_jabatan.kode_kelompok,count(pegawai.kode_kelompok) as jumlah,kelompok_jabatan.nama_kelompok from pegawai inner join kelompok_jabatan "+
                           "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by kelompok_jabatan.kode_kelompok").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart3 = ChartFactory.createBarChart("Grafik Pegawai Per Kelompok Jabatan","Kelompok Jabatan","Jumlah Pegawai", dcd3, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf3 = new ChartFrame("Grafik Pegawai Per Kelompok Jabatan",freeChart3);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    grafiksql2 kas=new grafiksql2("Grafik Pegawai Per Kelompok Jabatan",
                            "select concat(kelompok_jabatan.nama_kelompok,'(',kelompok_jabatan.kode_kelompok,')'),count(pegawai.kode_kelompok) as jumlah from pegawai inner join kelompok_jabatan "+
                            "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by kelompok_jabatan.kode_kelompok","Kelompok Jabatan");
                    ...
                    break;
                case "Jumlah Pegawai Laki-Laki":
                    grafiksql2 kas2=new grafiksql2("Grafik Pegawai Per Kelompok Jabatan",
                            "select concat(kelompok_jabatan.nama_kelompok,'(',kelompok_jabatan.kode_kelompok,')'),count(pegawai.kode_kelompok) as jumlah from pegawai inner join kelompok_jabatan "+
                            "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by kelompok_jabatan.kode_kelompok","Kelompok Jabatan");
                    ...
                    break;
                case "Jumlah Pegawai Perempuan":
                    grafiksql2 kas3=new grafiksql2("Grafik Pegawai Per Kelompok Jabatan",
                            "select concat(kelompok_jabatan.nama_kelompok,'(',kelompok_jabatan.kode_kelompok,')'),count(pegawai.kode_kelompok) as jumlah from pegawai inner join kelompok_jabatan "+
                            "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by kelompok_jabatan.kode_kelompok","Kelompok Jabatan");
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart("Grafik Pegawai Per Kelompok Jabatan",dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf = new ChartFrame("Grafik Pegawai Per Kelompok Jabatan",freeChart);
                    cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf.setLocationRelativeTo(Scroll);
                    cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart("Grafik Pegawai Per Kelompok Jabatan",dpd2,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame("Grafik Pegawai Per Kelompok Jabatan",freeChart2);
                    cf2.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf2.setLocationRelativeTo(Scroll);
                    cf2.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart("Grafik Pegawai Per Kelompok Jabatan",dpd3,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame("Grafik Pegawai Per Kelompok Jabatan",freeChart3);
                    cf3.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf3.setLocationRelativeTo(Scroll);
                    cf3.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPegawaiPerKelompokJabatan.jasper","report","::[ Laporan Jumlah Pegawai Per Kelompok Jabatan ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerKelompokJabatan dialog = new GrafikPegawaiPerKelompokJabatan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               "select kelompok_jabatan.kode_kelompok,count(pegawai.kode_kelompok) as jumlah,kelompok_jabatan.nama_kelompok from pegawai inner join kelompok_jabatan "+
               "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by kelompok_jabatan.kode_kelompok");
            try {
                rs=ps.executeQuery();
                total=0;
                totall=0;
                ...
                while(rs.next()){
                    ...
                    jmll=Sequel.cariInteger("select count(pegawai.kode_kelompok) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_kelompok=?",rs.getString(1));
