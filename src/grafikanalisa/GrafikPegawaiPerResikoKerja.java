 ...
 * @author dosen
 */
public class GrafikPegawaiPerResikoKerja extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPegawaiPerResikoKerja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select resiko_kerja.kode_resiko,count(pegawai.kode_resiko) as jumlah,resiko_kerja.nama_resiko from pegawai inner join resiko_kerja "+
                           "on resiko_kerja.kode_resiko=pegawai.kode_resiko where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by resiko_kerja.kode_resiko").executeQuery();
                        while(rs.next()) {
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select resiko_kerja.kode_resiko,count(pegawai.kode_resiko) as jumlah,resiko_kerja.nama_resiko from pegawai inner join resiko_kerja "+
                           "on resiko_kerja.kode_resiko=pegawai.kode_resiko where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by resiko_kerja.kode_resiko").executeQuery();
                        while(rs.next()) {
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select resiko_kerja.kode_resiko,count(pegawai.kode_resiko) as jumlah,resiko_kerja.nama_resiko from pegawai inner join resiko_kerja "+
                           "on resiko_kerja.kode_resiko=pegawai.kode_resiko where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by resiko_kerja.kode_resiko").executeQuery();
                        while(rs.next()) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerResikoKerja dialog = new GrafikPegawaiPerResikoKerja(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               ...
               "on resiko_kerja.kode_resiko=pegawai.kode_resiko where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by resiko_kerja.kode_resiko");
            try {
                rs=ps.executeQuery();
                total=0;
                totall=0;
                ...
                while(rs.next()){
                    ...
                    jmll=Sequel.cariInteger("select count(pegawai.kode_resiko) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_resiko=?",rs.getString(1));
                    jmlp=Sequel.cariInteger("select count(pegawai.kode_resiko) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_resiko=?",rs.getString(1));
                    totall=totall+jmll;
                    totalp=totalp+jmlp;
