 ...
 * @author dosen
 */
public class GrafikPegawaiPerEmergencyIndex extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPegawaiPerEmergencyIndex(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"Emergency Index Pegawai","Jumlah","Persentase(%)","Laki-Laki","Laki-Laki(%)","Perempuan","Perempuan(%)"}){
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select emergency_index.kode_emergency,count(pegawai.kode_emergency) as jumlah,emergency_index.nama_emergency from pegawai inner join emergency_index "+
                           "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by emergency_index.kode_emergency").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart("Grafik Pegawai Per Emergency Index","Emergency Index","Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf = new ChartFrame("Grafik Pegawai Per Emergency Index",freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select emergency_index.kode_emergency,count(pegawai.kode_emergency) as jumlah,emergency_index.nama_emergency from pegawai inner join emergency_index "+
                           "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by emergency_index.kode_emergency").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart("Grafik Pegawai Per Emergency Index","Emergency Index","Jumlah Pegawai", dcd2, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf2 = new ChartFrame("Grafik Pegawai Per Emergency Index",freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select emergency_index.kode_emergency,count(pegawai.kode_emergency) as jumlah,emergency_index.nama_emergency from pegawai inner join emergency_index "+
                           "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by emergency_index.kode_emergency").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart3 = ChartFactory.createBarChart("Grafik Pegawai Per Emergency Index","Emergency Index","Jumlah Pegawai", dcd3, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf3 = new ChartFrame("Grafik Pegawai Per Emergency Index",freeChart3);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    grafiksql2 kas=new grafiksql2("Grafik Pegawai Per Emergency Index",
                            "select concat(emergency_index.nama_emergency,'(',emergency_index.kode_emergency,')'),count(pegawai.kode_emergency) as jumlah from pegawai inner join emergency_index "+
                            "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by emergency_index.kode_emergency","Emergency Index");
                    ...
                    break;
                case "Jumlah Pegawai Laki-Laki":
                    grafiksql2 kas2=new grafiksql2("Grafik Pegawai Per Emergency Index",
                            "select concat(emergency_index.nama_emergency,'(',emergency_index.kode_emergency,')'),count(pegawai.kode_emergency) as jumlah from pegawai inner join emergency_index "+
                            "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by emergency_index.kode_emergency","Emergency Index");
                    ...
                    break;
                case "Jumlah Pegawai Perempuan":
                    grafiksql2 kas3=new grafiksql2("Grafik Pegawai Per Emergency Index",
                            "select concat(emergency_index.nama_emergency,'(',emergency_index.kode_emergency,')'),count(pegawai.kode_emergency) as jumlah from pegawai inner join emergency_index "+
                            "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by emergency_index.kode_emergency","Emergency Index");
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart("Grafik Pegawai Per Emergency Index",dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf = new ChartFrame("Grafik Pegawai Per Emergency Index",freeChart);
                    cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf.setLocationRelativeTo(Scroll);
                    cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart("Grafik Pegawai Per Emergency Index",dpd2,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame("Grafik Pegawai Per Emergency Index",freeChart2);
                    cf2.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf2.setLocationRelativeTo(Scroll);
                    cf2.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart("Grafik Pegawai Per Emergency Index",dpd3,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame("Grafik Pegawai Per Emergency Index",freeChart3);
                    cf3.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf3.setLocationRelativeTo(Scroll);
                    cf3.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPegawaiPerEmergencyIndex.jasper","report","::[ Laporan Jumlah Pegawai Per Emergency Index ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerEmergencyIndex dialog = new GrafikPegawaiPerEmergencyIndex(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               "select emergency_index.kode_emergency,count(pegawai.kode_emergency) as jumlah,emergency_index.nama_emergency from pegawai inner join emergency_index "+
               "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by emergency_index.kode_emergency");
            try {
                rs=ps.executeQuery();
                total=0;
                totall=0;
