 ...
 * @author dosen
 */
public class GrafikPenerimaanObatPerbulan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPenerimaanObatPerbulan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"Bulan Penerimaan","Nilai Penerimaan Per Bulan","Persentase Penerimaan Per Bulan(%)","Nilai Penerimaan"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Nilai Penerimaan Obat, Alkes & BHP Per Bulan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2020" }));
        ...
        Tanggal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2020" }));
        ...
        jLabel35.setPreferredSize(new java.awt.Dimension(25, 23));
        panelGlass5.add(jLabel35);
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select DATE_FORMAT(pemesanan.tgl_pesan, '%y-%m'),sum(pemesanan.tagihan) as jumlah "+
                "from pemesanan where tgl_pesan between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by DATE_FORMAT(pemesanan.tgl_pesan, '%y-%m')").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Grafik Penerimaan Obat, Alkes & BHP Per Bulan Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Bulan","Nilai Penerimaan", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Grafik Penerimaan Obat, Alkes & BHP Per Bulan",freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Penerimaan Obat, Alkes & BHP Per Bulan Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select DATE_FORMAT(pemesanan.tgl_pesan, '%y-%m'),sum(pemesanan.tagihan) as jumlah from pemesanan "+
               "where tgl_pesan between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' "+
               "group by DATE_FORMAT(pemesanan.tgl_pesan, '%y-%m')","Bulan");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Penerimaan Obat, Alkes & BHP Per Bulan Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Penerimaan Obat, Alkes & BHP Per Bulan",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPenerimaanObatPerBulan.jasper","report","::[ Laporan Penerimaan Obat, Alkes & BHP Per Bulan ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPenerimaanObatPerbulan dialog = new GrafikPenerimaanObatPerbulan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select DATE_FORMAT(pemesanan.tgl_pesan, '%y-%m'),sum(pemesanan.tagihan) as jumlah "+
                "from pemesanan where tgl_pesan between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by DATE_FORMAT(pemesanan.tgl_pesan, '%y-%m')");
            try {
                rs=ps.executeQuery();
                total=0;
                while(rs.next()){
                    total=total+rs.getDouble(2);
                    tabMode.addRow(new Object[]{rs.getString(1),Valid.SetAngka(rs.getDouble(2)),"",rs.getString(2)});
                }
                tabMode.addRow(new Object[]{"Total : ",Valid.SetAngka(total)+"","100 %",total+""});
                for(i=0;i<tbBangsal.getRowCount();i++){ 
                    tbBangsal.setValueAt(Math.round((Double.parseDouble(tbBangsal.getValueAt(i,3).toString())/total)*100)+" %",i,2);
                }
            } catch (Exception e) {
