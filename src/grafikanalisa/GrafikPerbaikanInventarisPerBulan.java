 ...
 * @author dosen
 */
public class GrafikPerbaikanInventarisPerBulan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPerbaikanInventarisPerBulan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"Bulan Perbaikan Inventaris","Jumlah Perbaikan Inventaris Per Bulan","Persentase Perbaikan Inventaris Per Bulan(%)"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Perbaikan Inventaris Per Bulan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m'),count(DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')) as jumlah "+
                "from perbaikan_inventaris where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')").executeQuery();
            while(rs.next()) {
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Perbaikan Inventaris Per Bulan Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m'),count(DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')) as jumlah from perbaikan_inventaris "+
               "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' "+
               "group by DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')","Bulan");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Perbaikan Inventaris Per Bulan Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Perbaikan Inventaris Per Bulan",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPerbaikanInventarisPerBulan.jasper","report","::[ Laporan Jumlah Perbaikan Inventaris Per Bulan ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerBulan dialog = new GrafikPerbaikanInventarisPerBulan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m'),count(DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')) as jumlah from perbaikan_inventaris "+
               "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' "+
               "group by DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')");
            try {
                rs=ps.executeQuery();
                total=0;
                while(rs.next()){
