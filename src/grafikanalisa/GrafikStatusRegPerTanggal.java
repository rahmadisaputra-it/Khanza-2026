 ...
 * @author dosen
 */
public class GrafikStatusRegPerTanggal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikStatusRegPerTanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Registrasi Pasien Lama Per Tanggal Tanggal "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerTanggal dialog = new GrafikStatusRegPerTanggal(new javax.swing.JFrame(), true);
