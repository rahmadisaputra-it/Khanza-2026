 ...
 * @author dosen
 */
public class GrafikHemodialisaPerTanggal extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikHemodialisaPerTanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{"Tanggal","Jumlah Hemodialisa Per Tanggal","Persentase Per Tanggal(%)"}){
    ...
    private void initComponents() {
        ...
        Tanggal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2020" }));
        ...
        Tanggal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2020" }));
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')) as jumlah "+
                "from hemodialisa where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Grafik Hemodialisa Per Tanggal Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Tanggal","Jumlah", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Grafik Hemodialisa Per Tanggal",freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Hemodialisa Per Tanggal Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')) as jumlah from hemodialisa "+
               "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' "+
               "group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')","Tanggal");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Hemodialisa Per Tanggal Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Hemodialisa Per Tanggal",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPeristiwaK3PerTanggal.jasper","report","::[ Laporan Jumlah Hemodialisa Per Tanggal ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikHemodialisaPerTanggal dialog = new GrafikHemodialisaPerTanggal(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')) as jumlah "+
                "from hemodialisa where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')");
            try {
                rs=ps.executeQuery();
                total=0;
                while(rs.next()){
