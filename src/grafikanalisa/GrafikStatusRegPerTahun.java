 ...
 * @author dosen
 */
public class GrafikStatusRegPerTahun extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikStatusRegPerTahun(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select year(reg_periksa.tgl_registrasi),count(year(reg_periksa.tgl_registrasi)) as jumlah "+
                "from reg_periksa where reg_periksa.stts_daftar='Lama' and tgl_registrasi between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by year(reg_periksa.tgl_registrasi)").executeQuery();
            while(rs.next()) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerTahun dialog = new GrafikStatusRegPerTahun(new javax.swing.JFrame(), true);
