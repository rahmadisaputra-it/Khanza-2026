 ...
 * @author dosen
 */
public class GrafikInventarisPerProdusen extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikInventarisPerProdusen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{
                "Nama Produsen","Jumlah","Persentase(%)","Nilai Aset","Nilai Aset(%)"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Jumlah Inventaris Per Produsen ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select inventaris_produsen.kode_produsen,count(inventaris_produsen.kode_produsen) as jumlah,inventaris_produsen.nama_produsen from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "+
                             "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_produsen.kode_produsen").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart("Grafik Jumlah Inventaris Per Produsen","Produsen Inventaris","Jumlah Inventaris", dcd, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf = new ChartFrame("Grafik Jumlah Inventaris Per Produsen",freeChart);
                ...
                case "Nilai Inventaris":
                    ...
                    try {                
                        rs = koneksi.prepareStatement("select inventaris_produsen.kode_produsen,sum(inventaris.harga) as harga,inventaris_produsen.nama_produsen from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "+
                                "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_produsen.kode_produsen").executeQuery();
                        while(rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart("Grafik Jumlah Inventaris Per Produsen","Produsen Inventaris","Jumlah Inventaris", dcd2, PlotOrientation.VERTICAL,true, true,true); 
                    ChartFrame cf2 = new ChartFrame("Grafik Jumlah Inventaris Per Produsen",freeChart2);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       try {
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    grafiksql2 kas=new grafiksql2("Grafik Jumlah Inventaris Per Produsen",
                            "select concat(inventaris_produsen.nama_produsen,'(',inventaris_produsen.kode_produsen,')'),count(inventaris_produsen.kode_produsen) as jumlah from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "+
                            "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_produsen.kode_produsen","Produsen Inventaris");
                    ...
                    break;
                case "Nilai Inventaris":
                    grafiksql2 kas2=new grafiksql2("Grafik Jumlah Inventaris Per Produsen",
                            "select concat(inventaris_produsen.nama_produsen,'(',inventaris_produsen.kode_produsen,')'),sum(inventaris.harga) as harga from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "+
                            "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_produsen.kode_produsen","Produsen Inventaris");
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart("Grafik Jumlah Inventaris Per Produsen",dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf = new ChartFrame("Grafik Jumlah Inventaris Per Produsen",freeChart);
                    cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf.setLocationRelativeTo(Scroll);
                    cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
                ...
                case "Nilai Inventaris":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart("Grafik Jumlah Inventaris Per Produsen",dpd2,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame("Grafik Jumlah Inventaris Per Produsen",freeChart2);
                    cf2.setSize(Scroll.getWidth(),Scroll.getHeight());   
                    cf2.setLocationRelativeTo(Scroll);
                    cf2.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptInventarisPerProdusen.jasper","report","::[ Laporan Jumlah Inventaris Per Produsen Inventaris ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikInventarisPerProdusen dialog = new GrafikInventarisPerProdusen(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               "select inventaris_produsen.kode_produsen,count(inventaris_barang.kode_produsen) as jumlah,inventaris_produsen.nama_produsen,sum(inventaris.harga) as harga "+
               "from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "+
               "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_produsen.kode_produsen");
            try {
                rs=ps.executeQuery();
                total=0;
                totalaset=0;
