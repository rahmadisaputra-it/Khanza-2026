 ...
 * @author dosen
 */
public class GrafikItemApotekPerGolongan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikItemApotekPerGolongan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"Golongan Item Apotek","Jumlah Golongan Item Apotek","Persentase Golongan Item Apotek(%)"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Item Apotek Per Golongan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select golongan_barang.kode,count(golongan_barang.kode) as jumlah,golongan_barang.nama from databarang inner join golongan_barang "+
               "on golongan_barang.kode=databarang.kode_golongan where databarang.status='1' group by golongan_barang.kode").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Grafik Item Apotek Per Golongan","Golongan","Jumlah Item Apotek", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Golongan",freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Grafik Item Apotek Per Golongan",
               "select concat(golongan_barang.nama,'(',golongan_barang.kode,')'),count(golongan_barang.kode) as jumlah from databarang inner join golongan_barang "+
               "on golongan_barang.kode=databarang.kode_golongan where databarang.status='1' group by golongan_barang.kode","Golongan");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Grafik Item Apotek Per Golongan",dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Golongan",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptItemApotekPerGolongan.jasper","report","::[ Laporan Jumlah Item Apotek Per Golongan ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikItemApotekPerGolongan dialog = new GrafikItemApotekPerGolongan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               "select golongan_barang.kode,count(golongan_barang.kode) as jumlah,golongan_barang.nama from databarang inner join golongan_barang "+
               "on golongan_barang.kode=databarang.kode_golongan where databarang.status='1' group by golongan_barang.kode");
            try {
                rs=ps.executeQuery();
                total=0;
                while(rs.next()){
                    total=total+rs.getDouble(2);
                    tabMode.addRow(new Object[]{rs.getString(3)+" ("+rs.getString(1)+")",rs.getString(2)});
                }
                if(tabMode.getRowCount()>0){
