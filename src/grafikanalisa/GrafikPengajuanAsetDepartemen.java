 ...
 * @author dosen
 */
public class GrafikPengajuanAsetDepartemen extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPengajuanAsetDepartemen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{"Departemen","Jumlah Pengajuan","Persentase Jumlah(%)","Nilai Pengajuan","Persentase Nilai(%)"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Pengajuan Aset/Inventaris Per Departemen ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-08-2019" }));
        ...
        Tanggal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-08-2019" }));
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Pengajuan Aset/Inventaris Per Departemen Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Departemen","Jumlah", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Pengajuan Aset/Inventaris Per Departemen",freeChart);
        ...
        JFreeChart freeChart2 = ChartFactory.createBarChart("Pengajuan Aset/Inventaris Per Departemen Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Departemen","Jumlah", dcd2, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf2 = new ChartFrame("Pengajuan Aset/Inventaris Per Departemen",freeChart2);
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Pengajuan Aset/Inventaris Per Departemen Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Pengajuan Aset/Inventaris Per Departemen",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
        ...
        JFreeChart freeChart2 = ChartFactory.createPieChart("Pengajuan Aset/Inventaris Per Departemen Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd2,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf2 = new ChartFrame("Pengajuan Aset/Inventaris Per Departemen",freeChart2);
        cf2.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf2.setLocationRelativeTo(Scroll);
        cf2.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPengajuanAsetDepartemen.jasper","report","::[ Laporan Pengajuan Aset/Inventaris Per Departemen ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPengajuanAsetDepartemen dialog = new GrafikPengajuanAsetDepartemen(new javax.swing.JFrame(), true);
        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{rs.getString("nama"),rs.getString("jumlah"),"0",rs.getDouble("total"),"0"});
                }
                if(tabMode.getRowCount()>0){
