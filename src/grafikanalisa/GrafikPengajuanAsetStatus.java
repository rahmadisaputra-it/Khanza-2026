 ...
 * @author dosen
 */
public class GrafikPengajuanAsetStatus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public GrafikPengajuanAsetStatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Grafik Pengajuan Aset/Inventaris Per Status ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {                
            rs = koneksi.prepareStatement("select status,count(status) as jumlah from pengajuan_inventaris where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by status").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart("Pengajuan Aset/Inventaris Per Status Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Status","Jumlah", dcd, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf = new ChartFrame("Pengajuan Aset/Inventaris Per Status",freeChart);
        ...
        try {                
            rs = koneksi.prepareStatement("select status,sum(total) from pengajuan_inventaris where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by status").executeQuery();
            while(rs.next()) {
        ...
        JFreeChart freeChart2 = ChartFactory.createBarChart("Pengajuan Aset/Inventaris Per Status Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),"Status","Jumlah", dcd2, PlotOrientation.VERTICAL,true, true,true); 
        ChartFrame cf2 = new ChartFrame("Pengajuan Aset/Inventaris Per Status",freeChart2);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
       grafiksql2 kas=new grafiksql2("Pengajuan Aset/Inventaris Per Status Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select status,count(status) as jumlah from pengajuan_inventaris "+
       ...
       grafiksql2 kas2=new grafiksql2("Pengajuan Aset/Inventaris Per Status Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),
               "select status,sum(total) as total from pengajuan_inventaris "+
               "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' "+
               "group by status","Status");
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart("Pengajuan Aset/Inventaris Per Status Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Pengajuan Aset/Inventaris Per Status",freeChart);
        cf.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
        ...
        JFreeChart freeChart2 = ChartFactory.createPieChart("Pengajuan Aset/Inventaris Per Status Periode "+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+" s.d. "+Valid.SetTgl(Tanggal2.getSelectedItem()+""),dpd2,true,true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf2 = new ChartFrame("Pengajuan Aset/Inventaris Per Status",freeChart2);
        cf2.setSize(Scroll.getWidth(),Scroll.getHeight());   
        cf2.setLocationRelativeTo(Scroll);
        cf2.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPengajuanAsetStatus.jasper","report","::[ Laporan Pengajuan Aset/Inventaris Per Status ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPengajuanAsetStatus dialog = new GrafikPengajuanAsetStatus(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                "select status,count(status) as jumlah,sum(total) as total from pengajuan_inventaris "+
                "where tanggal between '"+Valid.SetTgl(Tanggal1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tanggal2.getSelectedItem()+"")+"' group by status");
            try {
                rs=ps.executeQuery();
                total=0;
                jumlah=0;
