 ...
 * @author dosen
 */
public final class DlgRestorePetugas extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRestorePetugas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        Object[] row = {
            "P", "NIP","Nama Petugas","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Stts.Nikah","Alamat","Jabatan","No.Telp"
        };
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("petugas","nip='"+tbObat.getValueAt(i,1).toString()+"'","status='1'");
            }
        }        
        BtnCariActionPerformed(evt);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("petugas","nip",tbObat.getValueAt(i,1).toString());
            }
        }        
        BtnCariActionPerformed(evt);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestorePetugas dialog = new DlgRestorePetugas(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select petugas.nip,petugas.nama,petugas.jk,petugas.tmp_lahir,petugas.tgl_lahir, "+
                    ...
                    "where petugas.status='0' and petugas.nip like ? or "+
                    " petugas.status='0' and petugas.nama like ? or "+
                    " petugas.status='0' and petugas.jk like ? or "+
                    " petugas.status='0' and petugas.tmp_lahir like ? or "+
                    " petugas.status='0' and petugas.tgl_lahir like ? or "+
                    " petugas.status='0' and petugas.gol_darah like ? or "+
                    " petugas.status='0' and petugas.agama like ? or "+
                    " petugas.status='0' and petugas.alamat like ? or "+
                    " petugas.status='0' and petugas.no_telp like ? or "+
                    " petugas.status='0' and jabatan.nm_jbtn like ? order by petugas.nip");
            try {
