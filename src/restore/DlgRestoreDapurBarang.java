 ...
 * @author dosen
 */
public final class DlgRestoreDapurBarang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRestoreDapurBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("dapurbarang","kode_brng='"+tbObat.getValueAt(i,1).toString()+"'","status='1'");
            }
        }        
        BtnCariActionPerformed(evt);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("dapurbarang","kode_brng",tbObat.getValueAt(i,1).toString());
            }
        }        
        BtnCariActionPerformed(evt);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestoreDapurBarang dialog = new DlgRestoreDapurBarang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                        ...
                        "where dapurbarang.status='0' and (dapurbarang.kode_brng like ? or dapurbarang.nama_brng like ? "+
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        false, rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("satuan"),rs.getString("jenis"),rs.getDouble("stok"),rs.getDouble("harga")
                    });
                }
