 ...
 * @author dosen
 */
public final class DlgRestoreIPSRSBarang extends javax.swing.JDialog {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestoreIPSRSBarang dialog = new DlgRestoreIPSRSBarang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                        ...
                        "where ipsrsbarang.status='0' and ipsrsbarang.kode_brng like ? "+
                        "or ipsrsbarang.status='0' and ipsrsbarang.nama_brng like ? "+
                        "or ipsrsbarang.status='0' and kodesatuan.satuan like ? "+
                        "or ipsrsbarang.status='0' and ipsrsjenisbarang.nm_jenis like ? order by ipsrsbarang.kode_brng");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        false, rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("satuan"),rs.getString("nm_jenis"),rs.getDouble("stok"),rs.getDouble("harga")
                    });
                }
