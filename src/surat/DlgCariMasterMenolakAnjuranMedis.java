...
public final class DlgCariMasterMenolakAnjuranMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariMasterMenolakAnjuranMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);
        tabMode=new DefaultTableModel(null,new String[]{"Kode","Penolakan Anjuran"}){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariMasterMenolakAnjuranMedis dialog = new DlgCariMasterMenolakAnjuranMedis(new javax.swing.JFrame(), true);
