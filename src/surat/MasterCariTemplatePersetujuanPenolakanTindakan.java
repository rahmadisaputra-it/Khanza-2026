...
public final class MasterCariTemplatePersetujuanPenolakanTindakan extends javax.swing.JDialog {
    ...
    private MasterTemplatePersetujuanPenolakanTindakan formtemplate;
    /** Creates new form DlgPenyakit
     * @param parent
     * @param modal */
    public MasterCariTemplatePersetujuanPenolakanTindakan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        if (formtemplate == null || !formtemplate.isDisplayable()) {
            formtemplate=new MasterTemplatePersetujuanPenolakanTindakan(null,false);
            formtemplate.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
            formtemplate.addWindowListener(new WindowAdapter() {
                @Override
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterCariTemplatePersetujuanPenolakanTindakan dialog = new MasterCariTemplatePersetujuanPenolakanTindakan(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),Valid.SetAngka2(rs.getDouble(12))
                    });
                }
            } catch (Exception e) {
