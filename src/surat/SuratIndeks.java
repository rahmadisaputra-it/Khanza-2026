 ...
 * @author dosen
 */
public final class SuratIndeks extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratIndeks(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(545,599);

        Object[] row={"P","Kode","Indeks"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Indeks Surat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"indeks");
        }else{
            if(Sequel.menyimpantf("surat_indeks","?,?","Kode",2,new String[]{TKd.getText(),TNm.getText()})==true){
                runBackground(() ->tampil());
                emptTeks();
            }else{
                TKd.requestFocus();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbBangsal.getRowCount();i++){ 
            if(tbBangsal.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("surat_indeks","kd",tbBangsal.getValueAt(i,1).toString());
            }
        } 
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbBangsal.getSelectedRow()>-1){
                Sequel.mengedit("surat_indeks","kd=?","indeks=?,kd=?",3,new String[]{TNm.getText(),TKd.getText(),tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).toString()});
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptSuratIndeks.jasper",param,"::[ Laporan Indek Surat ]::");
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratIndeks dialog = new SuratIndeks(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(" surat_indeks ","SI",3,TKd);
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getsurat_indeks());
        BtnHapus.setEnabled(akses.getsurat_indeks());
        BtnEdit.setEnabled(akses.getsurat_indeks());
        BtnPrint.setEnabled(akses.getsurat_indeks());
    }
