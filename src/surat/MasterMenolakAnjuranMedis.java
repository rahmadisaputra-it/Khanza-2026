 ...
 * @author dosen
 */
public class MasterMenolakAnjuranMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterMenolakAnjuranMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Penolakan Anjuran"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Menolak Anjuran Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Penolakan Anjuran :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("master_menolak_anjuran_medis","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMenolakAnjuranMedis dialog = new MasterMenolakAnjuranMedis(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getmaster_menolak_anjuran_medis());
       BtnHapus.setEnabled(akses.getmaster_menolak_anjuran_medis());
       BtnEdit.setEnabled(akses.getmaster_menolak_anjuran_medis());
    }
