 ...
 * @author dosen
 */
public final class SuratKlasifikasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratKlasifikasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(545,599);

        Object[] row={"P","Kode","Klasifikasi"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Klasifikasi Surat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKlasifikasi dialog = new SuratKlasifikasi(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(" surat_klasifikasi ","SK",3,TKd);
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getsurat_klasifikasi());
        BtnHapus.setEnabled(akses.getsurat_klasifikasi());
