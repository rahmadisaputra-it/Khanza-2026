 ...
 * @author dosen
 */
public class PerpustakaanJenis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PerpustakaanJenis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode Jenis","Nama Jenis"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Jenis Koleksi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("perpustakaan_jenis_buku","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Jenis");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"perpustakaan_jenis_buku","id_jenis");
        runBackground(() ->tampil());
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("perpustakaan_jenis_buku","id_jenis=?","id_jenis=?,nama_jenis=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanJenis dialog = new PerpustakaanJenis(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from perpustakaan_jenis_buku "+(TCari.getText().trim().equals("")?"":"where perpustakaan_jenis_buku.id_jenis like ? or perpustakaan_jenis_buku.nama_jenis like ? ")+"order by perpustakaan_jenis_buku.id_jenis");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"JK",3,TKd);
        TKd.requestFocus();
    }
    ...
    public void isCek(){
       BtnSimpan.setEnabled(akses.getjenis_perpustakaan());
       BtnHapus.setEnabled(akses.getjenis_perpustakaan());
       BtnEdit.setEnabled(akses.getjenis_perpustakaan());
    }
