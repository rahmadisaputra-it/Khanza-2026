 ...
 * @author dosen
 */
public class PerpustakaanRuang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PerpustakaanRuang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode Ruang","Nama Ruang"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"Kode Ruang");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Nama Ruang");
        }else{
            Sequel.menyimpan("perpustakaan_ruang","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode Ruang");
            runBackground(() ->tampil());
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"perpustakaan_ruang","kd_ruang");
        runBackground(() ->tampil());
        emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanRuang dialog = new PerpustakaanRuang(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"RP",3,TKd);
        TKd.requestFocus();
    }
