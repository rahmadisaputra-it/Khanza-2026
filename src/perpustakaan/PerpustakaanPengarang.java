 ...
 * @author dosen
 */
public class PerpustakaanPengarang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PerpustakaanPengarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pengarang/Penulis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanPengarang dialog = new PerpustakaanPengarang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from perpustakaan_pengarang "+(TCari.getText().trim().equals("")?"":"where perpustakaan_pengarang.kode_pengarang like ? or perpustakaan_pengarang.nama_pengarang like ? ")+"order by perpustakaan_pengarang.kode_pengarang");
            try {
