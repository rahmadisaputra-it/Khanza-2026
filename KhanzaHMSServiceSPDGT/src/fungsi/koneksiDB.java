...
public class koneksiDB {
    ...
    public static String PASSSPDGT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("PASSSPDGT"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String USERSPDGT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("USERSPDGT"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String URLAPISPDGT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLAPISPDGT");
        }catch(Exception e){
            var=""; 
        }
        return var;
