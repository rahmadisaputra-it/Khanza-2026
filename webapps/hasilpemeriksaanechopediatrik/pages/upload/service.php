<?php
                        ...
                        if (empty($namafileTanpaExt)) {
                            ...
                            if ($fileData === false) {
                                ...
                                if ($hex !== 'ffd8ff') {
                                    ...
                                    try {
                                        if(Tambah3(" hasil_pemeriksaan_echo_pediatrik_gambar "," '$norawat','pages/upload/$namafileFinal' ")){
    ...
    function tampil(){
        echo json_encode(array(
            'metadata' => array(
                'message' => 'Selamat Datang di Service Upload Gambar Hasil Echo Pediatrik',
                'code'    => 200
            )
        ));
    }
