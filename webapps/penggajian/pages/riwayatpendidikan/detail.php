<?php
    if(strpos($_SERVER['REQUEST_URI'],"pages")){
        if(!strpos($_SERVER['REQUEST_URI'],"pages/riwayatpendidikan/berkas/")){
...
<div id="entry">        
    <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
        <?php
            ...
            $sekolah            = validTeks(isset($_GET['sekolah'])?$_GET['sekolah']:NULL);
        ...
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="tbl_form">
            ...
            <tr class="isi2">
                ...
                <td width="31%">
                    <input name="keterangan" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi7'));" type=text id="TxtIsi7" class="inputbox" value="<?php echo isset($keterangan)?$keterangan:NULL;?>" size="40" maxlength="50">
            ...
            <tr class="isi2">
                ...
                <td width="31%">
                    <input name="sekolah" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi2'));" type=text id="TxtIsi2" class="inputbox" value="<?php echo isset($sekolah)?$sekolah:NULL;?>" size="40" maxlength="50">
                    <span id="MsgIsi2" style="color:#CC0000; font-size:10px;"></span>
                </td>
                <td width="17%" >Status Pendidikan</td><td width="">:</td>
                <td width="31%">
                    <input name="status" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi8'));" type=text id="TxtIsi8" class="inputbox" value="<?php echo isset($status)?$status:NULL;?>" size="40" maxlength="40">
            ...
            <tr class="isi2">
                ...
                <td width="31%">
                    <input name="jurusan" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi3'));" type=text id="TxtIsi3" class="inputbox" value="<?php echo isset($jurusan)?$jurusan:NULL;?>" size="40" maxlength="40">
        ...
        <?php
                                ...
                                if(($_FILES['dokumen']['type'] == 'image/jpeg')||($_FILES['dokumen']['type'] == 'image/jpg')){
                                    if((@mime_content_type($_FILES['dokumen']['tmp_name'])== 'image/jpeg')||(@mime_content_type($_FILES['dokumen']['tmp_name'])== 'image/jpg')){
                                        try {
                                            ...
                                            if($e->getCode()==1062){
                                                echo "<b style='color:red'>Data riwayat pendidikan sudah ada..!!!</b>";
                                            }else{
            ...
            $_sql   = "SELECT riwayat_pendidikan.pendidikan,riwayat_pendidikan.sekolah,riwayat_pendidikan.jurusan,riwayat_pendidikan.thn_lulus,riwayat_pendidikan.kepala,riwayat_pendidikan.pendanaan,riwayat_pendidikan.keterangan,riwayat_pendidikan.status,riwayat_pendidikan.berkas from riwayat_pendidikan where riwayat_pendidikan.id='$id' ORDER BY riwayat_pendidikan.thn_lulus ASC ";
            $hasil  = bukaquery($_sql);
            ...
            if(mysqli_num_rows($hasil)!=0) {
                ...
                while($baris = mysqli_fetch_array($hasil)) {   
                    ...
                    echo "<tr class='isi'>
                            <td width='70'>
                                <center>
                                   <a href=?act=InputRiwayatPendidikan&action=HAPUS&pendidikan=".$baris[0]."&sekolah=".$baris[1]."&id=".$id."&berkas=".$baris["berkas"].">[hapus]</a>
                                </center>
                            </td>
                            <td>$baris[0]</td>
                            <td>$baris[1]</td>
