<div id="post">
     <div class="entry">
		...
		<tr class="head">
            ...
            <?php
                $_sql   = "SELECT pnm_tnj_harian.id,pnm_tnj_harian.id_tnj,master_tunjangan_harian.nama,master_tunjangan_harian.tnj from master_tunjangan_harian inner join pnm_tnj_harian on pnm_tnj_harian.id_tnj=master_tunjangan_harian.id where pnm_tnj_harian.id='$id' ORDER BY master_tunjangan_harian.nama ASC ";
                $hasil  = bukaquery($_sql);
                ...
                if(mysqli_num_rows($hasil)!=0) {
                    ...
                    while($baris = mysqli_fetch_array($hasil)) {
                        echo "<tr class='isi'>
                                <td>
                                    <center>
                                       <a href=?act=DetailPenerimaTunjanganHarian&action=HAPUS&id=".$baris[0]."&id_tnj=".$baris[1].">[hapus]</a>
                                    </center>
                                </td>
                                <td>$baris[2]</td>
