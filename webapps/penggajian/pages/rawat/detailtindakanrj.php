<div id="post">
    ...
    <div class="entry">
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <?php
                $_sql   = "SELECT master_tindakan.id,master_tindakan.nama,master_tindakan.jm,master_tindakan.jns from master_tindakan where master_tindakan.jns='dr Spesialis' ORDER BY master_tindakan.jns,master_tindakan.nama ASC ";
        ...
        <?php
            if ($action=="HAPUS") {
                try {
                    Hapus(" master_tindakan "," id ='".validTeks($_GET['id'])."' ","?act=DetailTindakanRj&action=TAMBAH&nama=$nama");
                } catch(mysqli_sql_exception $e) {
