...
<html>
   ...
   <?php
        echo "<table  border='0' align='left'>
            <caption><center><font color='333333' size='2'  face='Arial'>Slip Gaji Dokter Tahun ".$tahun." Bulan ".$bulan."</font></center></caption>
             <tr>
             <td>
            ";
        ...
        if(mysqli_num_rows($hasil)!=0) {	
			 ...
			 $jmlmsk         = isset($baris2[0])?$baris2[0]:0;
			    ...
			    $jl   = (isset($baris26[0])?$baris26[0]:0)+
					...
					<caption><font size='1px' face='Arial' color='333333'><strong>Jasa Medis</strong></font></caption>
                                        <TR class='isi6'>
				 ...
				 echo "
                                       <TR class='isi6'>
                                         <TD width='130px'>&nbsp;&nbsp;&nbsp;<i><b><strong><font size='2px' face='Arial' color='333333'>Total Gaji</font></strong></b></i></TD>
					 <td width='3px'>:</td>
					 ...
					 <td width='140px'><center>( .................. )</center></td>
				      ...
				      <center><font size='1px' face='Arial' color='333333'><i><b>..Terima kasih atas kerjasamanya <br>dalam memberikan pelayanan yang berkualitas..</b></i></font></center>

                                        <center><font face='Arial' size='3' color='333333'>Rincian Tindakan</font></center>";
