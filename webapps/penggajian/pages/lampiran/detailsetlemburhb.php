<div id="post">
    ...
    <div class="entry">
                        ...
                        switch($action) {
                            case "TAMBAH":
                                try {
                                    ...
                                    if($e->getCode()==1062){
                                        echo "<b style='color:red'>Data tunjangan lembur sudah ada..!!!</b>";
                                    }else{
                ...
                $jumlah=mysqli_num_rows($hasil);
                    ...
                    while($baris = mysqli_fetch_array($hasil)) {
                      echo "<tr class='isi'>
                                <td>
                                   <center>";?>
                                    <a href="?act=InputSetLemburHB&action=HAPUS&tnj=<?php print $baris[0] ?>" >[hapus]</a>
                            <?php
                            echo "</center>
                                </td>
        ...
        <?php
            if ($action=="HAPUS") {
                try {
                    Hapus(" set_lemburhb   "," tnj ='".$tnj."' ","?act=InputSetLemburHB&action=TAMBAH&tnj=".$tnj);
                } catch(mysqli_sql_exception $e) {
