<?php
    ...
    $_sqllibur  = "select set_hari_libur.tanggal,set_hari_libur.ktg from set_hari_libur where set_hari_libur.tanggal like '%".$tahun."-".$bulan."%' ORDER BY set_hari_libur.tanggal";
                ...
                if(mysqli_num_rows($hasil)!=0) {
                    echo "<table width='5000px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                            ...
                            <tr class='head'>
                                 ...
                                 <td width='100px'><div align='center'><font color='green'>Total Gaji</font></div></td>
                                 <td width='920px'><div align='center'>Potongan Gaji</div></td>
                                 <td width='100px'><div align='center'><font color='green'>Total Gaji Diterima</font></div></td>
                            </tr>";
                                ...
                                echo "<tr class='isi' valign='top'>
                                          ...
                                          <td>
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               ...
                                               <TR class='isi'>
                                                 ...
                                                 <TD>
                                                    <table cellpadding='0' cellspacing='0' width='100%' valign='top'>";
                                                    echo "<tr class='isi3'><td width='150px'>Tunjangan KaSift</td><td>:</td><td> ".$ttlkasift."</td></tr>";
                                                    ...
                                                    while($baris16 = mysqli_fetch_array($hasil16)) {
                                                        ...
                                                        echo "<tr class='isi3'><td width='150px'>$baris16[0]</td><td>:</td><td>".formatDec($nilaitunjangan)."</td></tr>";
                                                    }
                                                    ...
                                                    while($baris50 = mysqli_fetch_array($hasil50)) {
                                                        ...
                                                        echo "<tr class='isi3'><td width='150px'>$baris50[0]</td><td>:</td><td>".$baris50[1]."</td></tr>";
                                                    }
                                                 ...
                                                 <TD>".$tmbahanjg."</TD>
                                                 <TD>".$tnjhadir."</TD>
                                                 <TD><i>".formatDec($gapok+$tnjjbtn+$tnjtnj+$tnjtnjbln+$ttlkasift+$tmbhjgmlm+$tmbahanjg+$tnjhadir)."</i></TD>
                                               </TR>
                                             </table>
                                         </td>
                                         <td>
                                          ...
                                          <td>
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               ...
                                               <TR class='isi'>
                                                 ...
                                                 <TD>".formatRound($indexjaga)."</TD>
                                                 <TD>".formatRound($ttlindex)."</TD>
                                                 <TD width='100px'>";
                                                 ...
                                                 while($baris30 = mysqli_fetch_array($hasil30)) {
                                                     echo "<tr class='isi3'><td width='150px'>$baris30[0]</td><td>:</td><td> ".formatDec($baris30[1])."</td></tr>";
                                                 }
                                           echo " </table>
                                                 </TD>
                                                 <TD>".formatDec($jl)."</TD>
                                                 <TD><i>".formatDec($jmltmb)."</i></TD>
                                               </TR>
                                             </table>
                                          </td>
                                          <td><font size='2' color='green'><i>".formatDec($ttlgaji)."</i></font></td>
                                          <td>";
                                         ...
                                         echo "
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               ...
                                               <TR class='isi'>
                                                 <TD>".formatDec($bpjs)."</TD>
                                                 <TD>".formatDec($jamsostek)."</TD>
                                                 <TD>".formatDec($dansos)."</TD>
                                                 <TD>".formatDec($simwajib)."</TD>
                                                 <TD>".formatDec($angkop)."</TD>
                                                 <TD>".formatDec($angla)."</TD>
                                                 <TD>".formatDec($telpri)."</TD>
                                                 <TD>".formatDec($pajak)."</TD>
                                                 <TD>".formatDec($pribadi)."</TD>
                                                 <TD>".formatDec($lain)."</TD>
                                             </table>
                                          </td>
                                          <TD><font size='2' color='green'><i>".formatDec($ttlditerima)."</i></font></TD>
                                       </tr>";
                            }
                    ...
                    echo "<tr class='head'>
                                 ...
                                 <td>
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               <TR class='isi5'>
                                                 <TD width='100px'>".formatDec($ttlgapok)."</TD>
                                                 <TD width='100px'>".formatDec($ttltnjjbtn)."</TD>
                                                 <TD width='300px'>".formatDec($ttltnjtnj)."</TD>
                                                 <TD width='100px'>".formatDec($ttltmbhjgmlm)."</TD>
                                                 <TD width='100px'>".formatDec($ttltmbahanjg)."</TD>
                                                 <TD width='100px'>".formatDec($ttltnjhadir)."</TD>
                                                 <TD width='120px'><i>".formatDec($ttljmlgaji)."</i></TD>
                                               </TR>
                                             </table>
                                 </td>
                                 <td>
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               <TR class='isi5'>
                                                 <TD width='100px'>".formatDec($ttllemburhb)."</TD>
                                                 <TD width='100px'>".formatDec($ttllemburhr)."</TD>
                                                 <TD width='100px'><i>".formatDec($ttllemburhb+$ttllemburhr)."</i></TD>
                                               </TR>
                                             </table>
                                 </td>
                                 <td>
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               <TR class='isi5'>
                                                 ...
                                                 <TD width='105px'>".formatDec($ttlttlinsentif)."</TD>
                                                 <TD width='250px'>".formatDec($ttljm)."</TD>
                                                 <TD width='105px'>".formatDec($ttljasalain)."</TD>
                                                 <TD width='105px'><i>".formatDec($ttljmltmb)."</i></TD>
                                               </TR>
                                             </table>
                                 </td>
                                 <td width='100px'><div align='center'><font size='2' color='green'><i>".formatDec($ttlttlgaji)."</i></font></div></td>
                                 <td>
                                             <table cellpadding='0' cellspacing='0' width='100%' valign='top'>
                                               <TR class='isi5'>
                                                 <TD width='100px'>".formatDec($ttlbpjs)."</TD>
                                                 <TD width='100px'>".formatDec($ttljamsostek)."</TD>
                                                 <TD width='100px'>".formatDec($ttldansos)."</TD>
                                                 <TD width='100px'>".formatDec($ttlsimwajib)."</TD>
                                                 <TD width='100px'>".formatDec($ttlangkop)."</TD>
                                                 <TD width='100px'>".formatDec($ttlangla)."</TD>
                                                 <TD width='100px'>".formatDec($ttltelpri)."</TD>
                                                 <TD width='100px'>".formatDec($ttlpajak)."</TD>
                                                 <TD width='100px'>".formatDec($ttlpribadi)."</TD>
                                                 <TD width='100px'>".formatDec($ttllain)."</TD>
                                             </table>
                                 </td>
                                 <TD><font size='2' color='green'><i>".formatDec($ttlttlditerima)."</i></font></TD>
                            </tr>
                          </table>";
                } 
            }else{
