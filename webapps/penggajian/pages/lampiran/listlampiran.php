            ...
            if(mysqli_num_rows($hasil)!=0) {
                echo "<table width='4900px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                        <tr class='head'>
                             ...
                             <td width='60px'><div align='center'>Jenjang Jabatan</div></td>
                             <td width='60px'><div align='center'>Departemen</div></td>
                        ...
                        while($baris = mysqli_fetch_array($hasil)) {
                            ...
                            echo "<tr class='isi' title='".$baris["nik"]." ".$baris["nama"]."'>
                                     <td valign='top'><a target=_blank href=../penggajian/pages/lampiran/SlipGaji.php?&id=$baris[0]>".$baris["nik"]."</a></td>
                                     <td valign='top'><a target=_blank href=../penggajian/pages/lampiran/SlipDokter.php?&id=$baris[0]>".$baris["nama"]."</a></td>
                                     <td valign='top'><a target=_blank href=../penggajian/pages/lampiran/SlipGajisp.php?&id=$baris[0]>".$baris["jbtn"]."</a></td>
                                     <td valign='top'><a target=_blank href=../penggajian/pages/lampiran/SlipGajisp2.php?&id=$baris[0]>".$baris["jnj_jabatan"]."</a></td>
                                     <td valign='top'><a target=_blank href=../penggajian/pages/lampiran/SlipThr.php?&id=$baris[0]&jmlmsk=$jmlmsk&gapokgp=$gapokgp>".$baris["departemen"]."</a></td>
