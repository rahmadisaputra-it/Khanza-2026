...
header("Content-Disposition: attachment; filename=GajiSp.xls");
             ...
             $_sql30="select tindakan.tgl,tindakan.nm_pasien,tindakan.diagnosa,master_tindakan.nama,
                                         ...
                                         echo "<table width='270px' border='1' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                                               <tr class='isi6'>
                                                   ...
                                                   <td width='70px'><div align='center'><font size='1' face='Arial'>Tindakan-Kls</font></div></td>
                                                   <td width='30px'><div align='center'><font size='1' face='Arial'>JM</font></div></td>
                                                 </tr>";
				 ...
				 echo "
					 ...
					 <td width='140px'>&nbsp;</td>
                                        ...
                                        <!--ini di hiden disini
                                      <TR class='isi6'>
                                         <TD width='130px' colspan='3'><center>
                           <font color='333333' size='1'  face='Arial'><b>
                           Jasa Medis Tahun ".$tahun." </b></font></center></TD>
				      </TR>
                                      <TR class='isi6'>
                                         <TD width='130px' colspan='3'><center><font face='Arial' size='1' color='333333'>Rawat Jalan</font></center>";
