...
<html>
   ...
   <?php
                ...
                if(mysqli_num_rows($hasil)!=0) {
                    echo "&nbsp;&nbsp;&nbsp;<b><font color='999999'>Bagian/Bidang : $barisbid[0]</font></b>
                            ...
                            <tr class='head'>
                                 ...
                                 <td width='100px'><div align='center'><font color='green'>Total Gaji</div></td>
                                 <td width='870px'><div align='center'>Potongan Gaji</div></td>
                                 <td width='100px'><div align='center'><font color='green'>Total Gaji Diterima</div></td>
                            </tr>";
     ...
     echo("<br><br><table width='1880px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    <tr class='head'>
                        <td><div align='left'><b>Total Seluruh Gaji Karyawan : ". formatDec($semuanya)."</b></div></td>                        
                    </tr>     
                 </table>");
    ?>
    </body>
