...
<body>
    <div class="container">
        <h5 class="text-dark"><h5><center>Surat Permintaan Second Opinion<br> No. <?=$nopernyataan;?></center></h5><br/>
        <form method="POST" action="pages/storeImage2.php" onsubmit="return validasiIsi();" enctype=multipart/form-data>
            ...
            <h7 class="text-dark">
                <center>
                    Saksi Keluarga<br/>
                    <?=getOne("select surat_permintaan_second_opinion.saksi_keluarga from surat_permintaan_second_opinion where surat_permintaan_second_opinion.no_pernyataan='$nopernyataan'")?>
                </center>
            </h7>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-12 text-center">
                    <br>
                    <input type="button" class="btn btn-warning" value="Ya, Saya sebagai saksi keluarga" onClick="take_snapshot()">
