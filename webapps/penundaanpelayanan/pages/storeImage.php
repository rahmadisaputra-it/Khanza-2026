<?php
    ...
    if(file_exists(host()."/webapps/penundaanpelayanan/pages/upload/".$nopernyataan.".jpeg")){
        @unlink(host()."/webapps/penundaanpelayanan/pages/upload/".$nopernyataan.".jpeg");
    }
    ...
    try {
        Tambah3("bukti_persetujuan_penundaan_pelayanan","'".$nopernyataan."','pages/upload/$fileName'");
        echo $htmlHead."<body><center>Proses Pengambilan Persetujuan Penundaan Pelayanan Sudah Selesai ..!! <br><a href='".$urlKembali."' class='btn btn-secondary'>Kembali</a></center></body>";
