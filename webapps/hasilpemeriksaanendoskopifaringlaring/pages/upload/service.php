<?php
                        ...
                        if (empty($namafileTanpaExt)) {
                            ...
                            if ($fileData === false) {
                                ...
                                if ($hex !== 'ffd8ff') {
                                    ...
                                    try {
                                        if(Tambah3(" hasil_endoskopi_faring_laring_gambar "," '$norawat','pages/upload/$namafileFinal' ")){
    ...
    function tampil(){
        echo json_encode(array(
            'metadata' => array(
                'message' => 'Selamat Datang di Service Upload Gambar Hasil Endoskopi Faring Laring',
                'code'    => 200
            )
        ));
    }
