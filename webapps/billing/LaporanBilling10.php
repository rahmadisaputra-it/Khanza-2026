                                    ...
                                    <td padding='0'  width='90%' valign='top'>
                                        <table width='100%' cellspacing='0' cellpadding='0'>
                                            ...
                                            <tr valign='top'>
                                               ...
                                               <td><font color='333333' size='3'  face='Tahoma'>:</font></td>
                                               <td><font color='333333' size='3'  face='Tahoma'>".Terbilang(str_replace(",","",getOne("select temp7 from temporary_bayar_ralan where temp9='$petugas' and temp1='SISA PIUTANG'")))." rupiah</font></td>
                                            </tr>
                                            <tr valign='top'>
