                                ...
                                <td padding='0'  width='90%' valign='top'>
                                    <table width='100%' cellspacing='0' cellpadding='0'>
                                        ...
                                        <tr valign='top'>
                                           ...
                                           <td><font color='333333' size='3'  face='Tahoma'>:</font></td>
                                           <td><font color='333333' size='3'  face='Tahoma'>".Terbilang(str_replace("</b>","",str_replace("<b>","",str_replace(",","",getOne("select temp7 from temporary_bayar_ranap where temp1='TAGIHAN+PPN'")))))." rupiah</font></td>
                                        </tr>
                                        <tr valign='top'>
                                           ...
                                           <td><font color='333333' size='3'  face='Tahoma'>Pelayanan Kesehatan Rawat Inap di ".$setting["nama_instansi"]." a/n ".str_replace(":","",getOne("select temp2 from temporary_bayar_ranap where temp1='Nama Pasien'")).", 
                                               RM ".str_replace(":","",getOne("select temp2 from temporary_bayar_ranap where temp1='No.RM'")).", 
                                        ...
                                        <tr>
                                           ...
                                           <td><font color='333333' size='3'  face='Tahoma'></font></td>
                                           <td><font color='333333' size='3'  face='Tahoma'>Rp. ".getOne("select temp7 from temporary_bayar_ranap where temp1='TAGIHAN+PPN'")."</font></td>
                                        </tr>
                                        <tr>
                                           <td>&nbsp;</td>
                                           <td>&nbsp;</td>
