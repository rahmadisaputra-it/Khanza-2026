<?php
    ...
    try {
        ...
        echo $htmlHead."<body><center>Proses Pengambilan Persetujuan Transfer Antar Ruang Pasien Sudah Selesai ..!! <br><a href='".$urlKembali."' class='btn btn-secondary'>Kembali</a></center></body>";
