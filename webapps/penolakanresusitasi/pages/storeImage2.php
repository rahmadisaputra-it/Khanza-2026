<?php
    ...
    if(file_exists(host()."/webapps/penolakanresusitasi/pages/upload/".$nopernyataan."SK.jpeg")){
        @unlink(host()."/webapps/penolakanresusitasi/pages/upload/".$nopernyataan."SK.jpeg");
    }
    ...
    try {
        Tambah3("bukti_surat_penolakan_resusitasi_saksikeluarga","'".$nopernyataan."','pages/upload/$fileName'");
        echo $htmlHead."<body><center>Proses Pengambilan Persetujuan Saksi 1 Keluarga Sudah Selesai ..!! <br><a href='".$urlKembali."' class='btn btn-secondary'>Kembali</a></center></body>";
