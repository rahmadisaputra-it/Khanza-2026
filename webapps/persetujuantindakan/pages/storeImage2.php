<?php
    ...
    if(file_exists(host()."/webapps/persetujuantindakan/pages/upload/".$nopernyataan."SK.jpeg")){
        @unlink(host()."/webapps/persetujuantindakan/pages/upload/".$nopernyataan."SK.jpeg");
    }
