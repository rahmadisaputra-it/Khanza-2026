<?php
    ...
    try {
        ...
        echo $htmlHead."<body><center>Proses Pengambilan Pernyataan Umum Pasien/Keluarga Pasien Sudah Selesai ..!! <br><a href='".$urlKembali."' class='btn btn-secondary'>Kembali</a></center></body>";
