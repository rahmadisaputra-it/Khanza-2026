                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php 
                           $querypasien = bukaquery("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,reg_periksa.stts 
                                                     from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.kd_dokter='".validTeks4(encrypt_decrypt($_SESSION["ses_dokter"],"d"),20)."' and reg_periksa.tgl_registrasi=current_date()");
