<?php
    ...
    if (isset($iyem["norawat"])) {
        ...
        $querytanggalperiksalab = bukaquery(
            "select periksa_lab.tgl_periksa,periksa_lab.jam from periksa_lab where periksa_lab.kategori='PK' and periksa_lab.no_rawat='".$norawat."' and periksa_lab.tgl_periksa='".$tglperiksa."' ".
        ...
        if(mysqli_num_rows($querytanggalperiksalab)!=0) {
            echo "<div class='row clearfix'>
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class='card'>
                            <div class='header'>
                                <h2><center>HASIL PEMERIKSAAN LABORATORIUM PK</center></h2>
                            </div>
            ...
            while($rsquerytanggalperiksalab= mysqli_fetch_array($querytanggalperiksalab)){
                $queryperiksalab = bukaquery(
                    ...
                    "where periksa_lab.kategori='PK' and periksa_lab.no_rawat='".$norawat."' ".
