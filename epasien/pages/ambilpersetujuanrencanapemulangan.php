...
<?php
    ...
    if (isset($iyem["norawat"])) {
        ...
        $querypersetujuan = bukaquery(
            ...
            "perencanaan_pemulangan.nama_pasien_keluarga,reg_periksa.tgl_registrasi,reg_periksa.jam_reg from perencanaan_pemulangan inner join reg_periksa on reg_periksa.no_rawat=perencanaan_pemulangan.no_rawat ".
        ...
        if($rsquerypersetujuan= mysqli_fetch_array($querypersetujuan)){
                        ...
                        <div class='card'>
                            ...
                            <div class='body'>
                                <form method='POST' onsubmit='return validasiIsi();' enctype=multipart/form-data>
                                    ...
                                    <br/>
                                    <br/>
                                    <h7><center>Pasien/Keluarga<br/>".$rsquerypersetujuan["nama_pasien_keluarga"]."</center></h7>
                                    <div class='row'>
            ...
            if (isset($BtnSimpan)) {
                ...
                if(file_exists("../webapps/perencanaanpemulangan/pages/upload/".str_replace("/","",$norawat).".jpeg")){
                    @unlink("../webapps/perencanaanpemulangan/pages/upload/".str_replace("/","",$norawat).".jpeg");
                }
                $img                    = $_POST["image"];
                $folderPath             = "../webapps/perencanaanpemulangan/pages/upload/";
