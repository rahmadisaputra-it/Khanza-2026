...
<div class="block-header">
    <h2><center>RIWAYAT PEMERIKSAAN LAB PA</center></h2>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php 
                            $queryperiksa = bukaquery(
                                ...
                                "inner join dokter on periksa_lab.dokter_perujuk=dokter.kd_dokter where periksa_lab.kategori='PA' and reg_periksa.no_rkm_medis='".cleankar(encrypt_decrypt($_SESSION["ses_pasien"],"d"))."' group by concat(periksa_lab.no_rawat,periksa_lab.tgl_periksa,periksa_lab.jam) order by periksa_lab.tgl_periksa desc,periksa_lab.jam desc"
                            );
                            while($rsqueryperiksa = mysqli_fetch_array($queryperiksa)) {
                               echo "<tr>
                                        ...
                                        <td align='center' valign='middle'><a href='index.php?act=HasilLabPA&iyem=".encrypt_decrypt("{\"norawat\":\"".$rsqueryperiksa["no_rawat"]."\",\"tglperiksa\":\"".$rsqueryperiksa["tgl_periksa"]."\",\"jam\":\"".$rsqueryperiksa["jam"]."\"}","e")."' class='btn btn-danger waves-effect'>Hasil</a></td>
                                     </tr>";
                            }
                        ?>
                        </tbody>
